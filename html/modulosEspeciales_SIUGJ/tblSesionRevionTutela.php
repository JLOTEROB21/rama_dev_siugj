			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
					  ...
					  ?>
                      <script type="text/x-javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblSesionRevionTutela.js.php?iA=<?php echo $idAudiencia ?>"></script>
						<input type="hidden" id="idAudiencia" value="<?php echo $idAudiencia?>" />
