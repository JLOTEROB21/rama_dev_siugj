			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                       ...
                       <?php
					  	$idAudiencia=-1;
						if(isset($objParametros->idAudiencia))
							$idAudiencia=$objParametros->idAudiencia;
						...
						$carpetaAdministrativa=$con->obtenerValor($consulta);
					  	$consulta="SELECT id__990_tablaDinamica FROM _990_tablaDinamica WHERE codigo='".$carpetaAdministrativa."'";
					  	$idRegistro=$con->obtenerValor($consulta);
					  
					  ?>
                      <script type="text/x-javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblTutelasPaquete.js.php?iF=990&sL=0&iR=<?php echo $idRegistro ?>"></script>
