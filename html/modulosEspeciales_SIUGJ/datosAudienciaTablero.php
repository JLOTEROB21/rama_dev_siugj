...
<script type="text/javascript" src="../Scripts/cBitacoraSituacionObjeto.js.php"></script>
<style>
	.plupload_header
	{
			display:none;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$idRegistroReferenciaConfiguracion=-1;
							if(isset($objParametros->idRegistroReferenciaConfiguracion))
								$idRegistroReferenciaConfiguracion=$objParametros->idRegistroReferenciaConfiguracion;
							
							$consulta="SELECT situacion FROM 3014_registroResutadoAudiencia WHERE idEvento=".$idEvento;
							...
							$idRegistroCuestionario=-1;
							$cuestionarioAudiencia=-1;
							if(isset($objParametros->cuestionarioAudiencia) &&($objParametros->cuestionarioAudiencia!=-1))
							{
								$cuestionarioAudiencia=$objParametros->cuestionarioAudiencia;
								
								$nombreTabla=obtenerNombreTabla($cuestionarioAudiencia);
								$consulta="SELECT id_".$nombreTabla." FROM ".$nombreTabla." WHERE idReferencia=".$idEvento;
								
								$idRegistroCuestionario=$con->obtenerValor($consulta);
								if($idRegistroCuestionario=="")
									$idRegistroCuestionario=-1;
							}
							
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/datosAudienciaTablero.js.php?iE=<?php echo $idEvento?>&iC=<?php echo $idRegistroReferenciaConfiguracion?>"></script>
                        	<table>
                            <tr>
                            	<td>
                            ...
                            <tr>
                            	<td>
                                	<br /><br />
		                        	<span id="tblResolutivos"></span>
                                </td>
                            </tr>
                            </table>
                        	<input type="hidden" id="idEvento" value="<?php echo $idEvento?>" />
                            <input type="hidden" id="sL" value="<?php echo $sL?>" />
                            <input type="hidden" id="situacionInforme" value="<?php echo $situacionInforme?>" />
                            ...
                            <input type="hidden" id="cuestionarioAudiencia" value="<?php echo $cuestionarioAudiencia?>" />
                            <input type="hidden" id="idRegistroCuestionario" value="<?php echo $idRegistroCuestionario?>" />
                            <input type="hidden" id="idRegistroReferenciaConfiguracion" value="<?php echo $idRegistroReferenciaConfiguracion?>" />
