				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="left">
						  ...
						  ?>
						  <script type="text/x-javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblDemandasProgramaTrabajo.js.php?iF=<?php echo $idFormulario ?>&sL=<?php echo $sL?>&iR=<?php echo $idRegistro ?>"></script>
