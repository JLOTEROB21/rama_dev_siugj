...
function textoBotonRendererDocumento(val,meta,registro,numFila)
{
	meta.attr='style="text-align:left"';
        ...
        if(gE('sL').value=='0')
        {
            ...
            return '<a href="javascript:mostrarVentanaArchivoDocumento(\''+bE(numFila)+'\')"><img width="13" height="13" src="../images/pencil.png">&nbsp;&nbsp;'+comp;
		}
        else
        {
...
function mostrarVentanaArchivoDocumento(nFila)
{
