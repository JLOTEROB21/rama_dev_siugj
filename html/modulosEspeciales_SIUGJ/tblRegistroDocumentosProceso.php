                   ...
                   <tr>
                       ...
                       <?php
						...
						if(isset($objParametros->idFormularioProceso))
							$iFP=$objParametros->idFormularioProceso;	
					  	$sL=0;
					  ...
					  ?>
                      <script type="text/x-javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblRegistroDocumentosProceso.js.php?iFP=<?php echo $iFP?>&iF=<?php echo $idFormulario ?>&sL=<?php echo $sL?>&iR=<?php echo $idRegistro ?>"></script>
