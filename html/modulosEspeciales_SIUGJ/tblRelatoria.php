...
<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblRelatoria.js.php"></script>
<!-- InstanceEndEditable -->
                   ...
                   <tr>
                          <td align="left">
						   <?php
                            ...
                            $consulta="SELECT idDocumento FROM _1137_tablaDinamica WHERE id__1137_tablaDinamica=".$idRegistro;
                          ...
                          <input type="hidden" id="idDocumento" value="<?php echo $idDocumento?>" />
                            </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
