...
<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblReportViewer.js.php"></script>
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT tipoReporte FROM _1212_tablaDinamica WHERE id__1212_tablaDinamica=".$idRegistro;
							$iR=$con->obtenerValor($consulta);	
