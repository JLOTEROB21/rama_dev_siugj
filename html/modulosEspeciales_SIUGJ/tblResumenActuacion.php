                   ...
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->sL))
								$sL=$objParametros->sL;	
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblResumenActuacion.js.php?iF=<?php echo bE($idFormulario)?>&iR=<?php echo bE($idRegistro)?>"></script>
