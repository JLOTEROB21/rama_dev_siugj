<?php
	...
	$consulta="SELECT sentencia FROM _687_tablaDinamica WHERE id__687_tablaDinamica=".$idRegistro;
    ...
    if(!esRegistroFormulario())
    {
    	...
    	if(sentencia!='-1')
       {
            ...
            var extension=arrDocumento[arrDocumento.length-1];
       		...
       		gE('div_10894').innerHTML='<a href="javascript:visualizarDocumento(\''+bE(sentencia)+'\',\''+bE(extension)+'\')"><img src="../imagenesDocumentos/16/file_extension_'+extension+'.png" /></a>';
       }
    }
