...
function inyeccionCodigo()
{
    if(esRegistroFormulario())
    {
    	...
    	gEx('f_sp_fechaEstimadaListadte').setValue('<?php echo $fechaModificada==""?$fechaPublicacion:$fechaModificada?>');
           
        gEx('f_sp_fechaEstimadaListadte').fireEvent('change', gEx('f_sp_fechaEstimadaListadte'), gEx('f_sp_fechaEstimadaListadte').getValue());
        gEx('f_sp_fechaEstimadaListadte').fireEvent('select', gEx('f_sp_fechaEstimadaListadte'));
        gEx('f_sp_fechaEstimadaListadte').disable();
    ...
    if(fechaModificada!='')
    {
    	gE('sp_16506').innerHTML='<span style="font-size:14px">La fecha de publicaci&oacute;n ha presentado modificaciones,<br />para ver dichos cambios dé click'+
                                                                	...
                                                                	new Ext.form.DateField	(
                                                                    							{
                                                                                                    ...
                                                                                                    value:gEx('f_sp_fechaEstimadaListadte').getValue(),
															...
															handler: function()
																	{
                                                                        ...
                                                                        function resp(btn)
                                                                        {
                                                                        	if(btn=='yes')
                                                                            {
                                                                            	...
                                                                            	gEx('f_sp_fechaEstimadaListadte').setValue(gEx('fechaPublicacion').getValue());
                                                                                
                                                                                
                                                                                gE('_fechaEstimadaListadte').value=gEx('f_sp_fechaEstimadaListadte').getValue().format('d/m/Y');
