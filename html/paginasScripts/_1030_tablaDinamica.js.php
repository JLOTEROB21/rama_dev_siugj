...
{
	gE('sp_14081').innerHTML='<div id="divImgResumen" style="width:320px; height:240px; border-style:solid; border-width:1px; border-color: #1A3E9A;border-radius: 10px !important;"></div>';
    gE('sp_14082').innerHTML='<div id="divImgPrincipal" style="width:760px; height:310px; border-style:solid; border-width:1px; border-color: #1A3E9A;border-radius: 10px !important;"></div>';
    if(esRegistroFormulario())
    {
		...
		if(gE('idRegistroG').value=='-1')
      	{
        	gE('_responsablePublicacionvch').value='<?php echo $_SESSION["nombreUsr"]?>';
