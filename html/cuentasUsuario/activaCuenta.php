			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td>
                        <?php 
							$consulta="select Status from 800_usuarios where idUsuario=".$idUsuario;
						...
						?>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <br />
                                            ...
                                            <span class="letraFicha"><font style="font-size:12px"><b>En breve será redireccionado a la pagina de registro de usuarios, ahí usted podrá crear una nueva cuenta</b>
                                            </font>
                                            </span>
                                        </td>
                                    </tr>
                            ...
                            <META HTTP-EQUIV="Refresh" CONTENT="5; URL=../principal/inicio.php">
                        <?php
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <br />
                                                ...
                                                <span class="letraFicha"><font style="font-size:12px"><b>En breve será redireccionado a la pagina de autentificación para que inicie una sesión en el sistema</b>
                                                </font>
                                                </span>
                                            </td>
                                        </tr>
                        ...
                        <?php
								...
								else
								{
										...
										$query[$x]="begin";
										$x++;
										$query[$x]="update 800_usuarios set Status=-7 where idUsuario=".$idUsuario;
										$x++;
										$query[$x]="update 801_adscripcion set Status=-7 where idUsuario=".$idUsuario;
										$x++;
										$query[$x]="update 802_identifica set Status=-7 where idUsuario=".$idUsuario;
										$x++;
										$query[$x]="commit";
