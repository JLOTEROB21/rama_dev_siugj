...
<script type="text/javascript" src="../cuentasUsuario/Scripts/nUsuariosIntermedia.js.php"></script>
<!-- InstanceEndEditable -->
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   ...
                   <tr>
                        <td>
                            ...
                            <input type="hidden" name="cambioDatosUsrPrimeraVez" id="cambioDatosUsrPrimeraVez" value="1"/>
