...
//							$pagRegresar="../Usuarios/bUsuarios.php";
				  			...
				  			<tr>
								<td >
									...
									<tr height="27" valign="top">
                                        ...
                                        <td></td>
                                        <td><input type="text" name="ciuNac" id="ciudadNac" value='<?php echo ($cInfo[4]);?>'/></td>
                                    ...
                                    <tr height="27">
                                        ...
                                        <td><input type="text" name="estNac" id="estNac" value='<?php echo ($cInfo[5]);?>'/></td>
                                    	<td></td>
                                        <td><label>País de Nac.:</label>
                                      	</td>
                                        <td></td>
                                        <td><label>
                                          <input type="text" name="paisNac" id="paisNac" value='<?php echo ($cInfo[6]);?>'/>
                                          </label>	 
                                        </td>
                                    </tr>
                                   	<tr height="27" valign="top">
  									...
  									<tr>
                                        ...
                                        <tr height="60">
                                            ...
                                            <td width="270" valign="top">
                                            	<label>
                                              		<select name="cmbTelefono" id="cmbTelefono" size="3" style="width:185px">
													  <?php
                                                      if(isset($idUsuario))
  ...
  <?php }?>
    <td align="right">
	<br />
	<input type="button" class="tituloTabla" name="btnGuardar" id="btnGuardar" 
	<?php 
	if($accion=="Nuevo")
		echo "value='Guardar'"; 
	else
