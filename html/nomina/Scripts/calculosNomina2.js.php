															...
															handler: function()
																	{
                                                                        ...
                                                                        obtenerDatosWeb('../paginasFunciones/funcionesOrganigrama.php',funcAjax, 'POST','funcion=49&listConceptos='+listDeduc+'&tipo='+cmbTipoCalculo.getValue()+'&idUsuario='+idUsuario,true);
															...
															handler: function()
																	{
                                                                        ...
                                                                        obtenerDatosWeb('../paginasFunciones/funcionesContabilidad.php',funcAjax, 'POST','funcion=68&idUsuario=NULL&nAcumulador='+cv(nAcumulador.getValue())+'&idAcumulador='+idAcumulador+'&nivelAcumulador='+nivelAcumulador,true);
																	}
														},
														{
															text: '<?php echo $etj["lblBtnCancelar"]?>',
