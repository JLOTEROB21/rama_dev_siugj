				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td>
                        	...
                        	<?php
								$idEtapa="-1";
								if(isset($objParametros->idEtapa))
									$idEtapa=$objParametros->idEtapa;
								
								$consulta="SELECT noEtapa,nombreEtapa,e.idPerfil,p.nombrePerfil FROM 662_etapasNomina e,662_perfilesNomina p WHERE idEtapa=".$idEtapa." and p.idPerfilesNomina=e.idPerfil";
								$fEtapa=$con->obtenerPrimeraFila($consulta);
								$idPerfil=$fEtapa[2];
								
								$consulta="select idConsulta from 991_consultasSql where comp1='".$fEtapa[2]."' and comp2='".$fEtapa[0]."' and tipoConsulta=11";
							...
							?>
                            <script type="text/javascript" src="Scripts/dataSetDisparador.js.php?idProceso=<?php echo bE($fEtapa[2])?>"></script>
                            <script type="text/javascript" src="Scripts/configurarDisparadoresNomina.js.php?idConsulta=<?php echo bE($idConsultaExp)?>"></script>
                        	<table width="100%">
                            	<tr>
                                	<td align="center">
                                    	<span class="tituloPaginas">Configuración de disparadores</span><br /><br />
                                ...
                                <tr>
                                	<td align="left">
                                    	<table class="tablaMenu">
                                        	<tr height="24">
                                            	<td width="120">&nbsp;&nbsp;
                                                	<span class="corpo8_bold">Perfil de nómina:</span>
                                                </td>
                                                <td width="120">
                                                	<span class="copyrigthSinPadding"><?php echo $fEtapa[3]?></span>
                                                </td>
                                            </tr>
                                            <tr height="24">
                                            	<td width="100">&nbsp;&nbsp;
                                                	<span class="corpo8_bold">Etapa:</span>
                                                </td>
                                                <td width="200">
                                                	<span class="copyrigthSinPadding"><?php echo removerCerosDerecha($fEtapa[0]).".- ".$fEtapa[1]?></span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    	...
                                    	<table width="100%">
                                        	<tr>
                                            	<td valign="top">
                                                	<br />
                                                    <br />
                                                	<span id='tblAlmacenes' style="width:200px"></span>
                                                </td>
                                                <td width="10">
                                                </td>
                                                <td valign="top">
                            ...
                            <input type="hidden" id="numEtapa" value="<?php echo $fEtapa[0]?>" />
                            <input type="hidden" id="idEtapa" value="<?php echo $idEtapa?>" />
