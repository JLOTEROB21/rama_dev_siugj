                   ...
                   <tr>
                        <td align="center">
                        	<?php
								...
								if($idUsuario=="-1")
								{
									$consulta="select d.".$idTabla.",c.codigo,c.nombreConsulta,afectacionNomina,quincenaAfectacion,nQuincenasAfectacion,cicloAfectacion,tipoCalculo,c.idConsulta ,orden from ".$nTabla." d,991_consultasSql c where c.idConsulta=d.idConsulta and idUsuarioAplica is null order by orden";
									$query="select max(orden) from  ".$nTabla." where idUsuarioAplica is null";
								}
								else
								{
								...
								{
									$consulta="select idAcumuladorNomina,nombreAcumulador from 665_acumuladoresNomina where 
											codigoInstitucion='".$_SESSION["codigoInstitucion"]."' and nivelAcumulador in  (".$nivelAcumulador.")";
								}
                        	...
                        	<table  width="100%">
                            	<tr>
                                	<td align="left" colspan="2"><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    	<span class="tituloPaginas">Cálculos de nómina</span><br /><br /><br /><br />
                        			</td>
                            	</tr>
                                <tr>
                                	<td align="left" colspan="3">
                                    	<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    	<span class="letraFichaRespuesta">Si desea agregar un nuevo cálculo de click </span>
                                        <a href='javascript:agregarConcepto()'><span class="letraRoja"> AQUÍ</span>
                                        </a>
                                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                        <span class="letraFichaRespuesta">Para administrar los acumuladores  de click </span>
                                        <a href='javascript:agregarAcumulador()'><span class="letraRoja"> AQUÍ</span>
                                        </a>
                                                ...
                                                <?php
                                                    ...
                                                    while($fCta=mysql_fetch_row($resCtas))
                                                    {
                                                        if($fCta[6]==1)
                                                            ...
                                                            $afectacion="Haber";
                                                        $consulta="select tituloCta from 510_cuentas where idCuenta=".$fCta[7];
