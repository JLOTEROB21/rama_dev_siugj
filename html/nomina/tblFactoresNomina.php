                                    ...
                                    <td align="center" >
                                    	<table>
                                        	<tr>
                                            	<td align="left">
                                                <?php
													$consulta="SELECT idFactor,cveFactor,nombreFactor,descripcion FROM 668_factoresNomina";
													$configuracion='{
																		"inicializar":1,
																		"confBotones":	[
																							{
																								"tipo":"A",
																								"leyenda":"Agregar factor",
																								"paginaEnvio":"../nomina/factorNomina.php",
																								"nParamID":"idFactor"
																							},
																							{
																								"tipo":"M",
																								"leyenda":"Modificar factor",
																								"paginaEnvio":"../nomina/factorNomina.php",
																								"nParamID":"idFactor"
																							},
																							...
																							{
																								"tipo":"E",
																								"leyenda":"Eliminar factor",
																								"nParamID":"idFactor",
																								"tablaDel":"668_factoresNomina"
																							}
																						],
																		"confCampos":	[
																							{
