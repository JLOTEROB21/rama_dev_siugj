...
<script type="text/javascript" src="../modeloPerfiles/Scripts/tMapaMacroProcesos.js.php"></script>
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$idRegistro=-1;
							if($objParametros->idRegistro)
								$idRegistro=$objParametros->idRegistro;
								
								
							$consulta="SELECT idRegistro,cveMacroProceso,nombreMacroProceso,descripcion,fechaCreacion,responsableCreacion,situacionActual,idFuncionAplicacion,
									(SELECT nombreConsulta FROM 991_consultasSql WHERE idConsulta=m.idFuncionAplicacion) AS lblFuncionAplicacion FROM 00001_macroProcesos m WHERE idRegistro=".$idRegistro;
							$datosBase=utf8_encode($con->obtenerFilasJSON($consulta));
                        ?>
                        	<input type="hidden" id="idRegistro" value="<?php echo $idRegistro?>" />
                            <input type="hidden" id="datosBase" value="<?php echo bE($datosBase)?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
