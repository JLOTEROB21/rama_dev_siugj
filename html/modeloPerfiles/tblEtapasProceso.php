...
<script type="text/javascript"  src="Scripts/tblEstapasProceso.js"></script>
<?php 
			    ...
			    <tr>    
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <!-- InstanceBeginEditable name="menu_left2" -->
                        ...
                        $consulta="select f.idConfGrid from 909_configuracionTablaFormularios f where f.idFormulario=".$idFormulario;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$nomProceso=$con->obtenerValor($consulta);
						?>
                        	
                        	<fieldset class="frameHijo"><legend><b><?php echo $nomProceso?></b></legend>
                            <br />
                        	<table >
                            	<tr>
                                	<td class="tituloTabla" width="100" align="center"><?php echo $et["lblNumEtapa"] ?></td>
                                	<td class="tituloTabla" width="400"><?php echo $et["lblEtapa"] ?></td>
                                    <td class="tituloTabla" width="120"><?php echo $et["lblRegistros"] ?></td>
                                </tr>
                                 <?php
								 	$fila="filaBlanca10";
									$consulta="select numEtapa,nombreEtapa,idEtapa from 4037_etapas where idProceso=".$idProceso." order by numEtapa";
									$res=$con->obtenerFilas($consulta);
									...
									while($f=mysql_fetch_row($res))
									{
										...
										$queryAux="select count(id_".$nomTabla.")  from ".$nomTabla." where idEstado=".$f[0].$condWhere;
										$numReg=$con->obtenerValor($queryAux);
										$ctRegistro+=$numReg;
										echo 	"<tr height='23'>
													<td class='".$fila."' align='center'>".$f[0]."</td>
													<td class='".$fila."' align='left'> <a href='javascript:irAEtapa(".$idFormulario.",".$f[0].")'>".$f[1]."</a></td>
													<td class='".$fila."' align='center'><a href='javascript:irAEtapa(".$idFormulario.",".$f[0].")'>".$numReg."</a></td>
												</tr>";		
										if($fila=="filaBlanca10")
											$fila="filaRosa10";
										else
											$fila="filaBlanca10";
									}
								?>
                                <tr>
                                <td colspan="2" align="right" class="letraFicha"><b><?php echo $et["lblTotal"]?></b></td>
                                <td class="letraFichaRespuesta" align="center"><?php echo $ctRegistro ?></td>
                                </tr>
                            </table>
                            </fieldset>
