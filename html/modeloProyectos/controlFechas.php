...
<script type="text/javascript" src="../modeloProyectos/Scripts/controlFecha.js.php"></script>
<!-- InstanceEndEditable -->
<?php
			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
                        <span class="tituloPaginas">Control de fechas</span><br /><br /><br />
                        <?php
                        	$idFormulario="-1";
							...
							$fInicio="";
							if($filaFecha[0]!="")
								$fInicio=date("d/m/Y",strtotime($filaFecha[0]));
							$fFin="";
							if($filaFecha[1]!="")
								$fFin=date("d/m/Y",strtotime($filaFecha[1]));	
							$eJs="";
						...
						?>	
                        	<table width="100%">
                            	<tr>
                                    ...
                                    <table>
                                    	<tr height="25">
                                        	<td width="110"><span class="corpo8_bold">Fecha de inicio:</span></td>
                                            <td><span id='spFechaInicio'></span><input type="hidden" name="fechaInicio" id='fechaInicio' value="<?php echo $fInicio?>" />
                                            </td>
                                        	<td width="35"></td>
                                        	<td width="110"><span class="corpo8_bold">Fecha de t&eacute;rmino:</span></td>
                                            <td>
                                            <span id='spFechaFin'></span><input type="hidden" name="fechaFin" id='fechaFin' value="<?php echo $fFin?>" />
                                            </td>
                                        </tr>
                                ...
                                <tr>
                                      <td colspan="2" align="center"><br /><br /><br /><br />
                                          <input type="button" value="Guardar" class="btnAceptar" onclick="guardarFechas()" />
                                      </td>
                                  </tr>
                            </table>
