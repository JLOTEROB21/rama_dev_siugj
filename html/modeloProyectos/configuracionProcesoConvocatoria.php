				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
							...
							?><br /><br /><br /><br />
                            <script type="text/javascript" src="../modeloProyectos/Scripts/configuracionProcesoConvocatoria.js.php?idFormulario=<?php echo bE($idFormulario)?>&idReferencia=<?php echo bE($idRegistro)?>"></script>
                           	<table width="100%">
                            	<tr>
                                	<td align="left">
                                    	<table>
                                        	<tr>
                                            	<td><br />
                                                	...
                                                	Seleccione los procesos con los cuales la convocatoria estar&aacute; vinculada:
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                            	<td><br /><br />
                                                	<span class="copyrigthSinPadding">
                                                	Proceso de registro a vincular con la convocatoria:
                                                    <select id='cmbRegistroLinea' onchange="registroEnLinea(this)">
                                                    	<option value="-1">Ninguno</option>
                                                        
                                                    <?php 
														
														$consulta="SELECT idProceso,nombre FROM 4001_procesos WHERE idTipoProceso=15";
														$con->generarOpcionesSelect($consulta,$filaConvocatoria[3]);
													?>
                                                    </select>
                                                    </span>
                                                </td>
