...
?>
<script >
var ExtPadre=window.parent.Ext;
</script>
			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
                        <script type="text/javascript" src="../modeloProyectos/Scripts/programaActividades.js.php"></script>
                        	<?php
								$idFormulario="-1";
								...
								$frmModuloFecha=incluyeModulo($idProceso,"10");
								
								if($frmModuloFecha!="-1")
								{
									$consulta="select fechaInicio,fechaFin from 9038_fechasControlProyectos where idFormulario=".$idFormulario." and idReferencia=".$idRegistro;
									$filaFecha=$con->obtenerPrimeraFila($consulta);
									$fInicioProy="";
									if($filaFecha[0]!="")
										$fInicioProy=date("d/m/Y",strtotime($filaFecha[0]));
									$fFinProy="";
									if($filaFecha[1]!="")
										$fFinProy=date("d/m/Y",strtotime($filaFecha[1]));
								}
								
								$consulta="select idProceso from 900_formularios where idFormulario=".$idFormulario;
								$idProceso=$con->obtenerValor($consulta);
								
								$consulta="select ap.idUsuario,Nombre from 246_autoresVSProyecto ap,800_usuarios u where u.idUsuario=ap.idUsuario and idFormulario=".$idFormulario." and idReferencia=".$idRegistro;
								$arrUsuarios=$con->obtenerFilasArreglo($consulta);
								$idProceso=obtenerIdProcesoFormulario($idFormulario);
								$idModulo=incluyeModulo($idProceso,3);
								if($idModulo=="-1")
								{
									...
									$arrUsuarios="[['".$idUsuario."','".obtenerNombreUsuario($idUsuario)."']]";
								}
								else
								{
                            ...
                            <table>
                            <tr>
                                <td class="tituloPaginas" align="center" class="" >
                                    <span>Programa de actividades</span><br /><br /><br />
                                </td>
                            </tr>
                            <tr>
                            <td align="left">
                            	
                        	<span id="tblArbolGantt">
                            ...
                            <input type="hidden" id="frmModuloFecha" value="<?php echo $frmModuloFecha?>" />
                            ...
                            <input type="hidden" id="altoVentana" value="660" />
                            <input type="hidden" id="idUsuario" value="<?php echo  base64_encode($idUsuario)?>" />
                            <input type="hidden" id="nombreUsuario" value="<?php echo obtenerNombreUsuario($idUsuario)?>" />
                            <input type="hidden" id='fInicioProy' value="<?php echo $fInicioProy ?>" />
                            <input type="hidden" id='fFinProy' value="<?php echo $fFinProy ?>" />
                             <script>
							 	
								<?php
									echo "var arrUsuarios=".$arrUsuarios.";";
									echo $eJs;
								?>
							</script>
                        </td>
