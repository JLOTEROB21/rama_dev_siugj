				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td>
							...
							?>
                            <script type="text/javascript" src="../modeloProyectos/Scripts/moduloAdemdums.js.php?iF=<?php echo base64_encode($idFormulario)?>&iR=<?php echo base64_encode($idReferencia)?>"></script>
                        	<table width="100%">
                            	<tr>
                                	<td align="center">
                                ...
                                <tr>
                                	<td align="center">
										...
										?>
                                        	<tr>
                                            	<td align="right">
                                                	<span class="letraFichaRespuesta">Para agregar un nuevo ademdum de click</span><a href="javascript:agregarNuevo()"><span class="letraRoja"> AQUI</span></a>
                            ...
                            <input type="hidden" id="altoVentana" value="500" />
                            <script>
								<?php
									echo $eJs;
								?>
