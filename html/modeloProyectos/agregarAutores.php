...
<script type="text/javascript" src="Scripts/agregarAutores.js.php"></script>
	...
	<div class="<?php echo $wrapper ?>">
		...
		<div > 
                   ...
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->idFormulario))
								$idFormulario=bD($objParametros->idFormulario);
							$idRegistro="-1";
							if(isset($objParametros->idRegistro))
								$idRegistro=bD($objParametros->idRegistro);
							$cPagina="";
						...
						?>
                        <span class="tituloPaginas">Registro de <?php echo $plural?></span><br /><br /><br />
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <tr>
                      ...
                      <td class="letraFicha" height="23" width="140" align="left"><?php echo $et["lblApPaterno"]?>:</td>
                      <td align="left" >&nbsp;&nbsp;<input type="text" name="txtApPaterno" id="txtApPaterno"  size="20" /></td>
                    </tr>
                    <tr>
                      
                      <td class="letraFicha" height="23"  align="left"><?php echo $et["lblApMaterno"]?>:</td>
                      <td  align="left">&nbsp;&nbsp;<input type="text" name="txtApMaterno" id="txtApMaterno"  size="20" /></td>
                    </tr>
                   
                    <tr>
                      
                      <td  class="letraFicha" height="23"  align="left"><?php echo $et["lblNombres"]?>: <font color="red">*</font></td>
                    ...
                    <tr>
                      ...
                      <td  class="letraFicha" height="23"  align="left"><?php echo $et["lblMail"]?>: <font color="red">*</font></td>
                      <td  align="left">&nbsp;&nbsp;<input type="text" name="txtMail" id="txtMail" size="50" /></td>
                    </tr>
                    <tr>
                    	 <td class="letraFicha" height="23" width="140" align="left">Participación:</td>
                     	 <td align="left" >&nbsp;&nbsp;
                         <select id='cmbParticipacion'>
                         <?php
			...
			<tr>
			  ...
			  <fieldset class="frameHijo"> 
			  <legend class="letraFicha"><?php echo $et["lblDatosAfiliacion"]?></legend>
			  <br />
			  	<table border="0" >
			...
			<tr>
              <td colspan="3" align="center" >
				<br />
                <input class="btnGuardar" type="submit" name="btnAgregarAutor" id="btnAgregarAutor" value="<?php echo $et["lblBtnAceptar"] ?>"  onclick="agregarAutor()" />
