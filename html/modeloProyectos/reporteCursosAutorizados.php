			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
                        <span class="tituloPaginas">Listado de capacitaciones autorizadas</span>
                        <br />
                        <br />
                        <script type="text/javascript" src="../modeloProyectos/Scripts/reporteCursosAutorizados.js.php"></script>
                        	<table>
                            	<tr>
                                	<td>
                                    	<table>
