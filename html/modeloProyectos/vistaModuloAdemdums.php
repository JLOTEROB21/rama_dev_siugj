                   ...
                   <tr>
                        <td>
                        	...
                        	<table width="100%">
                            	<tr>
                                	<td align="center">
                                    <span class="tituloPaginas">Ademdums de proyecto</span>
                                    </td>
                                </tr>
                                <tr>
                                	<td align="center">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                            	<td align="left">
                                                <br /><br />
	       	                                       <table id="hor-minimalist-b" style="width:630px !important">
                                                       <thead>
                                                       		<th class="rounded-q1 " style="text-align:center; width:30px !important "></th>
                                                            <th class="rounded-q1 " style="text-align:center; width:300px !important "><b>Proyecto</b></th>
                                                            <th class="rounded-q1 " style="text-align:center; width:300px !important "><b>Tipo de proyecto</b></th>
                                                       </thead>
                                                       <tbody>
                                                       	<?php
															$clase="filaBlanca10";
															...
															?>
                                                            	<tr>
                                                                	<td align="left" class="<?php echo $clase?>"><?php echo $ct?>.-</td>
                                                                	<td align="left" class="<?php echo $clase?>"><?php echo $nProy?></td>
                                                                    <td align="left" class="<?php echo $clase?>"><?php echo $tipo?></td>
                                                                </tr>
                                                            <?php
