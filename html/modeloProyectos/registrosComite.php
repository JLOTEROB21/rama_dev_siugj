...
?>
<script type="text/javascript" src="Scripts/registrosComite.js.php"></script>
<!-- InstanceEndEditable -->
                   ...
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->idComite))
								$idComite=bD($objParametros->idComite);
							echo  generarTableroControlObjetoComite($tipoProceso,"REGISTROS",$idProceso,$idComite);
						?>
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
