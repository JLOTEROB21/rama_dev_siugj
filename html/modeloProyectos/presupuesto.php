			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
				   ...
				   ?>
                   <script type="text/javascript" src="../modeloProyectos/Scripts/presupuesto.js.php?idFormulario=<?php echo $idFormulario ?>&idRegistro=<?php echo $idRegistro ?>&idProceso=<?php echo $idProceso ?>"></script>
                   <tr>
                        <td align="center">
