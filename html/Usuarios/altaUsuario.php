			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
				   <?php
					...
					$altaPersonal="ALTA DE PERSONAL";
					if(isset($objParametros->titulo))
						$altaPersonal=$objParametros->titulo;
					
					$ocultarDomicilio='';
					if(isset($objParametros->ocultarDomicilio))
						$ocultarDomicilio='none';
						
					$ocultarFechaNac='';
					if(isset($objParametros->ocultarFechaNacimiento))
						$ocultarFechaNac='none';
					
					$ocultarLugarNac='';
					if(isset($objParametros->ocultarLugarNacimiento))
						$ocultarLugarNac='none';
					
					$ocultarPrefijo='';
					if(isset($objParametros->ocultarPrefijo))
						$ocultarPrefijo='none';
					
					$ocultarCurp='';
					if(isset($objParametros->ocultarCurp))
						$ocultarCurp='none';
					
					$ocultarIssste='';
					if(isset($objParametros->ocultarIssste))
						$ocultarIssste='none';
					
					$ocultarRFC="";
					if(isset($objParametros->ocultarRFC))
						$ocultarRFC='none';
						
					$arrRolesAsigna="";
					if(isset($objParametros->arrRolesAsigna))	
						$arrRolesAsigna=$objParametros->arrRolesAsigna;
					
					$funcionScript="";
					if(isset($objParametros->funcionScript))	
						$funcionScript=$objParametros->funcionScript;
					$codigoInstitucion=$_SESSION["codigoInstitucion"];
					if(isset($objParametros->codigoInstitucion))	
						$codigoInstitucion=$objParametros->codigoInstitucion;
					$codigoUnidad=$_SESSION["codigoUnidad"];
					if(isset($objParametros->codigoUnidad))	
						$codigoUnidad=$objParametros->codigoUnidad;
					$generarPassword=0;
					if(isset($objParametros->generarPassword))	
						$generarPassword=$objParametros->generarPassword;
                   ...
                   <tr>
                        <td>
                            ...
                            <tr>
                            	<td align="center"><span class="tituloPaginas"><?php echo $altaPersonal?></span></td>
                            </tr>
				  			<tr>
								<td align="left" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <tr height="27" valign="top">
                                                ...
                                                <td align="left"><label style="display:<?php echo $ocultarPrefijo?>">Prefijo (Sr, Dr):</label></td>
                                                <td> </td>
                                                <td><label style="display:<?php echo $ocultarPrefijo?>">
                                                    <input  type="text" name="Prefijo" id="Prefijo" value='<?php echo ($cInfo[3]);?>'/>
                                                    </label>
                                                 </td>
                                            </tr>
                                            <tr height="27" valign="top" style="display:<?php echo $ocultarFechaNac?>">
                                            ...
                                            <tr height="27" valign="top" style="display:<?php echo $ocultarLugarNac?>">
                                            ...
                                            <tr height="27" style="display:<?php echo $ocultarLugarNac?>">
                                                <td><label>Estado de Nacimiento:</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr height="27" valign="top">
                                                ...
                                                <td></td>
                                                <td><label style="display:<?php echo $ocultarRFC ?>">RFC:</label>
                                                </td>
                                                <td></td>
                                                <td><input style="display:<?php echo $ocultarRFC ?>" type="text" name="RFC" id="RFC" value='<?php echo ($cInfo[8]);?>'/></td>
                                             </tr>
                                             <tr height="27">
                                                 <td><label style="display:<?php echo $ocultarIssste ?>">CURP:</label></td>
                                                 <td><input style="display:<?php echo $ocultarIssste ?>" type="text" name="CURP" id="CURP" value='<?php echo ($cInfo[12]);?>'/></td>
                                                 <td></td>
                                                 <td><label style="display:<?php echo $ocultarIssste ?>">ISSSTE:</label></td>
                                                  <td></td>
                                                 <td>
                                                        <label style="display:<?php echo $ocultarIssste ?>">
                                	...
                                	<br />
								<fieldset class="frameHijo" style="display:<?php echo $ocultarDomicilio?>"><legend><b>DIRECCIÓN PERSONAL</legend>
                            ...
                            <input type="hidden" name="arrRolesAsigna" value="<?php echo $arrRolesAsigna?>" />
                            <input type="hidden" name="funcionScript" value="<?php echo $funcionScript?>" />
                            ...
                            <input type="hidden" name="generarPassword" value="<?php echo $generarPassword?>" />
