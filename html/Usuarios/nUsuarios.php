                   	...
                   	<tr>
						...
						<input type="hidden" id="lblLogin" value="<?php echo $cInfo["Login"]?>" />
                          ...
                          <table width="100%">
                              ...
                              <tr height="50">
                                  <td></td>
                                  <td width="440" align="left"><span class="letraTituloCampoRegistro">Estado en n&oacute;mina</span></td>
                                  <td width="10"></td>
                                  <td width="440" align="left"><span class="letraTituloCampoRegistro"></span></td>
                              </tr>
                              <tr height="50">
                                  <td></td>
                                  <td  align="left" colspan="3">
                                  	<div style="width:800px; padding-top: 10px;" class="SIUGJ_Control"><?php echo $fAdscripcion["statusNomina"]?></div>
