			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center"><span class="tituloPaginas">Definición de Indicadores</span>
                        <?php
							$idFormulario="-1";
						...
						?>	
                        	<script type="text/javascript" src="../modulosEspeciales_Censida/Scripts/indicadoresProyectos.js.php?iF=<?php echo $idFormulario?>&iR=<?php echo $idRegistro?>"></script>
                        	<br />
                            <br /><br /><br />
                            <table>
                            	<tr>
                                	<td align="left">
                                    	<span class="letraRojaSubrayada8">Indique lo valores que pretende alcanzar a través del proyecto para cada indicador (0 Si no pretende cubrir algún indicador):</span><br /><br />
                                    	<span id="tblIndicadores"></span>
                                    </td>
                                </tr>
                                <tr>
                                	<td align="center"><br /><br />
                                    <input type="button" class="btnAceptar" onclick="guardarIndicadores()" value="Aceptar" />
                                    </td>
                                </tr>
                            </table>
