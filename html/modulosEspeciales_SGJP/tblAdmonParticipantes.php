...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblAdmonParticipantes.js.php"></script>
<!-- InstanceEndEditable -->
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT idCarpeta,idActividad FROM 7006_carpetasAdministrativas WHERE carpetaAdministrativa='".$carpetaAdministrativa.
                        ...
                        ?>
                        	<input type="hidden" value="<?php echo $idCarpetaAdministrativa?>" id="idCarpetaAdministrativa" />
                            <input type="hidden" value="<?php echo $idActividad?>" id="idActividad" />
                            <input type="hidden" value="<?php echo $carpetaAdministrativa?>" id="carpetaAdministrativa" />
