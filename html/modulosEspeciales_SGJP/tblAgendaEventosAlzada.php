...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblAgendaEventosAlzada.js.php"></script>
                   ...
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->idEvento))
							{
								...
								$consulta="SELECT c.idCarpeta FROM 7007_contenidosCarpetaAdministrativa con,7006_carpetasAdministrativas c 
											WHERE tipoContenido=3 AND idRegistroContenidoReferencia=".$idEvento."
											AND c.carpetaAdministrativa=con.carpetaAdministrativa";
							...
							$consulta="SELECT id__17_tablaDinamica,idReferencia FROM _17_tablaDinamica WHERE claveUnidad='".$fCarpeta[1]."'";
                        ...
                        <input type="hidden" id="uGestion" value="<?php echo $idUnidadGestion?>" />
