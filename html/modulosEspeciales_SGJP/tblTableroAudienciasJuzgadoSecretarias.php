...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblTableroAudienciasJuzgadoSecretarias.js.php"></script>
<style>
	body
	{
		min-height:500px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if(isset($_POST["idJuzgado"]))
							{
	                        	$uGestion=$_POST["idJuzgado"];
								$consulta="SELECT claveUnidad FROM _17_tablaDinamica WHERE id__17_tablaDinamica='".$uGestion."'";
								$uGestion=$con->obtenerValor($consulta);
							}
                        ...
                        ?>
                        	<input type="hidden" id="periodoInicio" value="<?php echo $periodoInicio ?>" />
                            <input type="hidden" id="periodoFin" value="<?php echo $periodoFin ?>" />
