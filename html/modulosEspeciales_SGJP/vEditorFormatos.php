...
<script src="../modulosEspeciales_SGJP/Scripts/vEditorFormatos.js.php" ></script>
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$tipoFormato=-1;							
							$consulta="SELECT tipoFormato,idFormulario,idRegistro,idReferencia,cuerpoFormato,idRegistroFormato FROM 3000_formatosRegistrados WHERE idFormulario=".$idFormulario." and idReferencia=".$idRegistro;
							...
							if(!$fFormato)
							{
								...
								$consulta="SELECT tipoDefinicionFormato,idFormato,funcionDefinicionFormato FROM 3003_configuracionModuloFormatos WHERE idProceso=".$idProceso." AND idPerfil=".$idPerfil;
								...
								if($fConfiguracion)
								{
									switch($fConfiguracion[0])
									{
										case 1:  //Seleccion directa
											$tipoFormato=$fConfiguracion[0];
										break;
										case 2:
											if($fConfiguracion[2]!="")
											{
												$cacheCalculos=NULL;
												$cadParametros='{"idFormulario":"'.$idFormulario.'","idRegistro":"'.$idRegistro.'","actor":"'.bD($actor).'"}';
                        ...
                        <textarea style="width:450px" id="txtDocumento"></textarea>
