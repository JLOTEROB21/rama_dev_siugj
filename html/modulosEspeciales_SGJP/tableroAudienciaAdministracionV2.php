				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT carpetaAdministrativa,etapaProcesalActual FROM 7006_carpetasAdministrativas  WHERE carpetaAdministrativa='".$carpetaAdministrativa."'";
                        ...
                        ?>
                        	...
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tableroAudienciaAdministracion.js.php?cA=<?php echo bE($carpetaAdministrativa)?>"></script>
