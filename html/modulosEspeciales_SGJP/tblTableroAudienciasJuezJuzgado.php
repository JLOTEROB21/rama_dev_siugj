...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblTableroAudienciasJuezJuzgado.js.php"></script>
<style>
	body
	{
		min-height:500px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if($idUsr!=0)	
							{
								$consulta="SELECT nombre  FROM 800_usuarios WHERE idUsuario=".$idUsr;	
								$nombreUsuario=$con->obtenerValor($consulta);
							}
                        ?>
                        	<input type="hidden" id="idUsuario" value="<?php echo $idUsr ?>" />
                            <input type="hidden" id="nombreUsuario" value="<?php echo $nombreUsuario ?>" />
                            <input type="hidden" id="uGestion" value="<?php echo $_SESSION["codigoInstitucion"] ?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
