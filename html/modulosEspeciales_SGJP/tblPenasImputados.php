...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblPenasImputados.js.php"></script>
<?php
	$paramGET=true;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT idActividad,idEstado FROM _385_tablaDinamica WHERE id__385_tablaDinamica=".$idRegistro;
							$fRegistro=$con->obtenerPrimeraFila($consulta);
							$idActividad=$fRegistro[0];
							$idEstado=$fRegistro[1];
