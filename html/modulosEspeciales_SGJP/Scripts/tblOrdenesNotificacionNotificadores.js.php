...
var arrSituacionOrden=[['3,4','Cualquiera'],['3','En espera de atenci\xF3n'],['4','Atendida']]; 
...
function crearGridOrdenesNotificacion()
{
    ...
    cmbSituacionOrdenes.setValue('3');
    ...
    var filters = new Ext.ux.grid.GridFilters	(
    												{
                                                    	filters:	[ 
                                                                        ...
                                                                        {type: 'date', dataIndex: 'fechaAsignacion'},
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        proxy.baseParams.iUsr='<?php echo $_SESSION["idUsr"]?>';
                                                                ...
                                                                renderer:function(val,meta,registro)
                                                                		{
                                                                            ...
                                                                            {
                                                                            	return '<a href="javascript:window.parent.mostrarVentanaAtencionOrdenNotificacionNotificador(\''+bE('{"idOrden":"'+val+'"}')+'\')"><img src="../images/magnifier.png" width="14" height="14" title="Ver orden de notificaci&oacute;n" alt="Ver orden de notificaci&oacute;n"></a>';
                                                                            }
                                                                        }
                                                            },
                                                            {
