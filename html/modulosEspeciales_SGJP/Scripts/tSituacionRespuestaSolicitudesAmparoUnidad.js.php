<?php
	...
	$consulta="SELECT numEtapa,nombreEtapa FROM 4037_etapas WHERE idProceso=164 ORDER BY numEtapa";
	...
	$consulta="SELECT numEtapa,nombreEtapa FROM 4037_etapas WHERE idProceso=204 ORDER BY numEtapa";
	$res=$con->obtenerFilas($consulta);
	while($fila=mysql_fetch_row($res))
	{
		$o="[".$fila[0].",'".removerCerosDerecha($fila[0]).".- ".$fila[1]."']";
...
var arrSituacion=[['0','Respuesta NO generada/notificada','../images/bullet-red.png'],['1','Respuesta en espera de envio a CJF','../images/bullet-red.png'],['2','Respuesta enviada a CJF','../images/bullet-green.png'],['3','Respuesta NO enviada al CJF (Con Error)','../images/bullet-red.png']];
...
var arrModulos=[['346','Registro de Juicio de Amparo Inicial'],['460','Recepci&oacute;n de promociones sobre Juicio de Amparo']];    
...
{
	var cmbSituacionSolicitud= crearComboExt('cmbSituacionSolicitud',[['4','Cualquiera'],['0','Respuesta NO notificada'],['1','Respuesta Notificada al CJF']],0,0,250);
	...
	alDatos.on('beforeload',function(proxy)
        ...
        var cModelo= new Ext.grid.ColumnModel   	(
                                                        [
                                                            ...
                                                            {
                                                                header:'Carpeta de Amparo',
                                                                width:145,
                                                                sortable:true,
                                                                dataIndex:'carpetaAmparo',
                                                                renderer:function(val)
                                                                		{
