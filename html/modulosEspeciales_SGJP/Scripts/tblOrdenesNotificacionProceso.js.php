...
var arrSituacionOrden=[['1,2,3,4','Cualquiera'],['1','En espera de env\xEDo a JUD de Notificadores'],['2','En espera de atenci\xF3n (JUD de Notificadores)'],['3','En espera de atenci\xF3n (Notificador)'],['4','Atendida']]; 
...
function crearGridOrdenesNotificacion()
{
    ...
    cmbSituacionOrdenes.setValue('1,2,3,4');
                                                                ...
                                                                renderer:function(val,meta,registro)
                                                                		{
                                                                            ...
                                                                            {
                                                                            	if(parseInt(registro.data.situacion)!=4)
					                                                                return '<a href="javascript:mostrarOrdenNotificacion(\''+bE(val)+'\')"><img src="../images/magnifier.png" width="14" height="14" title="Ver orden de notificaci&oacute;n" alt="Ver orden de notificaci&oacute;n"></a>';                	
                                                                                else
                                                                            		return '<a href="javascript:mostrarOrdenNotificacionCerrada(\''+bE(val)+'\')"><img src="../images/magnifier.png" width="14" height="14" title="Ver orden de notificaci&oacute;n" alt="Ver orden de notificaci&oacute;n"></a>';
                                                                            }
                                                                        }
                                                            },
                                                            {
                                                            ...
                                                            handler:function()
                                                                    {
                                                                        ...
                                                                        msgConfirm('Est&aacute; seguro de querer enviar la orden de notificaci&oacute;n al JUD de notificadores?',resp);
                                                                    }
...
function subidaCorrecta(file, serverData) 
{
    ...
    else 
    {
        ...
        {
        	var cadObj='{"carpetaAdministrativa":"'+carpetaAdministrativa+'","idFormulario":"'+gE('idFormulario').value+'","idRegistro":"'+gE('idRegistro').value+'","idArchivo":"'+arrDatos[1]+'","nombreArchivo":"'+arrDatos[2]+
            '","tipoDocumento":"'+gEx('cmbTipoDocumento').getValue()+'","descripcion":"'+cv(gEx('txtDescripcion').getValue())+'","idOrden":"'+idOrden+'"}';
...
function mostrarOrdenNotificacionCerrada(iO)
{
