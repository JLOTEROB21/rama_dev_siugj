<?php
	...
	if($tipoMateria=="C")
	{
		$consulta="SELECT claveUnidad,if(tituloJuzgadoAnterior is null,nombreUnidad,(concat(nombreUnidad,'/',tituloJuzgadoAnterior))) FROM _17_tablaDinamica WHERE cmbCategoria in(1,2) ".$comp." ORDER BY prioridad";
       ...
       var chkRow=new Ext.grid.CheckboxSelectionModel({singleSelect:true});       
        ...
        var cModelo= new Ext.grid.ColumnModel   	(
                                                        [
                                                            ...
                                                            {
                                                                header:'Situaci&oacute;n Causa Penal',
                                                                width:220,
                                                                sortable:true,
                                                                dataIndex:'situacion',
                                                                renderer:function(val)
