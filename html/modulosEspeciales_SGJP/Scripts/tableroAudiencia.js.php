    	...
    	arrPanelesRight.push	(
                                   {
                                      ...
                                      title:'Actuaci&oacute;n Judicial',
                                      items:	[
                                                  crearGridActuacionDigital()
                                              ]
                                  }
                                );
    }
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                items:	[
                                                                                ...
                                                                                /*bbar:	[
                                                                                			{
                                                                                            	...
                                                                                            	text:'Iniciar grabaci&oacute;n'
                                                                                                
                                                                                            },'-',
                                                                                            {
                                                                                            	icon:'../images/control_pause.png',
                                                                                            	text:'Pausar grabaci&oacute;n'
                                                                                                
                                                                                            },'-',
                                                                                            {
                                                                                            	icon:'../images/Stop-Normal-Red-icon.png',
                                                                                            	text:'Finalizar grabaci&oacute;n'
                                                                                                
                                                                                            },'-',
                                                                                			{
                                                                                            	icon:'../images/control_play_blue.png',
                                                                                            	text:'Reproducir grabaci&oacute;n'
                                                                                                
                                                                                            }
                                                                                		],*/	
                                                                                tbar:	[
                                                                                			<?php
																								echo $arrMenusFunciones;
																								if((existeRol("'1_0'"))||existeRol("'112_0'"))
																								{
																									?>
																									{
																										...
																										cls:'x-btn-text-icon',
																										text:'Aperturar captura de resolutivos',
																										hidden:(gE('situacionCaptura').value=='0'),
																										handler:function()
																												{
																													function respAux(btn)
																													{
																														if(btn=='yes')
																														{
																															...
																															obtenerDatosWeb('../paginasFunciones/funcionesModulosEspeciales_SGP.php',funcAjax, 'POST','funcion=154&iE='+gE('idEventoAudiencia').value,true);
																														}
																													}
																													msgConfirm('Est&aacute; seguro de querer aperturar la captura de resolutivos?',respAux);
																												}
																							...
																							?>
                                                                                            {
                                                                                                  ...
                                                                                                  cls:'x-btn-text-icon',
                                                                                                  hidden:(gE('situacionCaptura').value=='1'),
                                                                                                  text:'Finalizar captura de resolutivos',
                                                                                                  handler:function()
                                                                                                          {
																												function resp(btn)
                                                                                                                {
                                                                                                                	if(btn=='yes')
                                                                                                                    {
                                                                                                                    	gEx('frameContenido').getFrameWindow().finalizarInforme();
                                                                                                                    }
                                                                                                                }
                                                                                                                msgConfirm('Est&aacute; seguro de querer finalizar la captura de los resolutivos?',resp);
                                                                            ...
                                                                            
                                                                            {
                                                                                ...
                                                                                activeTab:0,
                                                                                items:	[
                                                                                			crearGridBibliotecaApoyo(),
                                                                                            crearGridResolutivosAcciones()
                                                                                		]
                                                                            }
                                                                            */
...
function crearArbolSujetosProcesales()
{
                                                                ...
                                                                tbar:	[
                                                                			{
                                                                                ...
                                                                                cls:'x-btn-text-icon',
                                                                                hidden:true,
                                                                                id:'btnAcuerdosReparatorios',
                                                                                tooltip:'Buscar acuerdos reparatorios...',
                                                                                handler:function()
                                                                                        {
                                                                                            ...
                                                                                            obj.ancho='100%';
                                                                                            obj.height='100%';
                                                                                            obj.url='../modulosEspeciales_SGJP/tblBusquedaCarpetaAcuerdoReparatorio.php';
                                                                                            obj.params=[['autoload','1'],['name',Ext.util.Format.stripTags(nodoSelCheck.text)]];
                                                                            ...
                                                                            },'-',
                                                                            {
                                                                                ...
                                                                                hidden:true,
                                                                                id:'btnComputoPena',
                                                                                tooltip:'Registrar compurga de pena',
                                                                                handler:function()
                                                                                        {
                                                                                            var arrId=nodoSelCheck.id.split('_');
                                                                                            var obj={};
                                                                                            obj.ancho='100%';
                                                                                            obj.height=500;
                                                                                            obj.url='../modulosEspeciales_SGJP/tblCalculoPena.php';
                                                                                            obj.params=[['sL',gE('sL').value],['cPagina','sFrm=true'],['idEventoAudiencia',gE('idEventoAudiencia').value],
                                                                                            			['idImputado',arrId[1]],['carpetaJudicial',gE('carpetaAdministrativa').value]];
                                                                                            abrirVentanaFancy(obj);
                                                                                        }
                                                                            ...
                                                                            },
                                                                            {
                                                                                ...
                                                                                cls:'x-btn-text-icon',
                                                                                hidden:true,
                                                                                tooltip:'Agregar participante de audiencia',
                                                                                text:'',
                                                                                handler:function()
                                                                                        {
    ...
    arbolSujetosJuridicos.on('checkchange',chkParticipanteChange);	                                                                 
...
function funcSujeto(nodo, evento)
{
    ...
    if(nodo.attributes.tipo=='1')
    {
    	...
    	gEx('gDatosParticipante').getStore().load	(
        												{
                                                            url:'../paginasFunciones/funcionesModulosEspeciales_SGP.php',
                                                            params:	{
                                                                        idFigura:arrDatosNodo[2],
                                                                        idParticipante:arrDatosNodo[1],
                                                                        idEvento: gE('idEventoAudiencia').value
                                                                    }
                                                        }
        											)
