<?php
	...
	$consulta="SELECT claveUnidad,nombreUnidad FROM _17_tablaDinamica WHERE cmbCategoria=3 order by prioridad";
...
function cargarTableroUnidadGestion()
{
	gEx('frameContenidoHijo').load	(
    								{
                                    	url:'../modulosEspeciales_SGJP/tblTableroAudienciasTribunalAlzada.php',
                                   		params:	{
