<?php
	...
	{
		$salaPenalSugeridaAuxiliar=$filaSalaPenalSugeridaAuxiliar[0];
		$o="['".$filaSalaPenalSugeridaAuxiliar[0]."','".$filaSalaPenalSugeridaAuxiliar[2]."','Sala penal sugerida por JUD de Control','".cv($filaSalaPenalSugeridaAuxiliar[1])."','".($filaSalaPenalSugeridaAuxiliar[2]==1?" (Existe antecedente)":"")."']";
		if($arrSalas=="")
			$arrSalas=$o;
		else
			$arrSalas.=",".$o;
...
function inyeccionCodigo()
{
    ...
    gE('sp_9856').innerHTML=lblEtiqueta
