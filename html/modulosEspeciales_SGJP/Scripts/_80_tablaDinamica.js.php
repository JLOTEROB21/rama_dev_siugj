<?php
	...
	$consulta="SELECT idEvento FROM _".$iF."_tablaDinamica WHERE  id__".$iF."_tablaDinamica=".$iR;	
...
function inicializar()
{
	...
	if(esRegistroFormulario())
    {
    	...
    	asignarEvento(gE('_idEventovch'),'change',function(cmb)
                                                {
