<?php
	...
	$arrRolesUgas[3]="152_0";
	$arrRolesUgas[4]="207_0";
	...
	$consulta="SELECT claveUnidad,nombreUnidad FROM _17_tablaDinamica WHERE cmbCategoria in(3) ".$comp." ORDER BY prioridad";
	...
	$consulta=" SELECT DISTINCT t.idTipoCarpeta,nombreTipoCarpeta  FROM 7006_carpetasAdministrativas c,7020_tipoCarpetaAdministrativa t 
				 WHERE ".$comp2." c.tipoCarpetaAdministrativa=t.idTipoCarpeta and t.idTipoCarpeta=8 order by prioridad";
       ...
       var chkRow=new Ext.grid.CheckboxSelectionModel({singleSelect:true});       
        ...
        var cModelo= new Ext.grid.ColumnModel   	(
                                                        [
                                                            ...
                                                            {
                                                                header:'Carpeta Judicial de Alzada',
                                                                width:160,
                                                                sortable:true,
                                                                dataIndex:'carpetaAdministrativa',
