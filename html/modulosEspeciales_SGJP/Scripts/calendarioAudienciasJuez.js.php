<?php
	...
	if($tipoMateria=="SC")
	{
		...
		$compVistaJzugado='&vJuzgado=1&iJ='.$idJuzgado;
	}
	
?>

var compVistaJzugado='<?php echo $compVistaJzugado?>';
var dragged_event;
...
function inicializar()
{
    ...
    scheduler.load("../paginasFunciones/funcionesPanelCalendario.php?funcion=7&vVacaciones="+gE('vVacaciones').value+'&vIncidencias='+gE('vIncidencias').value+
    			'&vGuardias='+gE('vGuardias').value+'&vTramite='+gE('vTramite').value+'&idJuez='+gE('idUsr').value+compVistaJzugado,"json");
