...
function inyeccionCodigo()
{
	...
	if(esRegistroFormulario())
    {
        ...
        {
            gEx('f_sp_dteFechaSentenciadte').setValue(fechaActual);
        
            gEx('f_sp_dteFechaSentenciadte').fireEvent('change', gEx('f_sp_dteFechaSentenciadte'), gEx('f_sp_dteFechaSentenciadte').getValue());
