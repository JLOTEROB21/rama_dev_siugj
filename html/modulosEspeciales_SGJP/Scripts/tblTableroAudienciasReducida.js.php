<?php
	...
	$consulta="SELECT idReferencia FROM _17_tablaDinamica WHERE claveUnidad='".$_SESSION["codigoInstitucion"]."'";
	$idEdificio=$con->obtenerValor($consulta);
	
	$consulta="SELECT id__15_tablaDinamica, nombreSala FROM _15_tablaDinamica s
			where s.idReferencia=".$idEdificio." order by nombreSala";
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        proxy.baseParams.iEdificio=idEdificio;
