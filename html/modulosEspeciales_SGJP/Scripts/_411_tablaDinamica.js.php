...
{	
    ...
    arrSeccion3.push('p14');
	arrSeccion3.push('p15');
    arrSeccion3.push('p16');
    
    arrSeccion4.push('p17');   
    arrSeccion4.push('p18');   
    arrSeccion4.push('p19');    

	arrSeccion5.push('p20');   
    ...
    {
    	gE('_[total]vch').innerHTML='<span id="sp_8632">'+Ext.util.Format.number(gEN('_totalvch')[0].value,'0.00')+ ' %</span>';
    }
