<?php
	...
	$consulta="SELECT MIN(r.fechaRecordatorio) FROM 7037_recordatoriosPreviosNotificacion r,7036_alertasNotificaciones a WHERE 
				a.carpetaAdministrativa='".$carpetaAdministrativa."' AND r.idAlertaNotificacion=a.idRegistro";
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        //proxy.baseParams.tDocumentos='52,32,3,13,29';
                                        proxy.baseParams.cA=bE(nodoCarpetaSel.id.split('_')[0]);
                                        proxy.baseParams.idCarpetaAdministrativa=(nodoCarpetaSel.id.split('_0')[0]==gE('carpetaAdministrativa').value)?nodoCarpetaSel.attributes.iCarpeta:-1;
                                    }
                        )   
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        {
                                        	nodoCarpetaSel={};
                                        	nodoCarpetaSel.id=gE('carpetaAdministrativa').value;
                                        ...
                                        proxy.baseParams.cJ=nodoCarpetaSel.id.split('_')[0];

                                        proxy.baseParams.idCarpetaAdministrativa=(nodoCarpetaSel.id.split('_')[0]==gE('carpetaAdministrativa').value)?nodoCarpetaSel.attributes.iCarpeta:-1;
                                                                ...
                                                                renderer:function(val,meta,registro)
                                                                		{
                                                                            ...
                                                                            if(nodoCarpetaSel.id!=gE('carpetaAdministrativa').value)    
                                                                            	return val;
                                                                            if(parseInt(registro.data.situacionResolutivos)!='1')
                                                                            	return val;    
        ...
        var tblGrid=	new Ext.grid.GridPanel	(
                                                            {
                                                                ...
                                                                tbar:	[
                                                                			<?php
																			if((existeRol("'69_0'"))||(existeRol("'1_0'"))||existeRol("'112_0'")||existeRol("'81_0'")||existeRol("'54_0'")||existeRol("'152_0'")||existeRol("'26_0'"))
																			{
																			?>
                                                                            {
...
function abrirTableroAudiencia(iE)
{
    ...
    obj.params=[['idEventoAudiencia',bD(iE)],['sL','1'],['vC','1']];    
        ...
        var tblGrid=	new Ext.grid.GridPanel	(
                                                            {
                                                                ...
                                                                store:alDatos,
                                                                title:'Historial de status de carpeta',
                                                                region:'center',
                                                                frame:false,
                                                                cm: cModelo,
                                                                stripeRows :true,
                                                                ...
                                                                tbar:	[
                                                               				{
																				icon:'../images/add.png',
																				cls:'x-btn-text-icon',
																				text:'Registrar cambio de status de carpeta',
																				handler:function()
																						{
...
{
	var cmbCambioStatusCarpeta=crearComboExt('cmbCambioStatusCarpeta',arrStatusCarpeta,220,5,320);
	var form = new Ext.form.FormPanel(	
										{
											baseCls: 'x-plain',
											layout:'absolute',
											...
											items: 	[
                                            			{
                                            				x:10,
                                            				y:10,
                                            				html:'Cambiar status de la carpeta a:'
                                            			},
															...
															handler: function()
																	{
																		...
																		if(cmbCambioStatusCarpeta.getValue()=='')
																		{
																			...
																			msgBox('Debe indicar el status al cual desea cambiar la carpeta',resp);
																			return;
																		}
																		...
																		if(txtMotivoCambio.getValue()=='')
																		{
																			...
																			msgBox('Debe indicar el motivo del cambio de status de la carpeta',resp2);
																			return;
																		}
																		...
																		function respAux(btn)
																		{
																			if(btn=='yes')
																			{
																				var cadObj='{"carpetaAdministrativa":"'+gE('carpetaAdministrativa').value+
																						'","statusCarpeta":"'+cmbCambioStatusCarpeta.getValue()+
																						'","motivoCambio":"'+cv(txtMotivoCambio.getValue())+'"}';
																		...
																		msgConfirm('Est&aacute; seguro de querer cambiar el status de la carpeta?',respAux);
...
function formatearFilaPrescripcion(record, rowIndex, p, ds) 
{
	...
	p.body +=			'<tr height="21"><td valign="top" width="220"><span class="TSJDF_Etiqueta">Pena:</span></td><td valign="top" width="600"><span class="TSJDF_Control">'+record.data.pena+'</span></td></tr>';
   	...
   	if(record.data.tipoEntrada=='5')
   	{
   		...
   		p.body +=			'<tr height="21"><td valign="top"><span class="TSJDF_Etiqueta">Fecha de inicio de pena:</span></td><td valign="top" width="600"><span class="TSJDF_Control">'+Date.parseDate(record.data.fechaInicioPena,'Y-m-d').format('d/m/Y')+'</span></td></tr>';
...
{
	var cmbDetalle_P=crearComboExt('cmbDetalle_P',[],200,5,150,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
    cmbDetalle_P.disable();
	if(cmbDetalle_P.getStore().getCount()==0)
    	cmbDetalle_P.hide();
    
    var cmbNacionalidad_P=crearComboExt('cmbNacionalidad_P',arrNacionalidadesCP,160,65,200,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
    ...
    var cmbGenero_P=crearComboExt('cmbGenero_P',arrGeneroCP,95,155,130,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
    cmbGenero_P.disable();
    var cmbEstadoCivil_P=crearComboExt('cmbEstadoCivil_P',arrEstadoCivilCP,95,185,135,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
    cmbEstadoCivil_P.disable();
    var cmbIdentificacion_P=crearComboExt('cmbIdentificacion_P',arrTipoIdentificacion,420,185,280,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
	...
	var cmbEstado=crearComboExt('cmbEstado',arrEstados,70,65,170,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
    cmbEstado.on('select',obtenerMunicipios);
    cmbEstado.disable();
    var cmbMunicipio=crearComboExt('cmbMunicipio',[],320,65,180,{otrasConfiguraciones:{disabledClass :'comboDisabled'}});
