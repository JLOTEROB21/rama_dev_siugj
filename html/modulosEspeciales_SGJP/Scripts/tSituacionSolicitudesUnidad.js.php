...
{
	var cmbTipoAtencion=crearComboExt('cmbTipoAtencion',[['1','Normal'],['2','Urgente']],0,0,180);
    cmbTipoAtencion.setValue('2');
    cmbTipoAtencion.on('select',function()
    							{
                                	recargarGrid();
                                }
                      )
                      
	var cmbSituacionSolicitud= crearComboExt('cmbSituacionSolicitud',[['1','Atendido'],['2','En espera de atenci\xF3n']],0,0,180);
    cmbSituacionSolicitud.setValue('2');
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        proxy.baseParams.tipoAtencion=gEx('cmbTipoAtencion').getValue();
                                                        ...
                                                        [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                renderer:function(val,meta,registro)
                                                                		{
                                                                        	var arrDatos;
                                                                            if(registro.data.iFormulario=='46')
                                                                            	arrDatos=arrEtapasSolIniciales;
                                                                            else
                                                                            	arrDatos=arrEtapasSolPromociones;
                                                                           
                                                                        	return formatearValorRenderer(arrDatos,val,1,true);
                                                                        }
                                                            }
                                                        ]
                                                    );
        ...
        var tblGrid=	new Ext.grid.GridPanel	(
                                                            {
                                                                ...
                                                                tbar:	[
                                                                            {
                                                                                xtype:'label',
                                                                                html:'<b>&nbsp;&nbsp;&nbsp;Tipo de Atenci&oacute;n:&nbsp;&nbsp;&nbsp;</b>'
                                                                            },
                                                                            cmbTipoAtencion,
                                                                            '-',
                                                                             {
	...
	gEx('gSolicitudesIniciales').getStore().load	(
    											{
                                                    ...
                                                    params:	{
                                                                ...
                                                                tipoAtencion:gEx('cmbTipoAtencion').getValue(),
