...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblAgendaEventosControl.js.php"></script>
                   ...
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT id__17_tablaDinamica,u.idReferencia,c.tipoCarpetaAdministrativa,c.idJuezTitular FROM 7006_carpetasAdministrativas c,_17_tablaDinamica u WHERE 
									carpetaAdministrativa='".$carpetaAdministrativa."' AND claveUnidad=c.unidadGestion";
							...
							$idJuezOriginal=-1;
							$consulta="SELECT idJuez,noJuez,tipoJuez,titulo,serieRonda,noRonda FROM 7001_eventoAudienciaJuez 
									WHERE idRegistroEvento=".($fEvento?$fEvento["idRegistroEvento"]:-1);
							...
							$idAuxiliarSala=$fEvento["idAuxiliarSala"];
							$nombreAuxiliarSala=$fEvento["idAuxiliarSala"]==""?"":obtenerNombreUsuario($fEvento["idAuxiliarSala"]);
							if(($fEvento["idReunionVirtual"]!="0")&&($fEvento["idReunionVirtual"]!=""))
							{
								$consulta="SELECT * FROM 7050_reunionesVirtualesProgramadas WHERE idRegistro=".$fEvento["idReunionVirtual"];

								$fReunionVirtual=$con->obtenerPrimeraFilaAsoc($consulta);
								$requiereMesaEvidencia=$fReunionVirtual["mesaEvidencia"];
							}
                        ...
                        <input type="hidden" id="requiereMesaEvidencia" value="<?php echo $requiereMesaEvidencia?>" />
                        <input type="hidden" id="idAuxiliarSala" value="<?php echo $idAuxiliarSala?>" />
                        <input type="hidden" id="nombreAuxiliarSala" value="<?php echo $nombreAuxiliarSala?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
