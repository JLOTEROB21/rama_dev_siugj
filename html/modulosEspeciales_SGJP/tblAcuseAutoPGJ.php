                   ...
                   <tr>
                        ...
                        <?php
							...
							if($sL==0)
							{
								...
								if($fDatosRegistro && ($fDatosRegistro["notificadoPGJ"]==1))
								{
									$sL=1;
								}
                        ...
                        ?>
                        	<script type"text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblAcuseAutoPGJ.js.php?iF=<?php echo $idFormulario?>&iR=<?php echo $idRegistro?>"></script>
                            ...
                            <input type="hidden" id="idCarpeta" value="<?php echo $idCarpeta?>" /><br>
                        	<table>
                            	<tr>
                                	<td>
                                    	<span id="divFrm"></span>
                            ...
                            <?php
								...
								{
							?>
                            <div id="sticky" style="z-index: 998;">
                              <table width="100%">
                              <tbody><tr>
                                  <td align="right">
                                      <table>
                                          <tbody>
                                          <tr>
                                              <td><span id="contenedor1"></span>
                                              </td>
                                              <td><span id="contenedor2"></span>
                                              </td>
                                          </tr>
                                      </tbody></table>
                                  </td>
