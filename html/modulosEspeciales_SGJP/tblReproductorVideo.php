                        ...
                        ?>
							...
							vid.onloadeddata  = function() 	
											{
												...
												var duracion=(vid.duration/60);
												
												guardarDatosVideo(duracion);
							...
							function obtenerVideo()
							{
								function funcAjax()
								{
									...
									{
										msgBox('Error <br />'+arrResp[0]);
									}
								}
								obtenerDatosWeb('../paginasFunciones/funcionesModulosEspeciales_SGP.php',funcAjax, 'POST','funcion=81',true);
							}
							
							
							function guardarDatosVideo(duracion)
							{
								function funcAjax()
								{
									var resp=peticion_http.responseText;
								...
								obtenerDatosWeb('../paginasFunciones/funcionesModulosEspeciales_SGP.php',funcAjax, 'POST','funcion=82&duracion='+duracion+'&idEvento='+idEvento,true);
							}
							
							function actualizarVideo(url)
							{
								vid.src=url;
							}
							
							vid.onerror = function() {
														guardarDatosVideo(-10);
													};
