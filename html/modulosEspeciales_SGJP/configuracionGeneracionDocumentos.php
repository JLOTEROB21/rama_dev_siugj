...
<?php
	$tituloModulo="Documentos permitidos";
	$paramGET=true;
	?>
...
<script type="text/javascript" src="../Scripts/fancyBox/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
	...
	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/configuracionGeneracionDocumentos.js.php"></script>
<!-- InstanceEndEditable -->
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT * FROM 3019_categoriaDocumentosAdjuntos WHERE idProceso=".$idProceso." AND idPerfil=".$idPerfil." AND 				
										idFormularioProceso=".$idFormularioProceso;
							$fConfiguracion=$con->obtenerPrimeraFila($consulta);
							$idCategoriaDocumento="";
							$permiteSeleccionPlantilla=0;
							$permiteEdicionTextoEnriquecido=0;
							$permiteSubirWord=1;
							$idFormatoDefault=0;
							$funcionAsignacion=-1;
							$publicaEnBoletin=0;
							$permiteConfiguracionBoletin=0;
							$lblFuncionAsignacion="-1";
							$permiteGuardarSinCambios=0;
							if($fConfiguracion)
							{
								...
								$idFormatoDefault=$fConfiguracion[8];
								$permiteConfiguracionBoletin=$fConfiguracion[9];
								$publicaEnBoletin=$fConfiguracion[10];
								$funcionAsignacion=$fConfiguracion[11];
								$permiteGuardarSinCambios=$fConfiguracion[12];
								if($funcionAsignacion=="")
									$funcionAsignacion=-1;
								$consulta="SELECT nombreConsulta FROM 991_consultasSql WHERE idConsulta=".$funcionAsignacion;
								$lblFuncionAsignacion=$con->obtenerValor($consulta);
							}
                        ...
                        ?>
                        	...
                        	<table width="800">
                        		<tr>
									<td align="center"><span id="tblGrid"></span></td>
								</tr>
                                <tr>
                                	<td>
                             ...
                             <input type="hidden" id="idFormularioProceso" name="idFormularioProceso" value="<?php echo $idFormularioProceso ?>" />
							<input type="hidden" id="idCategoriaDocumento" name="idCategoriaDocumento" value="<?php echo $idCategoriaDocumento ?>" />
                             ...
                             <input type="hidden" id="idFormatoDefault" name="idFormatoDefault" value="<?php echo $idFormatoDefault ?>" />
                             ...
                             <input type="hidden" id="funcionAsignacion" name="funcionAsignacion" value="<?php echo $funcionAsignacion ?>" />
                             <input type="hidden" id="lblFuncionAsignacion" name="lblFuncionAsignacion" value="<?php echo $lblFuncionAsignacion ?>" />
                             <input type="hidden" id="permiteGuardarSinCambios" name="permiteGuardarSinCambios" value="<?php echo $permiteGuardarSinCambios ?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
