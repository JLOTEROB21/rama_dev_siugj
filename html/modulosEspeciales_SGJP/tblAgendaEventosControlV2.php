...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblAgendaEventosControlV2.js.php"></script>
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT id__17_tablaDinamica,u.idReferencia,c.tipoCarpetaAdministrativa FROM 7006_carpetasAdministrativas c,_17_tablaDinamica u WHERE 
