...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblTableroAudienciasReporte.js.php"></script>
<style>
	body
	{
		min-height:500px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->uGestion))
	                        	$uGestion=$objParametros->uGestion;
							
							if(isset($objParametros->listaAudiencias))
	                        	$listaAudiencias=$objParametros->listaAudiencias;
								
							$consulta="SELECT nombreUnidad FROM _17_tablaDinamica WHERE id__17_tablaDinamica=".$uGestion;
                        ...
                        ?>
                            ...
                            <input type="hidden" id="listaAudiencias" value="<?php echo $listaAudiencias ?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
