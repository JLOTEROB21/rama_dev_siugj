...
$formularioEvaluacion=-1;
if(isset($_POST["formularioEvaluacion"]))
	$formularioEvaluacion=$_POST["formularioEvaluacion"];
	
	
$listaJueces=-1;
if(isset($_POST["listaJueces"]))
	$listaJueces=$_POST["listaJueces"];


$arrGraficos=array();
$arrJueces=json_decode("[".bD($listaJueces)."]");
$listaJueces="";
foreach($arrJueces as $j)
{
	if($listaJueces=="")
		$listaJueces=$j->idJuez;
	else
		$listaJueces.=",".$j->idJuez;
	
	
	$imageData=bD($j->grafico);
	$filteredData = substr($imageData, strpos($imageData, ",") + 1);
	$unencodedData = base64_decode($filteredData);
	$nombreArchivoPng=generarNombreArchivoTemporal(2,"_");
	escribirContenidoArchivo($baseDir."/archivosTemporales/".$nombreArchivoPng.".png",$unencodedData);
	
	$arrGraficos[$j->idJuez]="http://10.19.5.9/archivosTemporales/".$nombreArchivoPng.".png";
}
...
$consulta="select * from (SELECT (SELECT nombreUnidad FROM _17_tablaDinamica WHERE id__17_tablaDinamica=j.idReferencia) AS unidadGestion,
		...
		IN(".$unidadGestion.") AND usuarioJuez in(".$listaJueces.")) as tmp  ORDER BY unidadGestion, ".$sort." ".$dir;//
...
while($fRegistro=mysql_fetch_assoc($rConsulta))
{
	$resultado="";
	foreach($arrSecciones as $id=>$resto )
	{
		$resto=utf8_decode($resto);
		if($resultado=="")
		{
			$resultado=$resto.": ".number_format($fRegistro["seccion_".($id-1)],2)."%";
		}
		else
		{
			$resultado.="<br>".$resto.": ".number_format($fRegistro["seccion_".($id-1)],2)."%";
		}
	}
	if($unidadGestion!=$fRegistro["unidadGestion"])
	{
		$unidadGestion=$fRegistro["unidadGestion"];
		$arrJueces.='	<tr style=\'mso-yfti-irow:1;height:29.15pt\'>
						  <td width=964 colspan=5 valign=top style=\'width:722.7pt;border:solid windowtext 1.0pt;
						  ...
						  mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><b>'.
						  utf8_decode($unidadGestion).'</b><span
						  style=\'font-size:9.0pt\'><o:p></o:p></span></p>
						  </td>
					 </tr>
				';
	}
	$oJuez='	<tr style=\'mso-yfti-irow:2;mso-yfti-lastrow:yes;height:29.15pt\'>
					  ...
					  normal;mso-element:frame;mso-element-frame-hspace:7.05pt;mso-element-wrap:
					  around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:margin;
					  mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><span
					  style=\'font-size:9.0pt\'>'.utf8_decode($fRegistro["nombreJuez"]).'<o:p></o:p></span></p>
					  </td>
					  ...
					  around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:margin;
					  mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><span
					  style=\'font-size:9.0pt\'>'.number_format($fRegistro["total"],2).'<o:p></o:p></span></p>
					  </td>
					  ...
					  margin;mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><span
					  style=\'font-size:9.0pt\'>'.number_format($fRegistro["totalEvaluaciones"],0).'<o:p></o:p></span></p>
					  </td>
					  ...
					  around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:margin;
					  mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><span
					  style=\'font-size:9.0pt\'>'.$resultado.'</span></p>
					  </td>
					  ...
					  around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:margin;
					  mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><span
					  style=\'font-size:9.0pt;mso-fareast-language:ES-MX;mso-no-proof:yes\'><img
					  width=350 height=250 id="_x0000_i1025"
					  src="'.$arrGraficos[$fRegistro["idJuez"]].'"
					  alt="'.$arrGraficos[$fRegistro["idJuez"]].'"></span><span style=\'font-size:9.0pt\'>
					  <o:p></o:p></span></p>
					  </td>
					 </tr>
				';
...
$cuerpoDocumento='<html xmlns:v="urn:schemas-microsoft-com:vml"
...
<link rel=File-List href="reporte%20(3)_archivos/filelist.xml">
<link rel=Edit-Time-Data href="reporte%20(3)_archivos/editdata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>novant</o:Author>
  <o:LastAuthor>novant</o:LastAuthor>
  <o:Revision>2</o:Revision>
  <o:TotalTime>15</o:TotalTime>
  <o:Created>2018-10-08T18:45:00Z</o:Created>
  <o:LastSaved>2018-10-08T18:45:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>75</o:Words>
...
<link rel=themeData href="reporte%20(3)_archivos/themedata.thmx">
<link rel=colorSchemeMapping
href="reporte%20(3)_archivos/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
  <w:View>Print</w:View>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 align=left
 width=964 style=\'width:722.7pt;border-collapse:collapse;border:none;
 ...
 -36.05pt;mso-table-top:61.55pt;mso-padding-alt:0cm 5.4pt 0cm 5.4pt\'>
 <tr style=\'mso-yfti-irow:0;mso-yfti-firstrow:yes;height:29.15pt\'>
  <td width=189 valign=top style=\'width:141.8pt;border:solid windowtext 1.0pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:29.15pt\'>
  <p class=MsoNormal align=center style=\'margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal;mso-element:frame;mso-element-frame-hspace:
  7.05pt;mso-element-wrap:around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:
  margin;mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><b
  style=\'mso-bidi-font-weight:normal\'><span style=\'font-size:9.0pt\'>Nombre del
  Juez<o:p></o:p></span></b></p>
  </td>
  <td width=48 valign=top style=\'width:35.9pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:29.15pt\'>
  <p class=MsoNormal align=center style=\'margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal;mso-element:frame;mso-element-frame-hspace:
  7.05pt;mso-element-wrap:around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:
  margin;mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><b
  ...
  7.05pt;mso-element-wrap:around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:
  margin;mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><b
  style=\'mso-bidi-font-weight:normal\'><span style=\'font-size:9.0pt\'>Evaluaciones<o:p></o:p></span></b></p>
  </td>
  ...
  7.05pt;mso-element-wrap:around;mso-element-anchor-vertical:page;mso-element-anchor-horizontal:
  margin;mso-element-left:-36.0pt;mso-element-top:61.55pt;mso-height-rule:exactly\'><b
  style=\'mso-bidi-font-weight:normal\'><span style=\'font-size:9.0pt\'>Secciones<o:p></o:p></span></b></p>
  </td>
...
//header("Content-length: ".sizeof($cuerpoDocumento)); 
header("Content-Disposition: inline; filename=reporte.doc");
echo $cuerpoDocumento;
/*$nombreAleatorio=generarNombreArchivoTemporal();
$nomArchivo=$nombreAleatorio.".html";
escribirContenidoArchivo($nomArchivo,$cuerpoDocumento);
$nombreFinal=str_replace(".html",".pdf",$nomArchivo);
