...
//				$consulta="select clave from 507_objetosGasto where codigoControl='".$partida."'";
	...
	function guardarConceptosNomina()
	{
		...
		$consulta[$x]="DELETE FROM 994_valoresDevueltoFuncion WHERE idConsulta=".$obj->idConcepto;
		$x++;
		...
		{
			$consulta[$x]="INSERT INTO 994_valoresDevueltoFuncion(idConsulta,nombreValor,descripcion) VALUES(".$obj->idConcepto.",'".cv($o->nombreValor)."','".cv($o->descripcion)."')";
			$x++;
