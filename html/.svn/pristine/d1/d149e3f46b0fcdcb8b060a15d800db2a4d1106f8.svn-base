        ...
        var tblGrid=	new Ext.grid.GridPanel	(
                                                            {
                                                                ...
                                                                tbar:	[
                                                                            ...
                                                                            {
                                                                                icon:'../images/../images/page_word.png',
                                                                                cls:'x-btn-text-icon',
                                                                                text:'Adjuntar documento de Word',
                                                                                menu:	[
                                                                                			{
                                                                                                  icon:'../images/user_gray.png',
                                                                                                  cls:'x-btn-text-icon',
                                                                                                  text:'Adjuntar Documento de Auto',
                                                                                                  handler:function()
                                                                                                          {
                                                                                                          		mostrarVentanaAddDocumento('122',true);
                                                                                                          }
                                                                                            },'-',
                                                                                            {
                                                                                                  icon:'../images/tablero.gif',
                                                                                                  cls:'x-btn-text-icon',
                                                                                                  text:'Adjuntar Constancia',
                                                                                                  handler:function()
                                                                                                          {
                                                                                                          		mostrarVentanaAddDocumento('505',true);
                                                                                                          }
                                                                                            }
                                                                                		]
                                                                            },'-',
                                                                            {
                                                                                ...
                                                                                cls:'x-btn-text-icon',
                                                                                text:'Utilizar plantilla de sistema',
                                                                                menu:	[
                                                                                			{
                                                                                                  icon:'../images/user_gray.png',
                                                                                                  cls:'x-btn-text-icon',
                                                                                                  text:'Utilizar Plantilla de Auto',
                                                                                                  handler:function()
                                                                                                          {
                                                                                                          		mostrarVentanaAddDocumento('122',false);
                                                                                                          }
                                                                                            },'-',
                                                                                            {
                                                                                                  icon:'../images/tablero.gif',
                                                                                                  cls:'x-btn-text-icon',
                                                                                                  text:'Utilizar Plantilla Constancia',
                                                                                                  handler:function()
                                                                                                          {
                                                                                                          		mostrarVentanaAddDocumento('505',false);
                                                                                                          }
                                                                                            },'-',
                                                                                            {
                                                                                                  icon:'../images/icon_documents.gif',
                                                                                                  cls:'x-btn-text-icon',
                                                                                                  text:'Utilizar Plantilla de Oficio/Otros',
                                                                                                  handler:function()
                                                                                                          {
                                                                                                          		mostrarVentanaAddDocumento();
                                                                                                          }
                                                                            ...
                                                                            handler:function()
                                                                            		{
                                                                                    	if(!nodoPlantillaSel)
                                                                                        {
                                                                                            msgBox('Debe seleccionar el tipo de documento que adjuntar&aacute;');
                                                                                            return;
                                                                                        }
                                                                                        gEx('wCreateDocumentDocument').close();
                                                                                    	mostrarVentanaDatosDocumento(null,true);
                                                                                    }
...
function visualizarDocumentoFinalizado(iD,tD)
{
	function funcAjax()
    {
        ...
        if(arrResp[0]=='1')
        {
            ...
            window.parent.mostrarVisorDocumentoProceso(extension,arrResp[1]);
        }
        else
        {
            msgBox('<?php echo $etj["errOperacion"]?>'+' <br />'+arrResp[0]);
