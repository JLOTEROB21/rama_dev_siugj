...
<script type="text/javascript" src="Scripts/seleccionActividadOrigen.js.php"></script>
<!-- InstanceEndEditable -->
<?php
                   ...
                   <tr>
                        ...
                        <?php
								...
								if(isset($objParametros->idRegistro))
									$idReferencia=$objParametros->idRegistro;
								$eJs="";
								...
								$consulta="select nombreTabla,idProceso from 900_formularios where idFormulario=".$idFormulario;
								...
								$consulta="select * from 982_actividadesOrigen where idFormulario=".$idFormulario." and idReferencia=".$idReferencia;
                        ...
                        <table width="100%">
                        	<tr>
                            	<td align="center" colspan="2"><span class="tituloPaginas">Selección de actividad que dió como producto el actual elemento de CV</span></td>
                            </tr>
                            <tr>
                            	...
                            	<td align="center" ><br /><br /><br />
                                	<table width="450">
                                    	<tr height="23">
                                            ...
                                            <td align="left">&nbsp;
                                            	<select id='anioAct' onchange="anioChange(this)">
                                            <?php
												$con->generarNumeracionSelect(2008,date('Y'),$anio);
											?>
                                            	</select>
                                            </td>
                                        ...
                                        <tr height="23">
                                        	<td align="left">
                                            	<label>Actividad:</label><font color="#FF0000">*</font>
                                            </td>
                                            <td align="left">&nbsp;
                                            	<select id='actividad'>
                                        ...
                                        <tr>
                                        	<td colspan="2" align="center"><br /><br />
                                            	<input type="button" class="tituloTabla" value="Guardar" onclick="guardarActividad()" />
