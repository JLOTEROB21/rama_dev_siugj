                                        ...
                                        loading:function(isLoading,view)
                                        		{
                                                	if(!isLoading)
                                                    {
                                                        ...
                                                        if(eventos.length>0)
                                                        {
                                                        	var dteFecha=window.parent.gEx('txtFechaEvento');
                                                            ...
                                                            eventos[0].start=Date.parseDate(dteFecha.getValue().format('Y-m-d')+' '+dteFechaInicial.format('H:i:s'),'Y-m-d H:i:s');
                                                            eventos[0].end=Date.parseDate(dteFecha.getValue().format('Y-m-d')+' '+dteFechaFinal.format('H:i:s'),'Y-m-d H:i:s');
                                                            
                                                            
                                                            eventos[0].end.add(Date.DAY,parseInt(diferenciaDias));
                                                            $('#calendar').fullCalendar('updateEvent', eventos[0]);
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            var tmeHoraFin=window.parent.gEx('cmbHoraTermino');
                                        ...
                                        dayClick: function(date, jsEvent, view) 
                                        			{
                                                        ...
                                                        if(eventos.length==0)
                                                        {
                                                            ...
                                                            evento.color='#900';
                                                            $('#calendar').fullCalendar('renderEvent', evento);
                                                            window.parent.calcularHoraFinal(fecha.format('H:i:s'));
                                                        }
                                                        else
                                                        {
