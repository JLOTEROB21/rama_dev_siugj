...
$idEstiloMenu=bD($_GET["iC"]);

if($idEstiloMenu=="")
	$idEstiloMenu=-1;
$consulta="SELECT funcionInicializacion FROM 808_configuracionEstilosMenu WHERE idConfiguracion=".$idEstiloMenu;
$funcionInicial=$con->obtenerValor($consulta);	
...
function inicializar()
{
	...
	try
    {
    	var urlInicio='../tesoreria/tblSituacionComprobantesEmpresas.php';
        ...
        var urlInicio='../paginasFunciones/white.php';
        <?php
			if(existeRol("'15_0'"))
			{
		...
		<?php
			if(isset($_SESSION["idUsr"])&&($_SESSION["idUsr"]!="-1"))
			{
				...
				if(existeRol("'7_0'"))
				{
					if((strpos($urlSitio,"ugm.grupolatis.net")!==false)||(strpos($urlSitio,"latisstudent.grupolatis.net")!==false))
					{
					...
					echo "urlInicio='../Alumno/fichaBaseAlumno.php';";
					
				}
				
				if(existeRol("'79_0'"))
					echo "urlInicio='../InscripAlumno/vistaAspiranteInscripcion.php';";
					
			
				if(existeRol("'77_0'"))
					echo "urlInicio='../modeloClinico/agendaCitasMedico.php';";
					
				if(existeRol("'7_0'"))
				{
					
					$idUsuario=generarNombreArchivoTemporal(1,"_");
					echo "urlInicio='../modulosEspeciales_ives/tblEvaluacionEnsenanza.php';";
					$paramComp=",idUsr:'".$idUsuario."'";
				}
...
{
	if((gEx('frameContenido'))&&( gEx('frameContenido').getFrameWindow().funcionAntesCerrar))
		gEx('frameContenido').getFrameWindow().funcionAntesCerrar();
    else
    {
...
function invocarEjecucionFuncionContenedor(funcion,params)
{
	...
	eval("gEx('frameContenido').getFrameWindow()."+funcion+"("+params+");");
}


function reinscribirAlumno()
{
	var arrDatos=[["idFormulario",946],["idRegistro",-1],["idReferencia",1],["actor",bE(203)],['dComp',bE('agregar')],['idUsuarioRegistro',76010],['idInstanciaPlan',37],['idCiclo',7],['idPeriodo',9]];//,['idUsuarioRegistro',76010],['idInstanciaPlan',37],['idCiclo',7],['idPeriodo',9]
  	var arrDatos=[["idFormulario",946],["idRegistro",3],["idReferencia",1],["actor",bE(803)],['dComp',bE('auto')],['idUsuarioRegistro',76010],['idInstanciaPlan',37],['idCiclo',7],['idPeriodo',9]];//,['idUsuarioRegistro',76010],['idInstanciaPlan',37],['idCiclo',7],['idPeriodo',9]
    //var arrDatos=[["idFormulario",933],["idRegistro",1],["actor",bE(784)],['dComp',bE('auto')],['idUsuarioRegistro',76010],['idInstanciaPlan',37]];//
...
function solicitudTitulacion()
{
	var arrDatos=[["idFormulario",769],["idRegistro",-1],["actor",bE(181)],['dComp',bE('agregar')],['idUsuarioRegistro',3176],['idInstanciaPlan',39]];
    var ventanaAbierta=window.open('',"vAuxiliar2", "toolbar=no,directories=no,menubar=no,status=no,scrollbars=yes,fullscreen=yes");
    enviarFormularioDatosV("../modeloPerfiles/vistaDTD.php",arrDatos,'POST','vAuxiliar2');
}

function solicitudTitulo()
{
	var arrDatos=[["idFormulario",845],["idRegistro",-1],["actor",bE(169)],['dComp',bE('agregar')],['idUsuarioRegistro',3176],['idInstanciaPlan',39],['idSolicitud',3]];
    var ventanaAbierta=window.open('',"vAuxiliar2", "toolbar=no,directories=no,menubar=no,status=no,scrollbars=yes,fullscreen=yes");
    enviarFormularioDatosV("../modeloPerfiles/vistaDTD.php",arrDatos,'POST','vAuxiliar2');
}
...
{
	var arrDatos=[["idFormulario",759],["idRegistro",-1],["actor",bE(152)],['dComp',bE('agregar')],['idUsuarioRegistro',3176],['idInstanciaPlan',39],['idSolicitud',4]];
    var ventanaAbierta=window.open('',"vAuxiliar2", "toolbar=no,directories=no,menubar=no,status=no,scrollbars=yes,fullscreen=yes");
    enviarFormularioDatosV("../modeloPerfiles/vistaDTD.php",arrDatos,'POST','vAuxiliar2');
}
...
{
	var arrDatos=[["idFormulario",923],["idRegistro",-1],["actor",bE(186)],['dComp',bE('agregar')],['idUsuarioRegistro',3176],['idInstanciaPlan',39],['idSolicitud',8]];
    var ventanaAbierta=window.open('',"vAuxiliar2", "toolbar=no,directories=no,menubar=no,status=no,scrollbars=yes,fullscreen=yes");
    enviarFormularioDatosV("../modeloPerfiles/vistaDTD.php",arrDatos,'POST','vAuxiliar2');
}

function solicitudExamen()
{
	var arrDatos=[["idFormulario",736],["idRegistro",-1],["actor",bE(186)],['dComp',bE('agregar')],['idUsuarioRegistro',3176],['idGrupo',9380],['idTipoExamen',3]];
    var ventanaAbierta=window.open('',"vAuxiliar2", "toolbar=no,directories=no,menubar=no,status=no,scrollbars=yes,fullscreen=yes");
    enviarFormularioDatosV("../modeloPerfiles/vistaDTD.php",arrDatos,'POST','vAuxiliar2');
}

function abrirCatalogoPacientes()
{
	gEx('frameContenido').load	(
                                    {
                                        url:'../modeloClinico/tblPacientes.php',
                                        scripts:true,
                                        params:	{
                                                    cPagina:'mR1=false|sFrm=true'
                                                }
...
function abrirAgendaCitas()
{
	gEx('frameContenido').load	(
                                    {
                                        url:'../modeloClinico/agendaCitas.php',
                                        scripts:true,
                                        params:	{
                                                    cPagina:'mR1=false'
                                                }
...
function abrirAgendaCitasMedico()
{
	gEx('frameContenido').load	(
                                    {
                                        url:'../modeloClinico/agendaCitasMedico.php',
                                        scripts:true,
                                        params:	{
                                                    cPagina:'mR1=false'
                                                }
...
var funcionIntervencionBiometrico=null;

function ejecutarAccionBiometrico(u)
{
	if((gEx('frameContenido'))&&( gEx('frameContenido').getFrameWindow().ejecutarAccionBiometrico))
    {
    	gEx('frameContenido').getFrameWindow().ejecutarAccionBiometrico(u);
        return;
    ...
    obtenerDatosWeb('../paginasFunciones/funciones.php',funcAjax, 'POST','funcion=8&u='+u,true);
...
{
	if((gEx('frameContenido'))&&( gEx('frameContenido').getFrameWindow().getUsuarioActivo))
    {
    	return gEx('frameContenido').getFrameWindow().getUsuarioActivo();
...
{
	if((gEx('frameContenido'))&&( gEx('frameContenido').getFrameWindow().notificarHuellaCapturada))
    {
    	gEx('frameContenido').getFrameWindow().notificarHuellaCapturada();
        return;
