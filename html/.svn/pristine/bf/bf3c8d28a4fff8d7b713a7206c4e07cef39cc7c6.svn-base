...
<link type="text/css" rel="stylesheet" href="../Scripts/plupload/js/jquery.plupload.queue/css/jquery.plupload.queueSIUGJ.css" media="screen" />
<script type="text/javascript" src="../gestorDocumental/Scripts/validaDocumentos.js.php"></script>
<style>
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="left">
                        <br /><br />
                        	<div class="letraTituloPagina" style="text-align:center">Validaci&oacute;n de Documentos</div><br /><br />
                        	<table width="1100">
                            	<tr>
