...
<script type="text/javascript" src="Scripts/crearContenido.js.php"></script>
<?php
	$pagRegresar="../Sistema/menus.php";
                   ...
                   <tr>
                        <td> 
                        	...
                        	<td>
								...
								<input type="hidden" value="<?php echo $idContenido?>" id="idContenido" name="idContenido" />
