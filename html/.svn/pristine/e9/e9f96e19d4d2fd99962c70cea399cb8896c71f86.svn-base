				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
							...
							?>
                            <script type="text/javascript" src="../modeloProyectos/Scripts/poa.js.php?iF=<?php echo  bE($idFormulario)?>&iR=<?php echo bE($idRegistro)?>"></script>
                        	<table>
                            	<tr>
                                	<td>
                                    <span class="tituloPaginas">Registro de POA</span><br /><bR />
                                    </td>
                                </tr>
                                <tr>
                                	<td>
