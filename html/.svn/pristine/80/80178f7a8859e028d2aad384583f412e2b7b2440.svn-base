...
<?php
	$tituloModulo="Reporte de audiencias";
...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblReporteAudienciasV2.js.php"></script>
<style>
	.x-grid3-hd-inner 
	{
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        ?>
                        	<table>
                            	<tr>
                                	<td align="left"><span id="tblUnidades"></span></td>
                                </tr>
                            </table>
