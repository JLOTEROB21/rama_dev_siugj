                                ...
                                items: [
                                            {
                                                ...
                                                tbar:	[	
                                                            ...
                                                            },
                                                			{
                                                                ...
                                                                html:'<div class="letraNombreTableroNegro">Promovente:</div>&nbsp;&nbsp;<div style="color:#1A3E9A !important" class="letraNombreTableroNegro">'+gE('nombreUsuario').value+'</div>'
                                                            },
                                                            {
                                                                xtype:"tbspacer",
                                                                width:15
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        proxy.baseParams.idParticipante=gE('idUsuario').value;
