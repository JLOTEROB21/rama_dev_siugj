...
?>
<script type="text/javascript" src="Scripts/proyectos.js.php"></script>
<!-- InstanceEndEditable -->
                   ...
                   <tr>
                        <td  align="center"><br />
                        	<?php
								...
								$idProceso="";
								if(isset($objParametros->idCv))
									$idProceso=$objParametros->idCv;
								$idUsuario="";
                        		...
                        		generarTableroControlProceso(3,"PROYECTOS","Proyectos",$sl,$idProceso,$idUsuario,$verCV);
							?>
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
