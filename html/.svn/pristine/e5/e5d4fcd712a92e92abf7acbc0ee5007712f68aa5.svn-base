...
<?php
	$tituloModulo="Datos de prescripci&oacute;n";
?>
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblDatosPrescripcion.js.php?iF=<?php echo bE($idFormulario)?>&iR=<?php echo bE($idRegistro)?>"></script>	
                        	<div id="sticky" >
                                <table width="100%">
                                <tr>
                                    <td align="right">
                            ...
                            <table width="980">
                            	<tr>
                                    ...
                                    <span class="TSJDF_Titulo">Datos de prescripci&oacute;n</span>
                                ...
                                <tr>
                                    ...
                                    <div class="lineaDivisoria" id="" style="width: 960px;height: px"><span id="sp_6865">_</span></div>
                                    </td>
                                </tr>
                            	<tr>
                                	<td align="left">
