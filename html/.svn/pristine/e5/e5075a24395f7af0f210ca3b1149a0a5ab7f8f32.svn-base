																					...
																					click:function()
																						{
                                                                                            ...
                                                                                            function funcAjax()
                                                                                            {
                                                                                            	var idReporte=gE('idProceso').value;
                                                                                                var resp=peticion_http.responseText;
                                                                                                arrResp=resp.split('|');
                                                                                                var cadObj;
                                                                                                if(arrResp[0]=='1')
                                                                                                {
                                                                                                    ...
                                                                                                    if(nodoSel.attributes.tipo=='ad')
                                                                                                    	...
                                                                                                    	tAlmacen=1;
                                                                                                    cadObj='"tipoDataSet":"2","tipoAlmacen":"'+tAlmacen+'","parametros":"'+cadParametros+'","nombreDataSet":"@nombreDS","descripcion":"@descripcion","idReporte":"'+idReporte+'","tabla":"'+objFinal.dTabla.nTablaO+'","camposProy":"'+objFinal.campos+'","operacion":"'+objFinal.operacion+'","tokenSql":['+arrTokens+']';
                                                                                                    cadObj="{"+cadObj+"}";
