                                ...
                                items: [
                                            {
                                                ...
                                                tbar:	[	
                                                            ...
                                                            <?php
																if((existeRol("'112_0'"))||(existeRol("'1_0'")))
																{
															?>
                                                            ,'-',
                                                            {
                                                                ...
                                                                renderer:function(val,meta,registro)
                                                                		{
                                                                        	//if(registro.data.situacion=='1')
	                                                                            return '<a href="javascript:registrarSolicitudAudiencia(\''+bE(val)+'\',\''+bE(registro.data.carpetaAdministrativa)+'\')"><img src="../images/book_edit.png" width="14" height="14" alt="Generar nueva audiencia" title="Generar nueva audiencia"><a>';
                                                                        }
                                                            },
                                                            <?php
															}
...
<?php
															...
															{	
                                                                header:'Con Recursos<br />adicionales',
                                                                width:100,
                                                                align:'center',
                                                                sortable:true,
                                                                dataIndex:'conRecursosAdicionales',
