...
<script type="text/javascript" src="../modulosEspeciales_SGJ/Scripts/tblTableroAudiencias.js.php"></script>
<style>
	body
	{
		min-height:500px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if($uGestion!=0)	
							{
								$consulta="SELECT nombreUnidad FROM _17_tablaDinamica WHERE claveUnidad='".$_SESSION["codigoInstitucion"]."'";	
								$nombreUnidad=$con->obtenerValor($consulta);
							}
                        ?>
                        	<input type="hidden" id="uGestion" value="<?php echo $uGestion ?>" />
                            <input type="hidden" id="nombreUnidad" value="<?php echo $nombreUnidad ?>" class="clase_unidad" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
