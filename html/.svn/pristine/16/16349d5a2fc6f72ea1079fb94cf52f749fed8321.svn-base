				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT calificacionFinal,dictamen,comentariosFinales FROM 9053_resultadoCuestionario2012 WHERE idRegistroCuestionario=".$idRegistro;
							...
							$consulta="SELECT idElemento,valorRespuesta,idRespuesta FROM 9054_respuestasCuestionario2012 WHERE idReferencia=".$idRegistro;
