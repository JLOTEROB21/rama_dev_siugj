...
function consultarDatosEvento(objConfRenderer)
{
	...
	function funcAjax(peticion_http)
    {
        ...
        if(arrResp[0]=='1')
        {
            ...
            if(objConf.horaInicio!='')
            {
                ...
                if(objConf.duracionReservada=='1')
                {
                	duracionEstimada='(Reservado)';
                }
                
                if(objConf.fechaRestringida=='1')
                {
                	fechaEvento='(Reservado)';
                }
                
                if(objConf.horarioRestringido=='1')
                {
                	lblHorario='(Reservado)';
                }
            ...
            tabla+='	<tr height="40"><td align="left" colspan="8" ><br><span class="tituloSIUGJ" style="width:750px">Datos de la Audiencia</span><br><br></td></tr>';
            
            if(objConfRenderer.mostrarCarpetaAsociada)
            {
            	var lblApertura='';
                if(objConfRenderer.permiteAperturaCarpetaAsociada)
                	lblApertura='[&nbsp;<span style="font-size:11px"><a href="javascript:abrirCarpetaJudicial()"><img src="../images/magnifier.png"> Abrir Expediente de Proceso Judicial</a></span>&nbsp;]';
	            tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Proceso Judicial:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.carpetaJudicial+' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+lblApertura+'</span></td></tr>';
            }
            
            tabla+='	<tr height="30"><td align="left" width="230"><span class="SIUGJ_Etiqueta">Nombre del Evento:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+(objConf.nombreEvento==''?'(Sin nombre del evento)':objConf.nombreEvento)+'</span></td></tr>';
            tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Descripci&oacute;n:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+(objConf.descripcionEvento==''?'(Sin descripci&oacute;n del evento)':objConf.descripcionEvento)+'</span></td></tr>';
            ...
            if(objConfRenderer.mostrarIDEvento)
	            tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">ID Evento:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.idEvento+'</span></td></tr>';
            if(objConfRenderer.mostrarFechaAudiencia)
            {
	            ...
	            tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Fecha de la Audiencia:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+fechaEvento+' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[<span style=""><b>Situaci&oacute;n:</b> '+objConf.lblSituacion+btnInfoSituacion+'</span>]</span></td></tr>';
            }
            
            if(objConfRenderer.mostrarFechaAudiencia)
            {
            	if(objConfRenderer.mostrarSoloHoraInicial)
                	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Horario:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+lblHorarioInicial+'</span></td></tr>';
                else
            		tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Horario:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+lblHorario+'</span></td></tr>';
            }
            ...
            if(objConfRenderer.mostrarTipoAudiencia)
            {
            	if(objConfRenderer.permiteModificarTipoAudiencia)
                {
                	...
                	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Tipo de Audiencia:</span></td><td colspan="3" align="left"><select id="cmbTipoAudicia" class="SIUGJ_ControlEtiqueta" style="width:400px" onchange="cmbTipoAudienciaChange(this)"></select></td></tr>';
                }
                else
                {
            		tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Tipo de Audiencia:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.tipoAudiencia+'</span></td></tr>';
	            }
            }
            
            if(objConfRenderer.mostrarDuracionAudiencia)
            {
            	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Duraci&oacute;n estimada:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+duracionEstimada+'</span></td></tr>';
            }
            
            if(objConfRenderer.mostrarSalaAudiencia)
            {
            	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Sala Asignada:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.sala+'</span></td></tr>';
            }
            
            if(objConfRenderer.mostrarSecretariaAudiencia)
            {
            	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Sala:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.sala+'</span></td></tr>';
            }
            
            if(objConfRenderer.mostrarCentroGestion)
            {
            	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Despacho:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.unidadGestion+'</span></td></tr>';
            }
            if(objConfRenderer.mostrarEdificio)
            {
            	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Sede:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+objConf.edificio+'</span></td></tr>';
            }
            if(objConfRenderer.mostrarJueces)
            {
            	if(objConf.tipoCarpeta=='8')
                	tabla+='	<tr height="30"><td align="left" style="vertical-align:top; padding-top:4px"><span class="SIUGJ_Etiqueta">'+((objConf.jueces.length==1)?'Magistrado asignado:':'Magistrados asignados:')+'</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+lblJueces+'</span></td></tr>';
               	else
            		tabla+='	<tr height="30"><td align="left" style="vertical-align:top; padding-top:4px"><span class="SIUGJ_Etiqueta">'+((objConf.jueces.length==1)?'Juez/Magistrado:':'Juez/Magistrado:')+'</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+lblJueces+'</span></td></tr>';
            }
            ...
            var x;
            for(x=0;x<objConf.arrParticipantes.length;x++)
            {
            	if(participantes=='')
                	participantes=objConf.arrParticipantes[x].nombre;
                else
                	participantes+='<br>'+objConf.arrParticipantes[x].nombre;
            }
            
            tabla+='	<tr height="30"><td align="left" valign="top"><span class="SIUGJ_Etiqueta">Participantes:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+participantes+'</span></td></tr>';
            
            
            if(lblAciones!='')
            {
            	tabla+='	<tr style="display:none"><td  align="right"  colspan="4"><span class="SIUGJ_ControlEtiqueta">'+lblAciones+'</span></td></tr>';
            }         
			
            if(objConfRenderer.mostrarAsignacionAuxiliar)
            {
  				          
            	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Auxiliar de sala asignado:</span></td><td colspan="3" align="left"><table><tr><td><span class="SIUGJ_ControlEtiqueta" id="spNombreAuxiliar">'+
            ...
            if(objConf.arrRecursosAdicionalesRequeridos.length>0)
            {
                ...
                tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Recursos adicionales requeridos:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+arrRecursosAdicionales+'</span></td></tr>';
            }
            ...
            {
                tabla+='	<tr height="30"><td align="left" colspan="4" ><br><span class="tituloSIUGJ" style="width:650px">Desarollo de la audiencia</span><br></td></tr>';
                if(objConfRenderer.mostrarDuracionDesarrollo)
            	{
                	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Duraci&oacute;n de la audiencia:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+duracionReal+'</span></td></tr>';
                }
                
                
                if((objConfRenderer.mostrarHorarioDesarrollo)||(objConfRenderer.permiteModificarHorarioDesarrollo))
            	{
                	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Horario de desarrollo:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+lblHorarioReal+'</span></td></tr>';
                }
                
                if(objConfRenderer.permiteModificarHorarioDesarrollo)
                {
                	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Horario de desarrollo real:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta">'+
            	...
            	{
                	tabla+='	<tr height="30"><td align="left"><span class="SIUGJ_Etiqueta">Documento multimedia:</span></td><td colspan="3" align="left"><span class="SIUGJ_ControlEtiqueta"><a href="'+objConf.urlMultimedia+'">'+objConf.urlMultimedia+'</a></span></td></tr>';
               	}
			}
        	...
        	if(objConfRenderer.permiteModificarRecurso)
            {
            	arrOpciones.push	(
                						{
        	...
        	if(objConfRenderer.renderTo)
            {
            	objConf.renderTo=objConfRenderer.renderTo;
            }
            
            if(objConfRenderer.region)
            {
            	objConf.region=objConfRenderer.region;
            }
        	
        
       		if(arrOpciones.length>0)
	        	objConf.tbar=arrOpciones;
        	console.log(objConf);
            var panelAudiencia=	new Ext.Panel 	(
                                                    objConf
                                                )                    
        	...
        	if(objConfRenderer.panelDestino)
            {
            	
            	gEx(objConf.panelDestino).add(panelAudiencia);
             	gEx(objConf.panelDestino).doLayout(); 
            }
        }
        else
        {
    ...
    obtenerDatosWebV2('../modulosEspeciales_SGJ/paginasFunciones/funcionesModulosEspeciales_SGJ.php',funcAjax, 'POST','funcion=22&iE='+objConfRenderer.idEvento,false);
