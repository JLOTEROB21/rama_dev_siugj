...
<script src="../modulosEspeciales_SGJP/Scripts/editorFormatosSeleccionFormatoEdicto.js.php" ></script>
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT noPublicaciones FROM _513_tablaDinamica WHERE id__513_tablaDinamica=".$idRegistro;
							$noPublicaciones=$con->obtenerValor($consulta);
							...
							if($listaDocumentos=="")					
								$listaDocumentos=-1;	
							$consulta="SELECT tipoFormato,idFormulario,idRegistro,idReferencia,cuerpoFormato,idRegistroFormato,documentoBloqueado,idDocumentoAdjunto FROM 3000_formatosRegistrados 
										WHERE idFormulario=-2 and idRegistro in(".$listaDocumentos.") and idFormularioProceso=".$idFormularioProceso;
                        ...
                        <input type="hidden" id="noPublicaciones" name="noPublicaciones" value="<?php echo $noPublicaciones ?>" />
