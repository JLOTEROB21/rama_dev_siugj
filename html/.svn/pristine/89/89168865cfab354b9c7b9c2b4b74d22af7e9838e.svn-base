<?php
	...
	while($filaFigura=$con->fetchRow($res))
	{
...
var modoEdicionParticipante=false;
...
function agregarParticipanteVentana(tipoParticipante,nombreTipo,objConf,edicion)
{
	if(typeof(esModuloExpediente)=='undefined')
    {
    	esModuloExpediente=false;
    }
	modoEdicionParticipante=edicion?true:false;
															...
															handler: function()
																	{
                                                                            ...
                                                                            function funcAjax()
                                                                            {
                                                                                ...
                                                                                if(arrResp[0]=='1')
                                                                                {
                                                                                	...
                                                                                	if(objConf && objConf.afterRegister)
                                                                                    {
                                                                                    	...
                                                                                    	objConf.afterRegister(arrResp[1],tipoParticipante);
                                                                                    }
                                                                                    else
                                                                        ...
                                                                        if(personaMoral)
                                                                        {
                                                                           ...
                                                                           cadObj='{"resultadoBusquedaWS":"'+(resultadoBusquedaWS?1:0)+'","grupoEtnico":"'+cmbGrupoEtnico.getValue()+'","discapacidad":"'+cmbDiscapacidad.getValue()+
                                                                                    ...
                                                                                    '","datosValidados":"4","desconoceDatosContacto":"'+(gEx('lblDesconoceDatoContacto').getValue()?'1':'0')+'"'+campoComp+'}';
                                                                        }
                                                                        else
                                                                        {
                                                                            ...
                                                                            if(gEx('lblValFechaNacimiento').isVisible() &&(gEx('fechaNacimiento').getValue()==''))
                                                                            {
                                                                            	function resp5()
                                                                                {
                                                                                	gEx('tblPersona').setActiveTab(1);
                                                                                    gEx('fechaNacimiento').focus();
                                                                                }
                                                                                msgBox('Debe indicar la fecha de nacimiento',resp5);
                                                                                return;
                                                                            }
                                                                            
                                                                            if(gEx('lblValFechaNacimiento').isVisible() && gEx('divFechaDocumento').isVisible())
                                                                            {
                                                                            
                                                                                var fechaLimiteNacimiento=gEx('fechaIdentificacion').getValue().add(Date.DAY,-1);
            
                                                                                if(tipoIdentificacion=='4')
                                                                                {
                                                                                    fechaLimiteNacimiento=gEx('fechaIdentificacion').getValue().add(Date.YEAR,-18);
                                                                                    
                                                                                    
                                                                                }
                                                                                
                                                                                if(gEx('fechaNacimiento').getValue()>fechaLimiteNacimiento)
                                                                                {
                                                                            ...
                                                                            var datosValidados='';
                                                                            if((cObjeto && (cObjeto.servicioUsado=='REGISTRADURIA'))&&(!servicioRegistraduriaOff)&&(cObjeto.esInfoWS=='1')&&(!esModuloExpediente)&&(conoceFechaExpedicion=='1'))
                                                                            {
                                                                                if(quitarAcentos(gEx('txtNombre').getValue()).toUpperCase()!=quitarAcentos(cObjeto.datosParticipante.nombre).toUpperCase())
                                                                                {
                                                                                    
                                                                                    leyenda='El nombre no coincide con registradur&iacute;a';
                                                                                    function resp1()
                                                                                    {
                                                                                        gEx('tblPersona').setActiveTab(0);
                                                                                ...
                                                                                if(quitarAcentos(gEx('txtApPaterno').getValue()).toUpperCase()!=quitarAcentos(cObjeto.datosParticipante.apellidoPaterno).toUpperCase())
                                                                                {
                                                                                ...
                                                                                if(quitarAcentos(gEx('txtApMaterno').getValue()).toUpperCase()!=quitarAcentos(cObjeto.datosParticipante.apellidoMaterno).toUpperCase())
                                                                                {
                                                                                ...
                                                                                var dFechaExp=gEx('fechaIdentificacion').getValue().format('Y-m-d');
                                                                                if(dFechaExp!=cObjeto.datosParticipante.fechaIdentificacion)
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        gEx('tblPersona').setActiveTab(0);
                                                                                        control=gEx('fechaIdentificacion');
                                                                                        control.focus();
                                                                                    }
                                                                            ...
                                                                            else
                                                                            {
                                                                            	...
                                                                            	if(esModuloExpediente)
                                                                                {
                                                                                	datosValidados=5;
                                                                                }
                                                                                else
                                                                                    if(!cObjeto || ((cObjeto.servicioUsado=='REGISTRADURIA') && (servicioRegistraduriaOff)))
                                                                                    {
                                                                                        datosValidados=0;
                                                                                    }
                                                                                    else
                                                                                        if(cObjeto.esInfoWS=='0')
                                                                                        {
                                                                                            datosValidados=3; 
                                                                                        }
                                                                                        else
                                                                                            if(!cObjeto && (cObjeto.servicioUsado!='REGISTRADURIA'))
                                                                                            {
                                                                                                datosValidados=2; 
                                                                                            }
                                                                                            else
                                                                        	...
                                                                        	cadObj='{"resultadoBusquedaWS":"'+(resultadoBusquedaWS?1:0)+'","grupoEtnico":"'+cmbGrupoEtnico.getValue()+'","discapacidad":"'+cmbDiscapacidad.getValue()+
                                                                                    ...
                                                                                    '","desconoceIdentificacion":"'+(gEx('lblSinIdentificacion').getValue()?'1':'0')+
                                                                                    '","datosValidados":"'+(datosValidados)+'","desconoceDatosContacto":"'+(gEx('lblDesconoceDatoContacto').getValue()?'1':'0')+'"'+campoComp+'}';
                                                                        ...
                                                                        for(x=0;x<gEx('gTelefonosCParticipante').getStore().getCount();x++)
                                                                        {
                                                                            ...
                                                                            o='{"tipoTelefono":"'+fila.data.tipoTelefono+'","lada":"'+fila.data.lada+
                                                                                ...
                                                                                '","pais":"'+fila.data.pais+'","verificado":"'+fila.data.verificado+'"}';
                                                                            if(arrTelefonos=='')
                                                                                arrTelefonos=o;
                                                                            else
                                                                                arrTelefonos+=','+o;
                                                                        ...
                                                                        if((!gEx('lblDesconoceDatoContacto').getValue())&&(naturaleza=='A')&&(!esModuloExpediente))
                                                                        {
                                                                        	if(arrMails=='')
                                                                            {
                                                                            	function resp104()
                                                                        ...
                                                                        if((!gEx('lblDesconoceDatoContacto').getValue()) &&  (!ingresaDomicilio) && (arrMails=='') &&(!esModuloExpediente))
                                                                        {
                                                                        	function resp105()
                                                                            {
                                                                                gEx('tblPersona').setActiveTab(2);
                                                            ...
                                                            tbar:	[
                                                            			{
                                                                            ...
                                                                            handler:function()
                                                                            		{
                                                                                    	if((conoceFechaExpedicion=='1')&&(!esModuloExpediente))
                                                                                        {
	...
	function funcAjax(peticion_http)
    {
        ...
        if(arrResp[0]=='1')
        {
            ...
            for(x=0;x<cObjeto.datosContacto.telefonos.length;x++)
            {
                ...
                {
                    arrDatosTelefono.push([f.tipoTelefono,f.idPais,f.lada,f.numero,f.extension,f.verificado]);
                }
            }
            ...
            if((cObjeto.datosParticipante.busquedaWS=='1') &&(cObjeto.datosParticipante.tipoIdentificacion=='4'))
            {
            	...
            	function funcAjax2(peticion_http)
                {
                    ...
                    if(arrResp[0]=='1')
                    {
                    	if(arrResp[1]=='1')
                        {
                        	...
                        	if(cObjeto.servicioUsado=='REGISTRADURIA')
                            {
                            	gEx('cmbIdentificacion').disable();
                ...
                obtenerDatosWebV2('../modulosEspeciales_SIUGJ/paginasFunciones/funcionesModuloRegistroPartes.php',funcAjax2, 'POST','funcion=2&iF='+personaJuridica+
                                '&tB='+cObjeto.datosParticipante.tipoIdentificacion+'&vB='+cObjeto.datosParticipante.folioIdentificacion+
                                '&tipoEntidad='+cObjeto.datosParticipante.tipoEntidad,true);
            }
            else
            {
...
{
	servicioRegistraduriaOff=false;
	...
	function funcAjax()
    {
        ...
        if(arrResp[0]=='1')
        {
            ...
            if(arrResp[1]=='1')
            {
                ...
                if((cObjeto.servicioUsado=='REGISTRADURIA') &&((cObjeto.esInfoWS=='1')||((cObjeto.esInfoWS=='0')&&(cObjeto.conInformacion=='0'))))
                {
                	cObjeto.validaCedulaProfesional='1';
                	cargarDatos=false;
                }
                ...
                if((typeof(cObjeto.datosParticipante.nombre)!='undefined')&&cargarDatos)
                {
                ...
                if((typeof(cObjeto.datosParticipante.fechaNacimiento)!='undefined')&& cargarDatos)
                {
                    if(cObjeto.datosParticipante.fechaNacimiento!='')
                    {
                        gEx('fechaNacimiento').fireEvent('change',gEx('fechaNacimiento'),gEx('fechaNacimiento').getValue());
                ...
                if((cObjeto.datosParticipante.tipoPersona)&& cargarDatos)
                {
                    gEx('cmbTipoPersona').setValue(cObjeto.datosParticipante.tipoPersona);
                    dispararEventoSelectCombo('cmbTipoPersona');
                ...
                if(cObjeto.validaCedulaProfesional=='1')
                {
                	...
                	if(cObjeto.servicioUsado!='REGISTRADURIA')
                	{
                        ...
                        if(cObjeto.situacionCedula=='0') //Error en consulta
                        {
                            ...
                            msgBox('No se pudo establecer conexión con el registro nacional de abogados');
                            resultadoBusquedaWS=false;
                            //gEx('btnAceptarAddPersona').disable();
                        }
                        ...
                        if(cObjeto.situacionCedula=='-1001') //Error en consulta
                        {
                            //gEx('lblErrorCedula_6').show();
                             msgBox('No se pudo establecer conexión con CONFECAMARAS');
                            resultadoBusquedaWS=false;
                            //gEx('btnAceptarAddPersona').disable();
                ...
                if((esBusquedaPersona)&&(cargarDatos))
                {
                ...
                if((resultadoBusquedaWS) && cargarDatos  &&(cObjeto.situacionCedula!='-1') &&(cObjeto.situacionCedula!='0') &&(cObjeto.situacionCedula!='-1001'))
                {
                	gEx('cmbIdentificacion').disable();
                    gEx('txtEspecifique').disable();
                    gEx('txtNombre').disable();
                ...
                if(cObjeto.validaCedulaProfesional=='1')
                {
                    ...
                    {
                    	var leyendaErrorRegistraduria='';
                        
                        if(cObjeto.situacionCedula=='-1')
                        {
                            
                            leyendaErrorRegistraduria='El n&uacute;mero de documento no es v&aacute;lido';
                            
                        }
                        else
                            if((cObjeto.situacionCedula!='-1001')&&(cObjeto.situacionCedula!='0')&&(cObjeto.situacionCedula!='1')&&(cObjeto.situacionCedula!='12')&&(cObjeto.situacionCedula!='14'))
                            {
                                leyendaErrorRegistraduria='El documento de identificaci&oacute;n no est&aacute; vigente';
    
                            }
                          	else
                            	if(cObjeto.situacionCedula=='-1001')
                                {
                                	servicioRegistraduriaOff=true;
                                    leyendaErrorRegistraduria='';
                                    msgBox('No se pudo establecer conexión con la registradur&iacute;a');
                                }  

                        if(leyendaErrorRegistraduria!='')
                        {
                            gEx('lblErrorCedula_7').setText('<span style="color:#F00">'+leyendaErrorRegistraduria+'</span>',false);
                            gEx('lblErrorCedula_7').show();
                            gEx('txtEspecifique').enable();
                            gEx('txtEspecifique').focus();
                            if(!esModuloExpediente)
	                            gEx('btnAceptarAddPersona').disable();
                ...
                if((arrMails.length==0)&& cargarDatos)
                {
    ...
    obtenerDatosWeb('../modulosEspeciales_SIUGJ/paginasFunciones/funcionesModuloRegistroPartes.php',funcAjax, 'POST','funcion=2&iF='+figuraJuridica+
    				'&tB='+tB+'&vB='+nPersona+'&esModuloExpediente='+(esModuloExpediente?'1':0)+'&tipoEntidad='+gEx('cmbTipoEntidad').getValue(),true);
										...
										listeners : {
													show : {
																...
																fn : function() 
																{
																	...
																	cmbPais.setValue('52');
                                                                    var cmbTipoTelefono=crearComboExt('cmbTipoTelefonoV',arrTelefonosCParticipante,0,0,280,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCmbTipo'});
