...
<?php
	...
	$tituloModulo="Administraci&oacute;n de N&oacute;minas"
?>
<style>
	.filaAceptado
	{
...
<script type="text/javascript" src="../nomina/Scripts/tblNominasEmpresasCentroCosto.js.php"></script>
                   ...
                   <tr>
                        <td align="center">
                        	<?php
								...
								{
									$consulta="SELECT ciclo FROM 550_cicloFiscal WHERE '".date("Y-m-d")."'>=fechaInicio AND '".date("Y-m-d")."'<=fechaCierre";
                            ...
                            <tr>
                                ...
                                <input type="hidden" id="arrNominas" value="<?php echo bE("[]")?>" />
                                <input type="hidden" id="idEmpleado" value="-1" />
                                <input type="hidden" id="cBusquedaP" value="" />
                                </td>
                           </tr>
                           </table>
                        </td>
