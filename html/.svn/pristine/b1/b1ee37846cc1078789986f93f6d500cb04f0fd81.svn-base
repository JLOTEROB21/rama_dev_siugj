											...
											items: 	[
                                            			{
                                                            ...
                                                            y:15,
                                                            cls:'SIUGJ_Etiqueta',
                                                            html:'Despacho a agregar:'
                                                        },
                                                        {
                                                        	xtype:'label',
                                                            x:200,
                                                            y:10,
                                                            html:'<div id="divCmbDespacho"></div>'
                                                        }
...
function validarAmbitoAplicacion()
{
	...
	if(id=='-1')
    {
        gE('funcPHPEjecutarNuevo').value=bE('asociarAmbitoAplicacionSuspensionTerminos(@idRegPadre,\''+bE(cadObj)+'\')');
    }
    else
    {
        gE('funcPHPEjecutarModif').value=bE('asociarAmbitoAplicacionSuspensionTerminos('+id+',\''+bE(cadObj)+'\')');
    }
