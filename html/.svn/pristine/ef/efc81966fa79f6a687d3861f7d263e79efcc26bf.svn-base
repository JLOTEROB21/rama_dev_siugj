...
$sql="SELECT institucionAbierto,Dependencia,cod_Area,cod_Puesto,Ads.Tipo,Calle,Numero,Colonia,Ciudad,CP,Estado,Pais,puestoAbierto,Status ";
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
						...
						<center> <span class="tituloPaginas">ADMINISTRACIÓN DE USUARIOS</span><br /><br /><br />
						<form action="intermediaProcesar.php" id="nAdscripcion" method="post">
						<table border="0" cellspacing="1" cellpadding="1" width="630">
						<tr>
							<td align="left">
								<fieldset class="frameHijo"><legend><b>DATOS LABORALES</b></legend>
								<br />
								...
								<tr height="25" valign="top">
  								...
  								<tr height="25" valign="top">
    								...
    								<td colspan="3">
										<input type="text" name="txtPuesto" id="txtPuesto" value='<?php echo $cInfo[12];?>' size="55" />
									</td>
									<td>&nbsp;</td>
									<td><label></label></td>
									<td rowspan="1"></td>
