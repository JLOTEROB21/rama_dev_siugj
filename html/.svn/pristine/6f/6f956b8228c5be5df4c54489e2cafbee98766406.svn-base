<?php
	...
	function obtenerDatosProducto($idProducto,$llave,$idCaja,$tipoCliente,$idCliente)
	{
		...
		$consulta="SELECT idAlmacen,categoria,nombreProducto,descripcion,if(categoriaIVA is null,-1,categoriaIVA),idUnidadMedida FROM 6901_catalogoProductos WHERE idProducto=".$idProducto;
