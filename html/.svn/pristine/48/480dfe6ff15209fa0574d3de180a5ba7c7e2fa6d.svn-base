				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$iActa=-1;
							if(isset($objParametros->iActa))
								$iActa=$objParametros->iActa;
							...
							$consulta="SELECT idRegistroEvento,CONCAT(DATE_FORMAT(horaInicioEvento,'%d/%m/%Y - %H:%i'),', ',t.tipoAudiencia ) AS tipoAudiencia,fechaEvento 
									...
									WHERE carpetaAdministrativa='".$cA."' AND e.idRegistroEvento=c.idRegistroContenidoReferencia
							...
							$consulta="SELECT * FROM 7028_actaNotificacion WHERE idRegistro=".$iActa;
							$arrNotificacion=utf8_encode($con->obtenerFilasJSON($consulta));
							$consulta="SELECT situacion FROM 7028_actaNotificacion WHERE idRegistro=".$iActa;
							$situacion=$con->obtenerValor($consulta);
							
							$sL=($situacion==2?1:0);
							
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblActaCircunstanciada.js.php?uG=<?php echo $uG?>"></script>
                        	<input type="hidden" id="carpetaAdministrativa"  value="<?php echo $cA?>" />
                            <input type="hidden" id="idActa"  value="<?php echo $iActa?>" />
                            <input type="hidden" id="arrAudiencias"  value="<?php echo bE($arrAudiencias)?>" />
                            <input type="hidden" id="datosNotificacion"  value="<?php echo bE($arrNotificacion)?>" />
