...
function generarFicha($idActividad)
{
	...
	$consulta="select a.actividad,p.actividad,tipoActividadProgramada,pr.tipoReporte,fechaInicio,fechaFin,idProcesoAsociado,idReferencia,horasTotal,
				idUsuario,reportaAvance,a.idTipoReporte,a.idFormulario from 965_actividadesUsuario a,967_prioridadActividad p,
	...
	switch($fila[2])
	{
		...
		break;
		case 3:
			$tipoActividad="Impartición de clase";
		break;
	}
	
	if(($fila[2]=="1")	||($fila[2]=="2"))	
	{
					...
					<td>
						...
						<tr>
							...
							<td class="valorFicha" align="left">
								<span class="corpo8">
								<?php
									$consulta="select nombre from 4001_procesos where idProceso=".$fila[6];
									$proceso=$con->obtenerValor($consulta);
									echo $proceso;
								?>
								</span>
							</td>
						 ...
						 <tr>
							...
							<td class="valorFicha" align="left">
								...
								<?php
									...
									$consulta="select nombreTabla from 900_formularios where idProceso=".$fila[6]." and formularioBase=1";
									$nTabla=$con->obtenerValor($consulta);
									$consulta="select * from ".$nTabla." where id_".$nTabla."=".$fila[7];
...
<?php	
	...
	{
		$idMateria=$fila[12];
		$consulta="select m.cve_materia,titulo,p.nombrePrograma from 4013_materia m,4158_materiaVSProfesor mp,4004_programa p where p.idPrograma=mp.idPrograma and mp.idMateria=m.idMateria and  m.idMateria=".$idMateria;
...
?>
<script type="text/javascript" src="Scripts/fichaActividad.js.php"></script>
<!-- InstanceEndEditable -->
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							$idActividad=base64_decode($objParametros->p);
