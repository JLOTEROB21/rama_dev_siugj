...
<?php
	$idEstiloMenu=$iEstiloMenu;
	$guardarConfSession=true;
	$mostrarRegresar=false;
	$mostrarBotonesControlSistema=true;
	$mostrarMenuIzq=true;
...
<script type="text/javascript" src="Scripts/inicio.js.php?iC=<?php echo bE($idEstiloMenu)?>"></script>
<?php
	...
	generarConfiguracionesMenus(1);	
	generarConfiguracionesMenus(2);	
?>
			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td>
                        	<span id="tblContenido"></span>
                        	<?php
							
								if(!esUsuarioLog())
								{
									$consulta="select contenido from 816_contenidos where  idGrupoContenido=10";
									$valor=$con->obtenerValor($consulta);
									if($valor!="")
										echo str_replace("#R","",$valor);
								}
							?>
                        	...
                        	<?php
								...
								while($fila=mysql_fetch_row($res))
								{
									...
									if(($fila[4]=="")||($fila[4]=="-1"))
									{
										...
										if($fila[5]!="")
											$claseMenu=$fila[5];
										$tblMenu='<div class=\'cBox\'><br><br><table width=\'250\'>'.
													'<tr>'.
														'<td >'.
															'<ul id=\'menu_'.$nReg.'\'>'.
																'<li  >'.
									...
									else
									{
										...
										$tblMenu='<div class=\'cBox\'>'.$tblMenuAux.'</div>';
									}
