			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
						...
						?>
                        <script type="text/javascript" src="../Usuarios/Scripts/cuentasBancarias.js.php?iU=<?php echo bE($idUsuario)?>"></script>
                        	<span class="tituloPaginas">Configuración de cuentas bancarias</span><br /><br /><br /><br /><br />
                        	<table>
                            	<tr>
                                	<td align="left">
                                    	<span id='tblGridCuentas'>
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            <input type="hidden" value="<?php echo obtenerNombreUsuario($idUsuario)?>" id="nUsuario" />
