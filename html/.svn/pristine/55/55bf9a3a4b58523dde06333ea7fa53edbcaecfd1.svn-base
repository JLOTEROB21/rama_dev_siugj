				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT carpetaAdministrativa,etapaProcesalActual,tipoCarpetaAdministrativa,idActividad FROM 7006_carpetasAdministrativas  WHERE carpetaAdministrativa='".$carpetaAdministrativa."'";
                        ...
                        ?>
                        	...
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tableroAudienciaAdministracionMedidasCautelares.js.php?tC=<?php echo bE($tipoCarpetaAdministrativa)?>&cA=<?php echo bE($carpetaAdministrativa)?>"></script>
