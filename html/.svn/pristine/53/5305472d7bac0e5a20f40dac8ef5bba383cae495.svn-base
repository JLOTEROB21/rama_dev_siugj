...
?>
<script type="text/javascript" src="Scripts/perfilExportacion.js.php"></script>
                        ...
                        <td align="center">
                            ...
                            <td align="left">
                            	<?php
									...
									$consulta="select nombrePerfil,descripcion from 9008_perfilesExportacion where idPerfilExportacion=".$idPerfil;
									$fila=$con->obtenerPrimeraFila($consulta);
									
								?>
                            	<form method="post" action="../modeloPerfiles/guardarPerfilExportacion.php" id='frmEnvio'>
                        		<fieldset class="frameHijo"><legend>Perfil de exportación</legend>
                                <table>
                                    <TR>
                                        <TD width="135" align="left">
                                            <label>Nombre del perfil: <font color="red">*</font></label>
                                        </TD>
                                        <td align="left">
                                        <input type="text" name="_nombrePerfilvch" maxlength="250" size="70" value="<?php echo $fila[0]?>" id="_nombrePerfilvch" val='obl' campo='Nombre del perfil' />
                                        </td>
                                    </TR>
                                    <TR>
                                        ...
                                        <td align="left">
                                            <textarea rows="7" cols="80" name="_descripcionvch"><?php echo $fila[1]?></textarea>
                                        </td>
                                    </TR>
                                    <tr>
                            ...
                            <table width="700" >
                            	<tr>
                                	<td align="left">
                                    	<fieldset class="frameHijo" /><legend>Estructura del archivo de exportación</legend>
                                            <table width="100%">
                                            <tr>
                                                <td align="center">
                                                    <table>
