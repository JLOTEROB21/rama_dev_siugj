		...
		<div > 
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  $consulta="select a.idUsuario,concat(i.Paterno,' ',i.Materno,', ',i.Nom) as nombre,a.claveParticipacion,a.orden,a.responsable from 246_autoresVSProyecto a,802_identifica i 
				  where a.idUsuario<>703585 and i.idUsuario=a.idUsuario and a.idFormulario=".$idFormulario." and a.idReferencia=".$objParametros->idRegistro." order by orden";
				  $res=$con->obtenerFilas($consulta);
                  ...
                  <tr>
                  <td align="center">
                  	<span class="tituloPaginas"><?php echo $plural?> participantes</span><br />
                  </td>
                  </tr>
                  </table>
                  <br />
                <table id="hor-minimalist-b" style="width:100% !important" >
                            <thead>
                               <tr>
        	                    	<th class="rounded-company " style="text-align:center"><b><?php echo $singular ?></b></th>
                                    <th class="rounded-q1 " style="text-align:center"><b>Participaci&oacute;n</b></th>
                                    <?php 
									if (!$ocultarOrden)
									{
									?>
                                    <th class="rounded-q4 " style="text-align:center"><b>Orden Participaci&oacute;n</b></th>
                                    <?php
									}
									if(!$ocultarColResp)
									{
                                    ?>
                                    <th class="rounded-q4 " style="text-align:center"><b><?php echo $responsable?></b></th>
                                    <?php
									}
									?>
                      ...
                      <?php
						...
						{
							if($fila[4]=="1")
								$resp="<font color='red'><b>Sí</b></font>";
							else
								$resp="No";
							$consulta="select descParticipacion from 953_elementosPerfilesParticipacionAutor where idPerfilAutor=".$idPerfil." and idElementoPerfilAutor='".$fila[2]."'";
							...
							echo '<tr>
									<td style="text-align:left" class="'.$claseFila.'">
										'.$fila[1].'
									</td>
									<td style="text-align:left" class="'.$claseFila.'">
										'.$participacion.'
							...
							if (!$ocultarOrden)
							{	
								echo	'<td style="text-align:center" class="'.$claseFila.'">
											'.$fila[3].'
										</td>';
							}
							if(!$ocultarColResp)
