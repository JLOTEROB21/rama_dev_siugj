<?php
	...
	$consulta="SELECT * FROM _785_gridComponentes WHERE idReferencia=".$idConfiguracion;
	$resComponentes=$con->obtenerFilas($consulta);
	while($fila=mysql_fetch_assoc($resComponentes))
	{
		$oComponente["idComponente"]=$fila["id__785_gridComponentes"];
		$oComponente["urlComponente"]=$fila["urlComponente"];
		$oComponente["tituloComponente"]=$fila["tituloComponente"];
		array_push($arrComponentes,$oComponente);
	}
	
	
	$consulta="SELECT id__785_tablaDinamica,cuestionarioAudiencia FROM _785_tablaDinamica WHERE id__785_tablaDinamica=".$idConfiguracion;
	...
	$consulta="SELECT p.idProceso,p.nombre,rolIngreso FROM _785_gProcesos g,4001_procesos p WHERE g.idReferencia=".$idConfiguracion.
				" AND  g.idProceso=p.idProceso ORDER BY p.nombre";
															  ...
															  gEx('frameRegistroPruebas_".$fila["idProceso"]."').load	(
																														  {
																															  ...
																															  params:	{
																																		  ...
																																		  parametrosProceso:bE('{\"carpetaAdministrativa\":\"".$cAdministrativa."\",\"cAdministrativa\":\"".$cAdministrativa."\"}'),
																																		  contentIframe:100
																																	  }
																														 }
																													  )
...
?>
var existeActaAudiencia=<?php echo $numReg>0?"true":"false" ?>;
var existeCuestionarioResolutivos=false;
var arrPanelesProcesos=[<?php echo $arrPanelesProcesos?>];
...
function inicializar()
{
                                                      ...
                                                      activate:function(p)
                                                              {
                                                                  ...
                                                                  {
                                                                      p.visualizado=1;
                                                                      gEx('frameInfoAudiencia').load	(
                                                                                                            {
                                                                                                                scripts:true,
                                                                                                                url:'../modulosEspeciales_SIUGJ/infoAudiencia.php',
                                                                                                                params:	{
                                                                                                                              idAudiencia:gE('idEvento').value,
                                                                                                                              sL:gE('sL').value
                                                                                                                          }
                                                                                                           }
                                                                                                        )
    ...
    if(gE('cuestionarioAudiencia').value!='-1')
    {
		existeCuestionarioResolutivos=true;

    	var panelCuestionario= {
                                    xtype:'panel',
                                    layout:'border',
                                    border:false,
                                    cls:'panelSiugj',
                                    title:'Resolutivos Audiencia',
                                    listeners:	{
                                                      activate:function(p)
                                                              {
                                                                  if(!p.visualizado)
                                                                  {
                                                                      p.visualizado=1;
                                                                      gEx('frameResolutivos').load	(
                                                                                                          {
                                                                                                              scripts:true,
                                                                                                              url:existeActaAudiencia?'../modeloPerfiles/verFichaFormularioV2.php':'../modeloPerfiles/registroFormularioV2.php',
                                                                                                            	params:	{
                                                                                                                          cPagina: 'sFrm=true',
                                                                                                                          pM:existeActaAudiencia?0:1,
                                                                                                                          pE:0,
                                                                                                                          pC:0,
                                                                                                                          funcPHPEjecutarNuevo:bE('cuestionarioAudienciaLlenado(idRegPadre)'),
                                                                                                                          funcPHPEjecutarModif:bE('cuestionarioAudienciaLlenado(idRegPadre)'),
                                                                                                                          idReferencia:gE('idEvento').value,
                                                                                                                          idFormulario:gE('cuestionarioAudiencia').value,
                                                                                                                          idRegistro:gE('idRegistroCuestionario').value,
                                                                                                                      }
                                                                                                         }
                                                                                                      )
    	...
    	arrPaneles.push(panelCuestionario);
    }
    
	<?php
		foreach($arrComponentes as $c)
		{
	?>
    	var panelCuestionario_<?php echo $c["idComponente"]?>= {
                                    xtype:'panel',
                                    layout:'border',
                                    border:false,
                                    cls:'panelSiugj',
                                    title:'<?php echo $c["tituloComponente"]?>',
                                    listeners:	{
                                                      activate:function(p)
                                                              {
                                                                  if(!p.visualizado)
                                                                  {
                                                                      p.visualizado=1;
                                                                      gEx('frameResolutivos_<?php echo $c["idComponente"]?>').load	(
                                                                                                                                      {
                                                                                                                                          scripts:true,
                                                                                                                                          url:'<?php echo $c["urlComponente"]?>',
                                                                                                                                          params:	{
                                                                                                                                                    	idAudiencia:gE('idEvento').value
                                                                                                                                                  	}
                                                                                                                                     }
                                    ...
                                    items:[
                                                new Ext.ux.IFrameComponent({ 
                                                                                    ...
                                                                                    id: 'frameResolutivos_<?php echo $c["idComponente"]?>',
                                                                                    anchor:'100% 100%',
                                                                                    region:'center',
                                                                                    loadFuncion:function(iFrame)
                                                                                                {
    	...
    	arrPaneles.push(panelCuestionario_<?php echo $c["idComponente"]?>);
    <?php
		}
	?>
    
    var x;
    for(x=0;x<arrPanelesProcesos.length;x++)
    {
    	arrPaneles.push(arrPanelesProcesos[x]);
    }
                                                ...
                                                items:	[
                                                            {
                                                                ...
                                                                border:false,
                                                                plain:true,                                                                
                                                                activeTab:existeCuestionarioResolutivos?1:0,
                                                                items:	arrPaneles
	...
	gEx('tpResolutivos').setActiveTab(0);
...
function recargarCuestionario(idRegistroCuestionario)
{
	gEx('frameResolutivos').load	(
                                          {
                                              scripts:true,
                                              ...
                                              params:	{
                                                          ...
                                                          //idReferencia:gE('idEvento').value,
                                                          idFormulario:gE('cuestionarioAudiencia').value,
                                                          idRegistro:idRegistroCuestionario,
                                                      }
                                         }
                                      )
}
...
function recargarGrids()
{
    ...
    var x;
    for(x=0;x<aPaneles.length;x++)
    {
    	if(( gEx(aPaneles[x]).getFrameWindow)&&(gEx(aPaneles[x]).getFrameWindow())&&(gEx(aPaneles[x]).getFrameWindow().recargarContenedorCentral))
	    	gEx(aPaneles[x]).getFrameWindow().recargarContenedorCentral();
     }     
