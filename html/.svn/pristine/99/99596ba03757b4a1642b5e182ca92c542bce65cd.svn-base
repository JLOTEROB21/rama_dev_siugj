...
#navigation_hayas.nosub {background:#<?php echo $colorMenu ?> url('../images/navigation_nosub_hayas.gif') repeat-x left
top}
...
#example_content {
background:#<?php echo $colorMenuIn ?>;border:1px solid
#<?php echo $colorMenuIn ?>;border-top:none;padding:10px;margin-bottom:15px}
#main_title {
background:#<?php echo $colorBanner ?>;border:1px solid #<?php echo $colorBanner ?>;border-top:1px solid
#<?php echo $colorBanner ?>;padding:10px;margin-bottom:0px}
...
.tituloTabla
{
COLOR: #<?php echo $colorLeTabla ?>; LINE-HEIGHT: 150%; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif;
TEXT-DECORATION: none;
...
font-family:<?php echo $colorFuMenu ?>;}
...
color:#<?php echo $colorTxTabla2 ?>; font-family: <?php echo $colorFuMenu ?>, Helvetica, sans-serif;
text-decoration:none}
