			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
				   ...
				   ?>
                   <script type="text/javascript" src="../modeloProyectos/Scripts/fichaPresupuesto.js.php?idFormulario=<?php echo $idFormulario ?>&idRegistro=<?php echo $idRegistro ?>&idProceso=<?php echo $idProceso ?>"></script>
                   <tr>
                        <td align="center">
                        	<span class="tituloPaginas">Presupuesto
                            </span>
                        	<br /><bR /><br /><br />
                        	<table>
                            	<tr>
                            ...
                            <input type="hidden" name="codigoUnidad" id="codigoUnidad" value=""/>
