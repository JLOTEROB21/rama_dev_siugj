...
?>
<script src='https://www.google.com/recaptcha/api.js?render=6LcxcuoUAAAAAAPZqd4nih6eLLbqZjnUFdLL4kd0'></script>
<script>
	grecaptcha.ready(function() 
						{
							grecaptcha.execute('6LcxcuoUAAAAAAPZqd4nih6eLLbqZjnUFdLL4kd0', {action: 'homepage'}).then(
																									function(token) 
																									{
...
<script type="text/javascript" src="../registroUsuario/Scripts/registroUsuarioSIGUE.js.php"></script>
<style>
	.grecaptcha-badge{
