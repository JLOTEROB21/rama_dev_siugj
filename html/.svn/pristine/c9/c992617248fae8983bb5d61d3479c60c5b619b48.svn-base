<?php
	...
	$consulta="SELECT claveUnidad,nombreUnidad FROM _17_tablaDinamica  ORDER BY nombreUnidad";
...
function recargarGridEventos()
{
	gEx('frameContenidoCalendario').load	(
    								{
                                    	url:'../modulosEspeciales_SGJ/calendarioAudienciasJuez.php',
                                        params:	{
                                                                                            ...
                                                                                            handler:function()
                                                                                                    {
                                                                                                        ...
                                                                                                        '","situacionAudiencia":"'+gEx('cmbSituacionEvento').getValue()+'","tipoVista":"1","idReferencia":"<?php echo $_SESSION["idUsr"]?>"}';
