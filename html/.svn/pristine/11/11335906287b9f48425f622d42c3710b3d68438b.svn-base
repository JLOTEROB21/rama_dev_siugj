<?php session_start();
	...
	//$idRegistro=$_POST["idRegistro"];
		...
		$consultaObG="SELECT distinct clave,nombreObjetoGasto FROM 507_objetosGasto o,9035_objetosGastoPresupuesto op WHERE idProceso=".$idProceso." AND o.clave=op.objGasto" ;
			...
			$objCbc="
					{
						...
						renderer:'usMoney',
						editor:new Ext.form.NumberField({allowDecimals:true,allowNegative:false})
					}
			";
	...
	var tblGrid=	new Ext.grid.EditorGridPanel	(
                                                        {
                                                            ...
                                                            tbar:	[
                                                            			{
                                                                        	text:'Agregar instituci&oacute;n',
                                                                            icon:'../images/add.png',
                                                                            cls:'x-btn-text-icon',
                                                                            handler:function()
                                                                            	{
                                                                        ...
                                                                        {
                                                                        	text:'Remover instituci&oacute;n',
										...
										listeners:
											{
												show:
												{
                                                    ...
                                                    fn:function()
														{
																Ext.getCmp('txtInstitucionNueva').focus(false,500);
														}
												}
											},
										buttons:
											...
											items: 	[ 
                                            			{
                                                            ...
                                                            y:10,
                                                            xtype:'label',
                                                            html:'Seleccione la instituci&oacute;n que desea remover:'
                                                        }
                                            			,
                                            			tablaMaterial
