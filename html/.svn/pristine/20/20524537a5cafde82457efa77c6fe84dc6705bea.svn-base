                                ...
                                items: [
                                            {
                                                ...
                                                tbar:	[	
                                                			{
                                                            	xtype:'label',
                                                                html:'&nbsp;&nbsp;&nbsp;<b>Tribunal:</b>&nbsp;<span style="color: #900"><b>'+gE('nombreUnidad').value+'</b></span>&nbsp;&nbsp;'
                                                            },'-',
                                                			{
                                                            	xtype:'label',
...
<?php
															if((existeRol("'69_0'"))||(existeRol("'1_0'"))||existeRol("'112_0'")||existeRol("'107_0'")||existeRol("'152_0'")||existeRol("'26_0'"))
															{
															?>
                                                            {
                                                                header:'Notificacion SIAJOP',
                                                                width:120,
                                                                align:'center',
                                                                sortable:true,
...
function abrirVentanaSala(iS)
{
    ...
    if((window.parent.parent)&&(window.parent.parent.abrirVentanaFancy))
    	window.parent.parent.abrirVentanaFancy(obj);
    else
        if((window.parent)&&(window.parent.abrirVentanaFancy))
            window.parent.abrirVentanaFancy(obj);
        else
            abrirVentanaFancy(obj);
}
