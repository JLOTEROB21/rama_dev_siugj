...
Ext.ux.grid.RowEditor = Ext.extend(Ext.Panel, {
    ...
    stopEditing : function(saveChanges)
	{
		...
		var validacion=this.fireEvent('validateedit', this, changes, r, this.rowIndex) ;
		
		
        if(hasChange && validacion!== false)
		{
            //r.beginEdit();
    ...
    onKey: function(f, e){
        ...
        if(((e.getKey() === e.ENTER))&&(this.saveOnEnter))
		{
    ...
    onRender: function()
	{
        ...
        this.btns = new Ext.Panel({
			...
			items: [
					 {
						xtype: 'button',
						cls:'rowEditorCancel btnSIUGJCancel',
						id:'cBtn_'+this.id,
