...
<link rel="stylesheet" type="text/css" href="../modulosEspeciales_SGJP/Scripts/conversacion.css" media="screen" />
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if($con->existeCampo("libreriaFuncionJSParametros","_10_tablaDinamica"))
							{
                        ...
                        ?>
                        	...
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tableroAudienciaAdministracionMediaticos.js.php?tC=<?php echo bE($tipoCarpetaAdministrativa)?>&cA=<?php echo bE($carpetaAdministrativa)?>"></script>
