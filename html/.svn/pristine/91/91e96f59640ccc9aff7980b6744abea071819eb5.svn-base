<?php
	...
	$consulta="SELECT idPerfilesNomina,nombrePerfil FROM 662_perfilesNomina where idPerfilesNomina in (".$listPerfiles.") and idPerfilesNomina in (SELECT idPerfilNomina FROM 
			662_perfilesNominaInstitucion WHERE institucion='".$_SESSION["codigoInstitucion"]."') ORDER BY nombrePerfil";	
