...
<link rel="stylesheet" type="text/css" href="../Scripts/ux/checkBoxComboBox/CheckboxComboBox.css"/>
...
<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/cParticipante.js.php"></script>
...
<script type="text/javascript" src="../Scripts/plupload/js/jquery.plupload.queue/jquery.plupload.queueSIUGJ.js"></script>

<script type="text/javascript" src="../Scripts/plupload/js/plupload.dev.js"></script>


<script type="text/javascript" src="../Scripts/plupload/js/i18n/es.js"></script>
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/cComputo.js.php"></script>
...
<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/cExportacionExpediente.js.php"></script>
<link type="text/css" rel="stylesheet" href="../Scripts/plupload/js/jquery.plupload.queue/css/jquery.plupload.queue2.css" media="screen" />
                   ...
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->cA))	
								$carpetaAdministrativa=bD($objParametros->cA);
							
							$idCarpetaAdministrativa=-1;
							if(isset($objParametros->idCarpetaAdministrativa))	
								$idCarpetaAdministrativa=$objParametros->idCarpetaAdministrativa;
							
							$idCarpetaAdministrativaForced=$idCarpetaAdministrativa;
							
							if($idCarpetaAdministrativaForced==-1)
							{
								$consulta="SELECT idCarpeta FROM 7006_carpetasAdministrativas WHERE carpetaAdministrativa='".$carpetaAdministrativa."'";
								$idCarpetaAdministrativaForced=$con->obtenerValor($consulta);
							}
							
							$consulta="SELECT carpetaAdministrativa,etapaProcesalActual,tipoCarpetaAdministrativa,idActividad,permiteAudienciaVirtual 
									FROM 7006_carpetasAdministrativas  WHERE carpetaAdministrativa='".$carpetaAdministrativa."'";
							...
							$tipoCarpetaAdministrativa=$fEventoAudiencia[2];
							$permiteAudienciaVirtual=$fEventoAudiencia[4];
							...
							if($tipoMateria=="P")
							{	
								$consulta="	SELECT DISTINCT libreriaFuncionJSParametros FROM _10_tablaDinamica WHERE libreriaFuncionJSParametros IS NOT NULL AND libreriaFuncionJSParametros<>''";
								$res=$con->obtenerFilas($consulta);							
								while($fila=mysql_fetch_row($res))
								{
									echo '<script type="text/javascript" src="'.$fila[0].'?tC='.$tipoCarpetaAdministrativa.
											'&c='.$carpetaAdministrativa.'&iC='.$idCarpetaAdministrativa.'"></script>';
								}
							}
                        ?>
                        	
                        	<script type="text/javascript" src="../modulosEspeciales_SGJ/Scripts/tableroAudienciaAdministracion.js.php?&iC=<?php echo bE($idCarpetaAdministrativa)?>&tC=<?php echo bE($tipoCarpetaAdministrativa)?>&cA=<?php echo bE($carpetaAdministrativa)?>"></script>
                        	<input type="hidden" id="carpetaAdministrativa" value="<?php echo $carpetaAdministrativa?>" />
                            <input type="hidden" id="idCarpetaAdministrativa" value="<?php echo $idCarpetaAdministrativa?>" />
                            <input type="hidden" id="idCarpetaAdministrativaForced" value="<?php echo $idCarpetaAdministrativaForced?>" />
                            <input type="hidden" id="idActividad" value="<?php echo $fEventoAudiencia[3]?>" />
                            <input type="hidden" id="permiteAudienciaVirtual" value="<?php echo $permiteAudienciaVirtual?>" />
                            ...
                            <input type="hidden" id="tipoMateria" value="<?php echo $tipoMateria?>" />
