				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        ?>
                        	...
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tableroAudienciaAdministracion.js.php?tC=<?php echo bE($tipoCarpetaAdministrativa)?>&cA=<?php echo bE($carpetaAdministrativa)?>"></script>
