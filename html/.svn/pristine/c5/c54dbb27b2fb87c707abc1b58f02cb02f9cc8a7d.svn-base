				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
						...
						if(isset($objParametros->sL))
							$sL=$objParametros->sL;	
					  ?>
					  	<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblAccesoProcesoJudicial.js.php?iF=<?php echo bE($idFormulario)?>&iR=<?php echo bE($idRegistro)?>"></script>
