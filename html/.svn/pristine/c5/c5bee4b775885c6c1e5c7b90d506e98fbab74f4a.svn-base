...
{
	var sistemaOralidad=gE('sistemaOralidad').value=='1';
    loadScript('../modulosEspeciales_SGJP/Scripts/controlEventos.js.php', function()
    																		{
																				...
																				objConf.permiteAperturaCarpetaAsociada=gE('sL').value=='0';
                                                                                objConf.mostrarFechaAudiencia=true;
																				objConf.mostrarSoloHoraInicial=sistemaOralidad?false:true;
                                                                                objConf.mostrarTipoAudiencia=true;
                                                                                objConf.mostrarDuracionAudiencia=sistemaOralidad?true:false;
                                                                                objConf.mostrarSalaAudiencia=sistemaOralidad?true:false;
																				objConf.mostrarSecretariaAudiencia=sistemaOralidad?false:true;
                                                                                objConf.mostrarCentroGestion=sistemaOralidad?true:false;
                                                                                objConf.mostrarEdificio=sistemaOralidad?true:false;
                       		...
                       		<table>
                            	<tr>
                                    ...
                                    <br />
                                    	...
                                    	<?php
											$arrSistemasOrales["A"]=1;
											$arrSistemasOrales["B"]=1;
											$arrSistemasOrales["M"]=1;
											$arrSistemasOrales["D"]=1;
											$arrSistemasOrales["X"]=1;
											$arrSistemasOrales["E"]=1;
											$arrSistemasOrales["EA"]=1;
											$arrSistemasOrales["MF"]=1;
											$arrSistemasOrales["MC"]=1;
											$arrSistemasOrales["ME"]=1;
											$arrSistemasOrales["SCC"]=1;
											...
											$consulta="SELECT DISTINCT d.tipoDelito  FROM 7000_eventosAudiencia e,_17_tablaDinamica u
													,_17_gridDelitosAtiende d WHERE idRegistroEvento=".$idEvento."
													AND e.idCentroGestion=u.id__17_tablaDinamica AND d.idReferencia=u.id__17_tablaDinamica";
											$res=$con->obtenerFilas($consulta);	
											while($fila=mysql_fetch_row($res))
											{
												if(isset($arrSistemasOrales[$fila[0]]))
												{
													$sistemaOralidad=1;
												}
											}
                                    ...
                                    <span id="tblFechaAudiencia"></span>
                                    <input type="hidden" id="idEvento" value="<?php echo $idEvento?>" />
                                    <input type="hidden" id="sistemaOralidad" value="<?php echo $sistemaOralidad?>" />
