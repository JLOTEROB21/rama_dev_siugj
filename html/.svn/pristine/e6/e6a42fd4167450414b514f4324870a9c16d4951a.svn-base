...
<script src="../modulosEspeciales_SGJP/Scripts/tblBusquedaCarpetaAlzadaAntecedente.js.php"></script>
<style>
body
{
	min-height:600px;
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        ?>
                        	<iframe id="frameDTD" name="frameDTD" src="" width="1" height="1" onload="frameLoad(this)"></iframe>
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
