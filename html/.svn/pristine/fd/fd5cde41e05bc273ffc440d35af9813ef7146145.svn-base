			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
					  ...
					  ?>
                      <script type="text/x-javascript" src="../modulosEspeciales_SIUGJ/Scripts/tbTutetasAsignadas.js.php?iF=<?php echo $idFormulario ?>&sL=<?php echo $sL?>&iR=<?php echo $idRegistro ?>"></script>
