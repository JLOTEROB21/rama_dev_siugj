...
$fila=$con->obtenerPrimeraFila("SELECT idUsuario FROM 4125_alumPers WHERE idAlumno='".$idAlumno. "'");
$idUsuario=$fila[0];

$sql="SELECT Nom,Paterno,Materno,Prefijo,ciudadNacimiento,estadoNacimiento,paisNacimiento,Nacionalidad,RFC, ";
$sql.="date_format(fechaNacimiento,'%d/%m/%Y'),Status,Genero,CURP,IMSS,Calle,Numero,Colonia,Ciudad,CP,Estado,Pais ";
...
<script type="text/javascript" src="Scripts/nIdentifica.js"></script>
<?php 
			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td>
						<form action="intermediaProcesar.php" enctype="multipart/form-data" id="nIdentifica" method="post">
                            ...
                            <tr>
                            	<td align="center"><p><b>FICHA DE IDENTIFICACION DEL PADRE O TUTOR</b></p><br /></td>
                            </tr>
				  			<tr>
								<td >
                                	<fieldset class="frameHijo" ><legend><b>DATOS DE IDENTIFICACIÓN</b></legend>
									<table  border="0" cellspacing="1" cellpadding="1"></td><!--<td colspan="10" align="right"><img heigth='50' src="verFoto.php?Id=<?php //echo $idUsuario; ?>"/></td>-->
				  					<tr height="27" valign="top">
						  				...
						  				<td></td>
    									<td width="110"><label>Nombre:</label></td>
    									<td width="150">
                                                <?php echo ($cInfo[0]);?>
                                        </td>
    									<td></td>
    									<td width="110"><label>Ap. Paterno:</label></td>
    									<td></td>
    									<td><?php echo ($cInfo[1]);?></td>
    									
    								</tr>
    								<tr height="27" valign="top">
        								<td></td>
										<td><label>Ap. Materno:</label><font color="#FF0000"></font></td>
        								<td><?php echo ($cInfo[2]);?></td> 
                                        <td></td>
                                        <td>
									...
									<tr height="27" valign="top">
                                        ...
                                        <td></td>
                                        <td><label>Ciudad de Nac.:</label>
                                        </td>
                                        <td></td>
                                        <td><?php echo ($cInfo[4]);?></td>
                                    ...
                                    <tr height="27" valign="top">
                                        ...
                                        <td><?php echo ($cInfo[5]);?></td>
                                    	<td></td>
                                        <td><label>País de Nac.:</label>
                                      	</td>
                                        <td></td>
                                        <td>
                                         <?php echo ($cInfo[6]);?>
                                    ...
                                    <tr height="27" valign="top">
                                    	<td><label>Fotografía<br></label></td>
                                        <td></td>
                                        ...
                                        <td></td>
                                        <td><?php echo ($cInfo[8]);?></td>
                                     </tr>
                                     <tr height="27">
                                         <td></td>
                                         <td></td>
                                         <td><label>CURP:</label></td>
                                         <td><?php echo ($cInfo[12]);?></td>
                                         <td></td>
                                         <td><label>IMSS:</label></td>
                                          <td></td>
                                         <td><?php echo ($cInfo[13]);?>
                                         </td>
                                     </tr>
                                     <tr height="27" valign="top">
                                        <td></td>
  									...
  									<tr>
                                        ...
                                        <tr height="60">
                                            ...
                                            <td width="270" valign="top">
                                            	<label>
                                              		<select name="cmbTelefono" size="3" id="cmbTelefono" style="width:185px">
													  <?php
                                                      if(isset($idUsuario))
                                                		$con->generarOpcionesSelect("SELECT idTelefono,concat(Lada,'-',Numero,' (',Extension,')',' - ',(select case Tipo2 when 0 then 'Teléfono'  when 1 then 'Celular' when 2 then 'Fax' end)) as telefonos FROM 804_telefonos WHERE Tipo=0 AND idUsuario=".$idUsuario);
                                                      ?>
                                              		</select>
                                            	</label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top">
                                              <label>
                                              <select name="cmbMail" id="cmbMail" size="3" style="width:185px">
                                                <?php
                                                  if(isset($idUsuario))
                                                      $con->generarOpcionesSelect("SELECT idMail,Mail FROM 805_mails WHERE Tipo=0 AND idUsuario=".$idUsuario);
                                                ?>
                                              </select>
                                              </label>
                                            </td>
