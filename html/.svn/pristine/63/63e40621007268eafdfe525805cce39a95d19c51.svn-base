...
<script src="../modulosEspeciales_SGJP/Scripts/tblBusquedaCarpetaAcuerdoReparatorio.js.php"></script>
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							$autoload=0;
							if(isset($objParametros->autoload))
								$autoload=$objParametros->autoload;
							
							$name=0;
							if(isset($objParametros->name))
								$name=$objParametros->name;
								

                        ?>
                        
                        <input type="hidden" id="autoload" value="<?php echo $autoload?>" />
