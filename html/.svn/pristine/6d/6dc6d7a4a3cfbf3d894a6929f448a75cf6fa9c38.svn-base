...
<script type="text/javascript" src="../modulosEspeciales_SIUGJ/Scripts/cValidacionesIdentificacion.js.php"></script>
<script type="text/javascript" src="../Usuarios/Scripts/nIdentifica2.js.php"></script>
<!-- InstanceEndEditable -->
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
				   ...
				   $actualizado=0;
					...
					$cInfo=$con->obtenerPrimeraFilaAsoc($sql,true);
                   ...
                   <tr>
                        <td>
	                        ...
	                        <form action="intermediaProcesar.php"  id="nIdentifica" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="datosValidados" id="datosValidados" value='<?php echo $datosValidados==""?0:$datosValidados;?>'/>
                            <table width="100%">
                            <tr>
                            <td align="center">
                            ...
                            <tr>
                                	...
                                	<fieldset class="frameSiugj" style="width:850px" ><br /><br />
                                    	<table width="100%">
                                            ...
                                            <tr height="50">
												...
												{
												?>
                                                <input onkeyup="cambiarMayusculasTexto(this)" class="SIUGJ_Control" size="42" type="text" name="Nombre" id="Nombre" val="obl|txt" campo="Primer nombre" value="<?php echo ($cInfo["Nom"]);?>"/>
                                                <?php
												}
												else
												{
                                             ...
                                             <tr height="50">
                                                ...
                                                <td ></td>
                                                <td  align="left"><span class="letraTituloCampoRegistro">Prefijo Prefijo (Dr., Dra., Lic.)</span></td>
                                            </tr>
                                            <tr height="50">
                                            	<td></td>
                                                <td align="left">
                                            ...
                                            <tr height="50">
                                                ...
                                                <td ></td>
                                                <td  align="left"><span class="letraTituloCampoRegistro">Fecha de nacimiento <span id="spFechaNacimiento" style="display:<?php echo $vCU==1?"":"none"?>;">*</span></span></td>
                                            </tr>
                                            <tr height="50">
                                            	<td></td>
                                                <td align="left">
	                                            ...
	                                            <input type='hidden' name='FNacimiento' id='FNacimiento' value='<?php echo ($cInfo["fechaNacimiento"]);?>'  campo='Fecha de Nacimiento' val="<?php echo $vCU==1?"obl":"" ?>" extId="f_FNac">
                                                </td>
                                            </tr>
                                            <tr height="50">
                                            	<td></td>
                                                ...
                                                <td ></td>
                                                <td align="left"><span class="letraTituloCampoRegistro">Tipo de identificaci&oacute;n <span id="spTipoIdentificacion" style="display:<?php echo $vCU==1?"":"none"?>;">*</span></span></td>
                                            </tr>
                                            <tr height="50">
                                            	<td></td>
                                                <td align="left">
                                                    <select class="SIUGJ_Control" name="cmbGenero" id="cmbGenero" style="width:380px;">
                                                    <option value="-1">Seleccione</option>
                                                     <?php 
												...
												{
												?>
                                                <select name="tipoIdentificacion" style="width:380px"  id="tipoIdentificacion" class="SIUGJ_Control" campo="Tipo de identificaci&oacute;n" val="<?php echo $vCU==1?"obl":"" ?>" campo="Tipo de identificaci&oacute;n">
												<option value="-1">Seleccione</option>
                                                <?php 
                                            ...
                                            <tr height="50">
                                            	<td></td>
                                                <td align="left"><span class="letraTituloCampoRegistro" id="lblNoIdentificacion">No. de identificaci&oacute;n <span id="spNoIdentificacion" style="display:<?php echo $vCU==1?"":"none"?>;">*</span></span></td>
                                                <td ></td>
                                                <td align="left"><span class="letraTituloCampoRegistro" id="lblFechaExpedicion">Fecha de expedición del documento <span id="spFechaDocumento" style="display:<?php echo $vCU==1?"":"none"?>;">*</span></span></td>
                                            </tr>
                                            <tr height="50">
                                            	<td></td>
                                                <td align="left">
												...
												{
												?>
                                                <input   val="<?php echo $vCU==1?"obl":"" ?>"  class="SIUGJ_Control" size="42" maxlength="18" type="text" name="noIdentificacion" id="noIdentificacion" campo="No. de identificaci&oacute;n" value="<?php echo ($cInfo["noIdentificacion"]);?>"/></td>
                                                <?php
												}
												else
												{
	                                            ...
	                                            <input type='hidden' name='FExpedicion' id='FExpedicion' value='<?php echo ($cInfo["fechaExpedicionDocumento"]);?>'  campo='Fecha de expedici&oacute;n del documento' val="<?php echo $vCU==1?"obl":"" ?>"  extId="f_FExp"></td>
								...
								<fieldset class="frameSiugj" style="width:850px"><br /><br />
                                    ...
                                    <tr height="50">
                                        ...
                                        <td ></td>
                                        <td  align="left">
                                        	<input class="SIUGJ_Control" style="display:none"  size="42" type="text" name="CP" id="CP" campo="Código Postal" value='<?php echo ($cInfo["CP"])?>' onkeypress="return soloNumero(event,false,false,this)"/>
                                        </td>
                                    </tr>
