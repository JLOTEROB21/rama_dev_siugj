...
function inicializar()
{
	...
	parametros={urlDoc:bE(oDocumento.urlContenido.replace("../","<?php echo $urlSitio?>")+'?id='+bE('documento_'+gE('iDocumento').value)+'____eV2='+gE('eV2').value+'____nombreArchivo='+oDocumento.nombreArchivo)}
