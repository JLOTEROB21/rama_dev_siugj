...
function crearArbolAcciones()
{
    ...
    if((datosCtrl[2]=='4')||(datosCtrl[2]=='16')||(datosCtrl[2]=='19'))
    {
        ...
        nodoAlmacen=buscarNodoID(gEx('arbolDataSet').getRootNode(),idAlmacen);
		var pos=existeValorMatriz(h.arrQueriesResueltas,idAlmacen);
        if(nodoAlmacen.attributes)
	        iConexion=nodoAlmacen.attributes.idConexion;
        else
        	iConexion=nodoAlmacen.idConexion;
        if(pos!=-1)
                                          ...
                                          tbar:	[
                                                  {
                                                      ...
                                                      handler:function()
                                                              {
                                                                  mostrarVentanaOpcionesEvento(iConexion);
                                                              }
                                                  },
                                                  {
                                                      id:'btnAgregarCtrl',
...
function mostrarVentanaOpcionesEvento(idConexion)
{
															...
															handler: function()
																	{
                                                                        ...
                                                                        obtenerDatosWeb('../paginasFunciones/funcionesProyectos.php',funcAjax, 'POST','funcion=110&lOpciones='+bE(listaValores)+'&idControl='+h.idControlSel,true);
    ...
    llenarOpcionesControl(ventanaAM,idConexion);
}
...
function llenarOpcionesControl(ventana,idConexion)
{
	var divSel=h.gE('div_'+h.idControlSel);
    var datosCtrl=divSel.getAttribute('controlInterno').split("_");
    var qy='';
    if((datosCtrl[2]=='4')||(datosCtrl[2]=='16')||(datosCtrl[2]=='19'))
    {
    	...
    	if(pos!=-1)
        {
            ...
            obtenerDatosWeb('../paginasFunciones/funcionesProyectos.php',funcAjax, 'POST','funcion=109&idConexion='+idConexion+'&qy='+h.arrQueriesResueltas[pos][1]+'&idControl='+h.idControlSel,true);
    	}
        else
        	ventana.show();
    ...
    else
    {
        ...
        obtenerDatosWeb('../paginasFunciones/funcionesProyectos.php',funcAjax, 'POST','funcion=109&idConexion='+idConexion+'&idControl='+h.idControlSel,true);
	}
}
										...
										buttons:	[
														{
															...
															handler: function()
																	{
                                                                    	console.log(nodoArbolEventoSel);
																		var filas=gridOpcionesCtrl.getSelectionModel().getSelections();
                                                                        if(filas.length==0)
                                                                        {
                                                                        	msgBox('Al menos debe seleccionar una elemento');
                                                                        ...
                                                                        obtenerDatosWeb('../paginasFunciones/funcionesProyectos.php',funcAjax, 'POST','funcion=112&lControles='+(listaValores)+'&listaAccion='+listaAccion+'&idControl='+h.idControlSel+'&valorOpt='+bE(nodoArbolEventoSel.id),true);
