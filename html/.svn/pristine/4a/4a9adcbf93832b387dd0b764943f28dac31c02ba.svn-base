...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblCarpetasAdministrativasReporte.js.php"></script>
<style>
	body
	{
		min-height:500px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$listaCarpetas=-1;
							if(isset($objParametros->listaCarpetas))
	                        	$listaCarpetas=$objParametros->listaCarpetas;
							
                        ?>
                        	<input type="hidden" id="uGestion" value="<?php echo $uGestion ?>" />
                            <input type="hidden" id="nombreUnidad" value="<?php echo $nombreUnidad ?>" />
                            <input type="hidden" id="listaCarpetas" value="<?php echo $listaCarpetas ?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
