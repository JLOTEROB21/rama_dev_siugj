...
{	
	...
	arrSeccion4.push('p15');
    
    arrSeccion5.push('p16');
    arrSeccion5.push('p17');    
    ...
    else
    {
        ...
        gE('_[total]vch').innerHTML='<span id="sp_8618">'+Ext.util.Format.number(gEN('_totalvch')[0].value,'0.00')+ ' %</span>';
    }
