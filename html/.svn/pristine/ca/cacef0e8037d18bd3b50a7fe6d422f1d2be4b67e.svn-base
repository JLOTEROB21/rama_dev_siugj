				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="left">
                        	...
                        	<script src="../modulosEspeciales_SGJP/Scripts/propuestaAudiencia.js.php?iF=<?php echo bE($idFormulario)?>&iR=<?php echo bE($idRegistro)?>"></script>
                            
                            <table width="1100px">
                            <tr>
                            	<td align="right" style="padding-left:50px; padding-top:10px;">
