...
<script type="text/javascript" src="../reportes/Scripts/tblReporteNotificaciones.js.php"></script>
<!-- InstanceEndEditable -->
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$formato=1; //1 Excel; 2 PDF
							if(isset($objParametros->f))
								$formato=$objParametros->f;
                        ?>
                        	<input type="hidden" id="idReporte" value="<?php echo $idReporte?>" />
                            <input type="hidden" id="formato" value="<?php echo $formato?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
