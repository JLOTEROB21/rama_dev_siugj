...
<script type="text/javascript" src="../Scripts/IQSec/Firma.js"></script>
<script src="../modulosEspeciales_SIUGJ/Scripts/editorFormatosSeleccionFormatoWord.js.php" ></script>
...
<link rel="stylesheet" type="text/css" href="../principalPortal/css/estiloPlUploadSiugj.css"/>
<!-- InstanceEndEditable -->
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if($datosDocumento)
							{
								$idCategoriaDocumento=$datosDocumento["categoriaDocumento"];
								if(!$fFormato)
								{
