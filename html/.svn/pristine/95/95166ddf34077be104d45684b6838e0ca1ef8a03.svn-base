...
<script type="text/javascript" src="../Scripts/ChartMaster/Chart.js"></script>
<!-- InstanceEndEditable -->
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$unidadGestion=-1;
							if(isset($objParametros->unidadGestion))
								$unidadGestion=$objParametros->unidadGestion;	
								
							$tipoAudiencia=-1;
							if(isset($objParametros->tipoAudiencia))
								$tipoAudiencia=$objParametros->tipoAudiencia;	
								
							$formularioEvaluacion=-1;
							if(isset($objParametros->formularioEvaluacion))
								$formularioEvaluacion=$objParametros->formularioEvaluacion;		
									
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblReporteEvaluacionAudiencia.js.php?unidadGestion=<?php echo $unidadGestion?>&tipoAudiencia=<?php echo $tipoAudiencia?>&formularioEvaluacion=<?php echo $formularioEvaluacion?>"></script>
                        	<input type="hidden" id="unidadGestion" value="<?php echo $unidadGestion?>" />
                            <input type="hidden" id="fechaInicio" value="<?php echo $fechaInicio?>" />
                            <input type="hidden" id="fechaFin" value="<?php echo $fechaFin?>" />
