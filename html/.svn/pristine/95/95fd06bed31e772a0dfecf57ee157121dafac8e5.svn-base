...
<script type="application/javascript" src="../Sistema/Scripts/administracionComponente.js.php"></script>
<style>
	.sticky {
    position: fixed;
    top: 5px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
							...
							$consulta="SELECT * FROM 00020_tiposCompoentesRegistroBitacora WHERE idRegistro=".$idRegistro;
							$fRegistro=$con->obtenerPrimeraFilaAsoc($consulta);
							$lblFuncionSistema="";
							
							$consulta="SELECT nombreConsulta FROM 991_consultasSql WHERE idConsulta=".($fRegistro["funcionVerificacionDisponibilidad"]==""?-1:$fRegistro["funcionVerificacionDisponibilidad"]);
                                ...
                                <table width="950" border="0">
                                    <tr>
                                        <td align="left" colspan="3">
                                            <span class="tituloSIUGJ">Administraci&oacute;n de componentes</span><br /><br /><br />
                                        </td>
                                    </tr>
                                    ...
                                    <tr height="30">
                                        <td  width="450">
                                            <span class="<?php echo $estiloLetraFormulario?>">
                                                Nombre del componente <span style="color:#F00">*</span>
                                            </span>
                                        </td>
                                        <td>
                                        </td>
                                    ...
                                    <tr height="60">
                                        <td>
                                                <input type="text" value="<?php echo $fRegistro["nombreTipoComponene"]?>" size="42" class="<?php echo $estiloLetraControles?>" val="obl" id="_nombreTipoComponenevch" name="_nombreTipoComponenevch" />
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                    ...
                                    <tr height="30">
                                    	...
                                    	<td>
                                            <span class="<?php echo $estiloLetraFormulario?>" id="lblValorContabilizador">
                                                Funci&oacute;n de verificaci&oacute;n de disponibilidad
                                            </span>
                                        </td>
                                    </tr>
                                    </tr>
                                 <tr height="60">
                                    <td >
                                        <select id='_componenteActivoint' name="_componenteActivoint" style="width:200px" class="<?php echo $estiloLetraControles?> val='obl' campo='Componente Activo'>
                                                ...
                                                <?php
                                                    ...
                                                    $con->generarOpcionesSelectArreglo($arrOpcion,$fRegistro["componenteActivo"]);
                                                ?>
                                        </select>
                                    </td>
                                	<td  >
                                	...
                                	<td  >
                                   		<input type="text" value="<?php echo $lblFuncionSistema?>" id="funcionVerificacionDisponibilidad"  size="38" class="<?php echo $estiloLetraControles?> disabled="disabled"/>&nbsp;&nbsp;
                                        ...
                                        <input type="hidden" value="<?php echo $fRegistro["funcionVerificacionDisponibilidad"] ?>" id="hFuncionVerificacionDisponibilidad"  name="_funcionVerificacionDisponibilidadvch" campo="Funci&oacute;n de Verificaci&oacute;n de Disponibilidad"/>
                                    </td>
                                </tr>
                                </table><br /><br />
                                <table width="100%">
                            	 ...
                            	 <input type="hidden" name="tabla" value="00020_tiposCompoentesRegistroBitacora" />
                                  <input type="hidden" name="id" id="id" value="<?php echo $idRegistro?>" />
                                  <input type="hidden" name="campoId" value="idRegistro" />
                                  <input type="hidden" name="pagRedireccion" value="../Sistema/tblAdministracionComponentes.php"/>	
