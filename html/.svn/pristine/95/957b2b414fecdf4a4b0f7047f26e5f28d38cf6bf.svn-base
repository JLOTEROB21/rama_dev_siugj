...
<script type="text/javascript" src="../Scripts/cScanner.js.php"></script>
<script type="text/javascript" src="../scan/Scripts/tLatisScanner.js.php"></script>
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$cadObj="";
							if(isset($objParametros->cadObj))
								$cadObj=$objParametros->cadObj;
                        ?>
                        
                        	<input type="hidden" id="cadObj" value="<?php echo $cadObj?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
