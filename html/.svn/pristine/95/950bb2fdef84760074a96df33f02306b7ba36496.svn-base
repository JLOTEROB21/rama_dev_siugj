...
?>
<script type="text/javascript" src="Scripts/registrosUsuario.js.php"></script>
<!-- InstanceEndEditable -->
                   ...
                   <tr>
                        <td  align="center"><br />
                        	<?php
								...
								generarTableroControlObjetoUsuario($tipoProceso,"REGISTROS EN EVALUACI&Oacute;N POR ROL (TIPO DE PROCESO: <span class='letraRojaSubrayada8'>".$nTipoProceso."</span>)",$idProceso,$actor);
							?>
