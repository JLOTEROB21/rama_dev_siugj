...
<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblAdministracionJuecesAmparo.js.php"></script>
<style>
	.burbujaCoincidencia
		{
			height: 18px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        ?>
                            ...
                            <input type="hidden" id="mostrarGridJuez" value="<?php echo $mostrarGridJuez?>" />
