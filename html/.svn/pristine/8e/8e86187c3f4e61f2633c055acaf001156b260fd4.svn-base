<?php
	...
	$consulta="SELECT id__5_tablaDinamica,nombreTipo FROM _5_tablaDinamica where idEstado=2 order by nombreTipo";
...
function inyeccionCodigo()
{
    ...
    gE('sp_7651').innerHTML='';
    
    
    
	crearGridParticipantes();

	if(gE('sp_7660').innerHTML=='En trámite')
	{
		oE('div_7653');
		oE('div_7654');
		oE('div_7655');
