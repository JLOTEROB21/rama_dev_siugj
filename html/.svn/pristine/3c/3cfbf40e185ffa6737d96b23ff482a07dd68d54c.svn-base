...
{
	config.extraPlugins= 'pMarcador,pPrintDocumentPlantilla,cwjdsjcsconfineselection,pInsertParametroPlantilla';
	...
	config.toolbarGroups = [
							...
							{ name: 'plugins', groups: ['pPrintDocumentPlantilla']},
							{ name: 'plugins2', groups: ['pInsertParametroPlantilla']}  
						];
