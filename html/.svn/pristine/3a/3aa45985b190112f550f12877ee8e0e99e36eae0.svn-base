...
<link rel="stylesheet" type="text/css" href="../Scripts/ux/groupHeader/ColumnHeaderGroup.css"/>
<script type="text/javascript" src="../Scripts/ux/groupHeader/ColumnHeaderGroup.js"></script>
<script type="text/javascript" src="../gestorDocumental/Scripts/tablaRetencionDocumental.js.php"></script>
<?php
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
                        	$idTablaRetencion=-1;
							if(isset($objParametros->idTablaRetencion))
								$idTablaRetencion=$objParametros->idTablaRetencion;
							
							
							$consulta="SELECT * FROM 908_tablasRetencionDocumental WHERE idTablaRetencion=".$idTablaRetencion;
							$objInfo=utf8_encode($con->obtenerFilasJSON($consulta));
							
							
							$consulta="SELECT MAX(VERSION) FROM 908_versionesTablasRetencionDocumental WHERE idTablaRetencion=".$idTablaRetencion;
							$ultimaVersion=$con->obtenerValor($consulta);
							if($ultimaVersion=="")
								$ultimaVersion=-1;
                        ?>
                        	<input type="hidden" id="idTablaRetencion"  value="<?php echo $idTablaRetencion?>"/>
                            <input type="hidden" id="objInfo"  value="<?php echo bE($objInfo)?>"/>
                            <input type="hidden" id="ultimaVersion"  value="<?php echo $ultimaVersion?>"/>
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
