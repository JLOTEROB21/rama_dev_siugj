...
<link rel="stylesheet" href="../principalPortal/css/estilosFormulariosDinamicos.css"  type="text/css" media="screen" />
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							if(isset($objParametros->fechaConsulta))
								$fechaConsulta=$objParametros->fechaConsulta;
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SGJP/Scripts/tblNotificacionesAlertasDelDia.js.php?fechaConsulta=<?php echo $fechaConsulta?>"></script>
                        	<input type="hidden" id="fechaConsulta" value="<?php echo $fechaConsulta?>">
