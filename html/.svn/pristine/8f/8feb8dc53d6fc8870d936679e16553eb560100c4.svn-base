                        ...
                        <td align="center">
                        	<?php
								...
								if($tipoConsulta==2)
								{
									...
									$nTabla="658_percepciones";
									$idTabla="idPercepcion";
								}
								if($idUsuario=="-1")
									$consulta="select d.".$idTabla.",c.codigo,c.nombreConsulta,afectacionNomina,quincenaAfectacion,nQuincenasAfectacion,cicloAfectacion from ".$nTabla." d,991_consultasSql c where c.idConsulta=d.idConsulta and idUsuarioAplica is null";
								else
									$consulta="select d.".$idTabla.",c.codigo,c.nombreConsulta,afectacionNomina,quincenaAfectacion,nQuincenasAfectacion,cicloAfectacion from ".$nTabla." d,991_consultasSql c where c.idConsulta=d.idConsulta and idUsuarioAplica = ".$idUsuario;
																		
								$res=$con->obtenerFilas($consulta);
								$nRegistros=$con->filasAfectadas;
							?>
                            <script type="text/javascript" src="../nomina/Scripts/confPercepcionesDeducciones.js.php?tC=<?php echo bE($tipoConsulta)?>"></script>
                        	<table  width="100%">
                            	<tr>
                                	<td align="center" colspan="2">
                                    	<span class="tituloPaginas">Configuración de <?php echo $tPlural.$comp?></span><br /><br />
                        			</td>
                            	</tr>
                                <tr>
                                	<td align="left" colspan="2">
                                    	<br />
                                    	<span class="letraFichaRespuesta">Si desea agregar una nueva <?php echo $tSingular?> de click </span>
                                        <a href='javascript:agregarConcepto()'><span class="letraRoja"> AQUÍ</span>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                	<td align="center" colspan="2"><br /><br />
                                    	...
                                    	<span class="corpo8">Aún no existen <?php echo $tPlural?> configuradas</span>	
                                ...
                                <tr height="2">
                                	<td colspan="6" style="background-color:#003"></td>
                                </tr>
                                <tr height="4">
                                	<td colspan="6" ></td>
                                </tr>
                                ...
                                <tr id='fila_<?php echo $fila[0]?>'>
                                    ...
                                    <td align="left" class='<?php echo $clase?>'>
                                    	<?php
											$checar="";
											$consulta="select idTipoPuestoAfecta from 660_afectacionesDeducPercepciones where idDeduccionPercepcion=".$fila[0]." and tipo=".$tipoConsulta." and afectacion=1";
											$vRes=$con->obtenerValor($consulta);
											if($vRes!="")
												$checar='checked="checked"';
												
										?>
                                    	<input type="checkbox" id='chk_1_<?php echo $fila[0]?>' onclick="actualizaAfectacion(this)" <?php echo $checar?> />&nbsp;<span class="letraExt">Base</span>&nbsp;<br />
                                    	<?php
											$checar="";
											$consulta="select idTipoPuestoAfecta from 660_afectacionesDeducPercepciones where idDeduccionPercepcion=".$fila[0]." and tipo=".$tipoConsulta." and afectacion=2";
											$vRes=$con->obtenerValor($consulta);
											if($vRes!="")
												$checar='checked="checked"';
                                        ...
                                        <input type="checkbox" id='chk_2_<?php echo $fila[0]?>' onclick="actualizaAfectacion(this)" <?php echo $checar?>/>&nbsp;<span class="letraExt">Confianza&nbsp;</span><br />
                                    	<?php
											$checar="";
											$consulta="select idTipoPuestoAfecta from 660_afectacionesDeducPercepciones where idDeduccionPercepcion=".$fila[0]." and tipo=".$tipoConsulta." and afectacion=3";
											$vRes=$con->obtenerValor($consulta);
											if($vRes!="")
												$checar='checked="checked"';
                                        ...
                                        <input type="checkbox" id='chk_3_<?php echo $fila[0]?>' onclick="actualizaAfectacion(this)" <?php echo $checar?>/>&nbsp;<span class="letraExt">Mandos medio</span>&nbsp;
                                    </td>
                                    <td align="left" class='<?php echo $clase?>'>
                                    	<?php
                                            ...
                                            <td colspan="2">
                                                ...
                                                <?php
                                                    ...
                                                    if($con->filasAfectadas>0)
                                                        echo "<tr><td class='fondoVerde7' align='center' width='350'><span style='color:#000'>Estructura</span></td><td class='fondoVerde7' align='center' width='150'><span style='color:#000'>Cuenta</span></td><td class='fondoVerde7' align='center' width='120'><span style='color:#000'>Tipo afectación</span></td><td class='fondoVerde7' align='center' width='120'><span style='color:#000'>% afectación</span></td><td></td></tr>";
                                                    while($fCta=mysql_fetch_row($resCtas))
                                                    {
                                                        if($fCta[6]==1)
                                                            ...
                                                            $afectacion="Haber";
                                                        $consulta="select estructura from 560_estructuraCuenta where idEstructuraCuenta=".$fCta[7];
                                                        $estructura=$con->obtenerValor($consulta);
                                                ?>	
                                                    <tr id='fila_<?php echo ($fila[0])."_".($fCta[0])?>'>
                                                        <td class="fondoGrid7" align="left"><span style="color:#000"><?php echo $estructura?></span></td>
                                                        <td class="fondoGrid7" align="left"><span style="color:#000"><?php echo $fCta[3]?></span></td>
