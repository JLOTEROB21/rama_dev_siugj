...
<?php
	...
	$tituloModulo="Periodicidad de nómina";
...
<script type="text/javascript" src="../nomina/Scripts/periodicidadNominaPerfil.js.php"></script>
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							$idTipoNomina=-1;
							if(isset($objParametros->idTipoNomina))
								$idTipoNomina=$objParametros->idTipoNomina;
								
							$consulta="SELECT * FROM 677_tipoPagoNomina WHERE idTipoNomina=".$idTipoNomina;
							...
							$consulta="SELECT noOrdinal,nombreElemento,diainicio,mesInicio,
									(select count(idNomina) FROM 672_nominasEjecutadas n,662_perfilesNomina p WHERE p.idPerfilesNomina=n.idPerfil AND p.idPeriodicidad=".$idTipoNomina." AND  quincenaAplicacion=e.noOrdinal) as nRegistros 
									FROM 678_elementosTipoPagoNomina e WHERE idTipoPago=".$idTipoNomina." ORDER BY noOrdinal";
							$arrCategorias=$con->obtenerFilasArreglo($consulta);
							echo formatearTituloPagina($tituloModulo,true,$idTipoNomina);
                                        ...
                                        <tr>
                                        	<td align="left">
                                                ...
                                                <table>
                                                    ...
                                                    <tr height="21">
                                                        <td width="160" ><span class="letraAzulSimple">Título periodicidad:</span> <span style="color:#F00">*</span></td>
                                                        <td ><input type="text" value="<?php echo $fConcepto[1]?>" size="70" val="obl" name="_tipoNominavch" id="_tipoNominavch" campo="Título periodicidad" /></td>
                                                    </tr>
                                                    <tr height="21">
                                                        <td  valign="top"><span class="letraAzulSimple">Descripci&oacute;n:</span></td>
                                                        <td ><textarea cols="70" rows="6" name="_descripcionvch"><?php echo $fConcepto[2]?></textarea></td>
                                                    </tr>
                                                    <tr height="21">
                                                        <td  valign="top"><span class="letraAzulSimple">Listado de Periodos:</span></td>
                                                        <td  >
                                                ...
                                                <input type="hidden" name="tabla" value="677_tipoPagoNomina" />
                                                <input type="hidden" name="post"  value="" />
                                                <input type="hidden" name="id" id="id" value="<?php echo $idTipoNomina?>" />
                                                <input type="hidden" name="campoId" value="idTipoNomina" />
                                                <input type="hidden" name="pagRedireccion" value="../nomina/tblPeriodicidadNominaPerfil.php"/>	
