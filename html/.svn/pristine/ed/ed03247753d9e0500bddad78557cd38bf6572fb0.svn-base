<?php
	function inicializarMenuRenderer($menu,$tipoMenu,$nElemento)
	{
		...
		else
		{
			...
			echo '<div class="cabeceraMenu" id="'.$nElemento.'"><table width="100%"><tr><td class="menu_title" style="width:20px;text-align: left;vertical-align:middle important; "><img id="img_'.$nElemento.'" class="cImagenOpen"></td><td class="menu_title">'.$menu["titulo"]."</td></tr></table><div>";
			echo generarOpcionesMenuCensidaVertical($menu["opciones"]);
			echo "</div></div>";
