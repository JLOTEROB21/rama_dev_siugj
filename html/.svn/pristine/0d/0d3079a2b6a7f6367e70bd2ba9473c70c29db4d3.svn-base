CKEDITOR.editorConfig = function( config ) 
{
	...
	config.extraPlugins= 'pSaveDocument,pSaveFirmaElectronica,pSavePDF,cwjdsjcsconfineselection';
	config.toolbarGroups = [
							...
							{ name: 'plugins', groups: ['pSaveDocument','pSaveFirmaElectronica','pSavePDF']} 
						];
