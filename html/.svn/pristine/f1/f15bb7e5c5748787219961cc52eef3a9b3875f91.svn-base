...
require_once 'latis/PHPPowerPoint/Writer/PowerPoint2007.php';
...
/** PHPPowerPoint_Shape */
require_once 'latis/PHPPowerPoint/Shape.php';

/** PHPPowerPoint_Shape_RichText */
require_once 'latis/PHPPowerPoint/Shape/RichText.php';

/** PHPPowerPoint_Shape_BaseDrawing */
require_once 'latis/PHPPowerPoint/Shape/BaseDrawing.php';

/** PHPPowerPoint_Shape_Drawing */
require_once 'latis/PHPPowerPoint/Shape/Drawing.php';

/** PHPPowerPoint_Shape_MemoryDrawing */
require_once 'latis/PHPPowerPoint/Shape/MemoryDrawing.php';

/** PHPPowerPoint_Shared_Font */
require_once 'latis/PHPPowerPoint/Shared/Font.php';

/** PHPPowerPoint_Shared_String */
require_once 'latis/PHPPowerPoint/Shared/String.php';
