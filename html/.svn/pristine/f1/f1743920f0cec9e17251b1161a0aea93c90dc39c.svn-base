...
<script type="text/javascript" src="../Scripts/html2Canvas/html2canvas.min.js"></script>
<script type="text/javascript" src="../Scripts/fullcalendar/lib/moment.min.js"></script>
<script type="text/javascript" src="../Scripts/fullcalendar/fullcalendarEspecial.js"></script>
<script type="text/javascript" src="../Scripts/fullcalendar/lang/es.js"></script>
<script type="text/javascript" src="../Scripts/base64.js"></script>
<script src="../modulosEspeciales_SGJ/Scripts/tblAgendaRecursosAsignacionHora.js.php"></script>
<style type='text/css'>
	...
	{
    	content: attr(data-start-normalizado);
	}
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="left">
                            ...
                            <?php
								$tipoRecurso="-1";
								if(isset($objParametros->tipoRecurso))
								{
									$tipoRecurso=$objParametros->tipoRecurso;
								}
								
								$idRecurso="-1";
								if(isset($objParametros->idRecurso))
								{
									$idRecurso=$objParametros->idRecurso;
								}
								
								$idRegistroIgnorar="-1";
								if(isset($objParametros->idRegistroIgnorar))
								{
									$idRegistroIgnorar=$objParametros->idRegistroIgnorar;
								}
								...
								$horaInicio=strtotime("1984-05-10 00:00");
								...
								$lblNombrePrograma="Cita a Solicitar";
								
							?>
                            <input type="hidden" id="minutosDezplazamiento" value="<?php echo $minutosDezplazamiento?>" />
                            <input type="hidden" id="minutosDivision" value="30" />
                            <input type="hidden" id="fechaInicio" value="<?php echo $fechaInicio?>" />
                            <input type="hidden" id="tipoRecurso" value="<?php echo $tipoRecurso?>" />
                            <input type="hidden" id="idRegistroIgnorar" value="<?php echo $idRegistroIgnorar?>" />
                            <input type="hidden" id="idRecurso" value="<?php echo $idRecurso?>" />
                            <input type="hidden" id="sL" value="1" />
                            <input type="hidden" id="lblNombrePrograma" value="<?php echo bE($lblNombrePrograma)?>" />
