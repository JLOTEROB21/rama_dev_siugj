...
<link rel="stylesheet" type="text/css" href="../Scripts/ux/textoBotonField/ext.ux.textoBotonField.css" media="screen" />
<script type="text/x-javascript" src="../Scripts/ux/textoBotonField/ext.ux.textoBotonField.js"></script>
...
<link type="text/css" rel="stylesheet" href="../principalPortal/css/estiloPlUploadSiugj.css" media="screen" />
                   ...
                   <tr>
                       ...
                       <?php
						...
						if(isset($objParametros->sL))
					  	...
					  	$idActividad=-1;
						if($con->existeCampo("idActividad",$nombreTabla))
						{
							$consulta="SELECT idActividad FROM ".$nombreTabla." WHERE id_".$nombreTabla."=".$idRegistro;
							$idActividad=$con->obtenerValor($consulta);
						}
					  ?>
                      <script type="text/x-javascript" src="../modulosEspeciales_SIUGJ/Scripts/tblRegistroDocumentos.js.php?iF=<?php echo $idFormulario ?>&sL=<?php echo $sL?>&iR=<?php echo $idRegistro ?>"></script>
