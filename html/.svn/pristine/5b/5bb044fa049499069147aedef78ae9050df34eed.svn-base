...
function recargarGridEventos()
{
	gEx('frameContenidoCalendario').load	(
    								{
                                    	url:'../modulosEspeciales_SGJ/calendarioAudienciasPromovente.php',
                                        params:	{
                                                                                            ...
                                                                                            handler:function()
                                                                                                    {
                                                                                                        ...
                                                                                                        '","situacionAudiencia":"'+gEx('cmbSituacionEvento').getValue()+'","tipoVista":"3","idReferencia":"<?php echo $_SESSION["idUsr"]?>"}';
