        ...
        return this.each(function() {
            ...
            switch (effect) {
                ...
                case 'accordion':
					...
					{
						var resBusqueda=$(this).find("div");
						if(resBusqueda.length>0)
						{
							
							resBusqueda[0].src=(resBusqueda[0].src.indexOf('verMas.gif')!=-1)?'../images/verMenos.png':'../images/verMas.gif';
						}
                ...
                default:
                    ...
                    $($thisEven).click(function(evt) 
					{
						var resBusqueda=$(this).find("div");
						if(resBusqueda.length>0)
						{
							
							$(resBusqueda[0]).toggleClass('cImagenOpen cImagenClosed');
						}
                        $(this).children(':first-child').toggleClass(settings.arrowRclass + ' ' + settings.arrowDclass);
