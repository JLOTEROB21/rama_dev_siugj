...
<?php
	$tituloModulo="Configuración de fundamento legal por medio de notificación";
?>
<style>
	.x-tree-node-icon
	{
...
<script src="../modulosEspeciales_SGJP/Scripts/tblConfiguracionMediosNotificacionFundamentoLegal.js.php"></script>
<!-- InstanceEndEditable -->
