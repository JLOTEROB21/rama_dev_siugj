...
<script type="application/javascript" src="../gestorDocumental/Scripts/frmPerfilMetaDato.js.php"></script>
<style>
	.sticky {
    position: fixed;
    top: 5px;
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="center">
							...
							$idPerfilMetaDato=-1;
							if(isset($objParametros->idPerfilMetaDato))	
								$idPerfilMetaDato=$objParametros->idPerfilMetaDato;
							$consulta="SELECT * FROM 20005_perfilesMetaDatos WHERE idPerfilMetaDato=".$idPerfilMetaDato;
                        	...
                        	<form id="frmEnvio" method="post" action="../paginasFunciones/guardarDatos.php">
                                ...
                                <td align="left" colspan="3">
                                	<span class="tituloSIUGJ">Perfil de metadatos (Catálogo)</span><br /><br /><br />
                                ...
                                <tr height="30">
                                	<td width="450">
                                        <span class="<?php echo $estiloLetraFormulario?>">
                                             Cve. del perfil <span style="color:#F00"></span>
                                        </span>
                                    </td>
                                    <td width="50">
                                    </td>
                                ...
                                <tr height="60">
                                	<td >
                                    <input type="text" value="<?php echo $fRegistro["cvePerfil"]?>" size="20" class="<?php echo $estiloLetraControles?>" val="" id="_cvePerfilvch" name="_cvePerfilvch" />
                                    
                                    </td>
                                    <td>
                                    </td>
                                    <td>
                                    <input type="text" value="<?php echo $fRegistro["nombrePerfil"]?>" size="42" class="<?php echo $estiloLetraControles?>" val="obl" id="_nombrePerfilvch" name="_nombrePerfilvch" />
                                    </td>
                                </tr>
                                <br /><br />
                                <tr height="30" >
                                ...
                                <tr height="60" colspan="3">
                                	<td colspan="3">
                                        <textarea style="width:450px; height:90px !important;" class="<?php echo $estiloLetraControles?>"  id="_descripcionvch" name="_descripcionvch"><?php echo $fRegistro["descripcion"]?></textarea>
                                    </td>
                                </tr>
                                 <tr height="30" id="fila_4">
                                	<td   valign="top"  colspan="3">
                                        <span class="<?php echo $estiloLetraFormulario?>"><br />
                                           Ingrese los metadatos que forman parte del perfil
                                        </span><br /><br />
                                    </td>
                                   
                                </tr>
                                 <tr height="23" id="fila_4">
                                    <td  colspan="3">
                                ...
                                <table width="100%">
                            		...
                            		<?php
										$consulta="SELECT idMetaDato,obligatorio FROM 20006_metaDatoPerfil WHERE idPerfilMetaDato=".$idPerfilMetaDato;
										$arrMetaDatos=$con->obtenerFilasArreglo($consulta);
									?>
                            	 <input type="hidden" name="tabla" value="20005_perfilesMetaDatos" />
                                  <input type="hidden" name="id" id="id" value="<?php echo $idPerfilMetaDato?>" />
                                  <input type="hidden" name="campoId" value="idPerfilMetaDato" />
                                  <input type="hidden" name="arrOpciones" id="arrMetaDatos" value="<?php echo bE($arrMetaDatos)?>" />
                                  <input type="hidden" name="pagRedireccion" value="../gestorDocumental/tbPerfileslMetaDatos.php"/>	
                                  
                                  <?php
								  if($idPerfilMetaDato==-1)
								  {
									 ?>
