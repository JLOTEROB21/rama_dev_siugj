<?php session_start();
	...
	function registroProcesoJudicialSIUGJ($solicitudRadicacion,$token)
	{
		...
		if($aResultado[0]==0)
		{
			$oResp=json_decode($aResultado[1]);
			
			$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>'.$oResp->error.'</datosComplementarios></datosResultado>';
			return $resultado;
		}
		try
		{
			...
			switch($tipoRadicacion)
			{
				case 1://Ordinario
					...
					$consulta="SELECT COUNT(*) FROM 817_vistasEstadosMunicipio WHERE cveEstado='".$departamentoRadicacion."' AND cveMunicipio='".$ciudadRadicacion."'";
					$nReg=$con->obtenerValor($consulta);
				
					if($nReg==0)
					{
						$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>La relaci&oacute;n departameto - ciudad no es correcta o no se encuentra habilitado la radicaci&oacute;n en la ciudad indicada</datosComplementarios></datosResultado>';
						return $resultado;
					}
				
				
					$urlAcuse="generarAcuseRadicacion";
					...
					{
						case 1:
							$limite=20*	$salarioMinimo;	
							if($cuantiaProceso<=$limite)
							{
								$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>Los procesos ordinarios laborales de primera instancia, son aquellos que exceden de 20 SMMLV ($ '.number_format($limite,2).')</datosComplementarios></datosResultado>';
								return $resultado;
							}
						break;
						case 20:
							...
							if($cuantiaProceso>$limite)
							{
								$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>Los procesos ordinarios laborales de &uacute;nica instancia, son aquellos que no exceden de 20 SMMLV ($ '.number_format($limite,2).')</datosComplementarios></datosResultado>';
								return $resultado;
							}
						break;
					}
				...
				case 2://Tutela
					$tipoProceso=6;
					$etapaCambio=3.5;
					$urlAcuse="generarAcuseRadicacionTutela";
			...
			foreach($sujetosProcesales as $s)
			{
				...
				$consulta="SELECT COUNT(*) FROM _1250_tablaDinamica t,_1250_gridSujetosProcesales s WHERE s.figuraJuridica=".$tipoSujetoProcesal." AND s.idReferencia=t.id__1250_tablaDinamica
						AND t.idReferencia=".$tipoProceso;
				$nReg=$con->obtenerValor($consulta);
				if($nReg==0)
				{
					$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El tipo de sujero procesal \''.($tipoSujetoProcesal==""?"Vac&iacute;o":$tipoSujetoProcesal).'\' NO es v&aacute;lido para este tipo de proceso judicial</datosComplementarios></datosResultado>';
					return $resultado;
				}
				
				$consulta="SELECT COUNT(*) FROM _5_tablaDinamica WHERE id__5_tablaDinamica=".($tipoSujetoProcesal==""?-1:$tipoSujetoProcesal);
				$nReg=$con->obtenerValor($consulta);
				if($nReg==0)
				{
					$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El tipo de sujero procesal \''.($tipoSujetoProcesal==""?"Vac&iacute;o":$tipoSujetoProcesal).'\' NO es v&aacute;lido</datosComplementarios></datosResultado>';
					return $resultado;
				}
				...
				{
					$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El tipo de persona NO es v&aacute;lido</datosComplementarios></datosResultado>';
					return $resultado;
				}			
				...
				if(($tipoSujetoProcesal!=5)&&($tipoSujetoProcesal!=17))
				{
				...
				if($tipoPersona==1)//Natural
				{
					...
					if($tipoIdentificacion!="")
					{
						...
						if($noIdentificacion!="")
						{
							...
							{
								$fechaExpedicion=trim((string)$s->fechaExpedicion);
								$arrResultados=buscarInformacionRegistraduria($noIdentificacion);

								switch($arrResultados["Respuesta"])
								{
									case 1:
										if($fechaExpedicion!=$arrResultados["fechaExpedicion"])
										{
											$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>La fecha de expedición del documento no coincide con registradur&iacute;a (\''.cv($nombreCompleto).'\')</datosComplementarios></datosResultado>';
											return $resultado;
										}
										
										$fechaLimiteNacimiento=strtotime("-18 years",strtotime($arrResultados["fechaExpedicion"]));
										
										$socioDemograficos=$s->socioDemograficos[0];
										$fechaNacimiento=$socioDemograficos->fechaNacimiento[0];
										if($fechaNacimiento=="")
										{
											$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>Debe ingresar la fecha de nacimiento de la persona \''.cv($nombreCompleto).'\'</datosComplementarios></datosResultado>';
											return $resultado;
										}
										
										if(strtotime($fechaNacimiento)>$fechaLimiteNacimiento)
										{
											$leyenda='La fecha de nacimiento no puede ser mayor a '.date("d/m/Y",$fechaLimiteNacimiento)." (".$nombreCompleto.")";
											$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>Debe ingresar la fecha de nacimiento de la persona \''.cv($nombreCompleto).'\'</datosComplementarios></datosResultado>';
											return $resultado;
										}
					...
					if($socioDemograficos)
					{
						...
						if($nReg==0)
						{
							$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El g&eacute;nero de la persona \''.($nombreCompleto).'\' NO es v&aacute;lido</datosComplementarios></datosResultado>';
							return $resultado;
						...
						if($nReg==0)
						{
							$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El grupo &eacute;tnico de la persona \''.($nombreCompleto).'\' NO es v&aacute;lido</datosComplementarios></datosResultado>';
							return $resultado;					
						}
						...
						if($nReg==0)
						{
							$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El tipo de discapacidad de la persona \''.($nombreCompleto).'\' NO es v&aacute;lida</datosComplementarios></datosResultado>';
							return $resultado;					
						}
					...
					if($datosContacto)
					{
						...
						if($nReg==0)
						{
							$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El departamento del domicilio de la persona \''.($nombreCompleto).'\' NO es v&aacute;lido</datosComplementarios></datosResultado>';
							return $resultado;
						...
						if($nReg==0)
						{
							$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>La ciudad del domicilio de la persona \''.($nombreCompleto).'\' NO es v&aacute;lida</datosComplementarios></datosResultado>';
							return $resultado;
						...
						if($telefonosContacto!="")
						{
							...
							foreach($telefonosContacto->telefono as $t)
							{
								...
								if(($tipo!=1)&&($tipo!=2))
								{
									$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El tipo de tel&eacute;fono de la persona \''.($nombreCompleto).'\' NO es v&aacute;lido</datosComplementarios></datosResultado>';
									return $resultado;
								}
								...
								if($nReg==0)
								{
									$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El pa&iacute;s del tel&eacute;fono de la persona \''.($nombreCompleto).'\' NO es v&aacute;lido</datosComplementarios></datosResultado>';
									return $resultado;
								...
								{
									$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>El n&uacute;mero del tel&eacute;fono de la persona \''.($nombreCompleto).'\' NO es v&aacute;lido (10 d&iacute;gitos)</datosComplementarios></datosResultado>';
									return $resultado;
								}
						...
						if($correosElectronicos)
						{
							foreach($correosElectronicos->mail as $m)
							{
								...
								if(!validarCorreo($m))
								{
									$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>La direcci&oacute;n de correo \''.$m.'\' de la persona \''.($nombreCompleto).'\' NO es v&aacute;lida</datosComplementarios></datosResultado>';
									return $resultado;
								}
			...
			foreach($sujetosProcesales as $s)
			{
				...
				$tipoPersona=(string)$s->tipoPersona;
				$tipoSujetoProcesal=(string)$s->tipoSujetoProcesal;
				$aceptaNotificacionEmail="";
				
				$datosContacto=$s->datosContacto[0];
				if($datosContacto)
				{
					$aceptaNotificacionEmail=trim((string)$datosContacto->aceptaNotificacionEmail);
				}
				...
				if($tipoPersona==1)//Natural
				{
					...
					$arrDatosPersona["tipoPersona"]=$tipoPersona;
				...
				$query[$x]="INSERT INTO 7005_relacionFigurasJuridicasSolicitud(idActividad,idParticipante,idFiguraJuridica,situacion,
							...
							VALUES(".$idActividad.",".$idRegistroPersona.",".$tipoSujetoProcesal.",1,".$idCuentaAcceso.",1,1,NULL,0)";
				$x++;
				$datosContacto=$s->datosContacto[0];
			...
			{
				case 1:
					cambiarEtapaFormulario($idFormulario,$idRegistroRadicacion,3.5,"",-1,"NULL","NULL",0);
					//cambiarEtapaFormulario($idFormulario,$idRegistroRadicacion,4,"",-1,"NULL","NULL",0);
				break;
				case 2:
					cambiarEtapaFormulario($idFormulario,$idRegistroRadicacion,4,"",-1,"NULL","NULL",0);
				break;
			...
			$consulta="select unidad FROM 817_organigrama WHERE codigoUnidad='".$fRadicacion["despachoAsignado"]."'";
			$despachoAsignado=$con->obtenerValor($consulta);
			
			$arrParametros=array();
			$arrParametros["idRegistro"]=$idRegistroRadicacion;
			$resultado=realizarEjecucionPagina($urlSitio."modulosEspeciales_SIUGJ/".$urlAcuse.".php",$arrParametros,"POST");
			...
			$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>1</resultado><iDRadicacion>'.$idRegistroRadicacion.'</iDRadicacion><folioRadicacion>'.$folioRegistro.
					'</folioRadicacion><fechaRegistro>'.$fRadicacion["fechaCreacion"].'</fechaRegistro><fechaRecepcion>'.$fechaRecepcion.
					'</fechaRecepcion><cup>'.$fRadicacion["carpetaAdministrativa"].'</cup><despachoAsignado>'.cv($despachoAsignado).
					'</despachoAsignado><documentoAcuse>'.bE($resultado).'</documentoAcuse><datosComplementarios></datosComplementarios></datosResultado>';
			return $resultado;
		}
		catch(Exception $e)
		{
			$resultado='<?xml version="1.0" encoding="ISO-8859-1"?><datosResultado><resultado>0</resultado><datosComplementarios>'.cv($e->getMessage()).'</datosComplementarios></datosResultado>';
			return $resultado;
		}
	}
