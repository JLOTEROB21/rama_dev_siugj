<?php
	...
	function generarArregloMenusPagina($nomPagina,$posicion)
	{
		global $con;
		$arrMenus=array();
		$consulta="select distinct(pO.idOpcion),tM.textoMenu,tM.colorFondo,idFuncionVisualiza,idFuncionRenderer,clase,icono from 813_paginasVSOpciones pO,
		...
		while($filaM=mysql_fetch_row($res))
		{
			...
			$arrMenus[$filaM[1]."_".$filaM[0]]["icono"]=$filaM[6];
