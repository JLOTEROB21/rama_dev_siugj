...
class zip  {  
	...
	function addAuthor() {
		...
		fwrite($fp, "Ez a ZIP archívum PHP-vel készült.\n");
		fwrite($fp, "A ZIP osztályt készítette: Mágus (phpmagus@gmail.com)\n");
	...
	function downloadZip($filename) {
		...
		elseif ( ! file_exists( $filename ) ) {
			echo "<html><title>AlfaZoneSoft PHP Zip Class</title><body><b>Hiba:</b> A letöltendõ fájl nem létezik.</body></html>";
			exit;
		}
