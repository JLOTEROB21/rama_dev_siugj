...
function obtenerCarpetaAdministrativaProceso($idFormulario,$idRegistro)
{
	...
	switch($idFormulario)
	{
		...
		default:
			$campoCarpetaEncontrado=false;
			
			if($con->existeCampo("carpetaAdministrativa2aInstancia",$nombreTablaBase))
			{
				$consulta="select carpetaAdministrativa2aInstancia from ".$nombreTablaBase." where ".$campoLlave."=".$idRegistro;
				$carpetaAdministrativa=$con->obtenerValor($consulta);
				if(($carpetaAdministrativa!="N/E")&&($carpetaAdministrativa!=""))
				{
					$campoCarpetaEncontrado=true;
				}
				else
					$carpetaAdministrativa="";
			...
			if(!$campoCarpetaEncontrado)
			{
				if($con->existeCampo("carpetaAdministrativaIncistencia",$nombreTablaBase))
				{
					$consulta="select carpetaAdministrativaIncistencia from ".$nombreTablaBase." where ".$campoLlave."=".$idRegistro;
					$carpetaAdministrativa=$con->obtenerValor($consulta);
				}
				else
