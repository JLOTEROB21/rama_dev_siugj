<?php	include_once("PHPExcel.php");		
	...
	class cExcel
	{
		...
		function setBorde($rango,$estilo,$color="000000",$tipoBorde="allborders") //P punteado,N ninguno,PR punto y guion, RPP  raya punto punto, D doble,G grueso,DE delgado
		{
			$estiloLinea;
			switch($estilo)
			{
			...
			$arrEstilo["borders"][$tipoBorde]["color"]["argb"]="00".$color;
			$arrEstilo["borders"][$tipoBorde]["style"]=$estiloLinea;
