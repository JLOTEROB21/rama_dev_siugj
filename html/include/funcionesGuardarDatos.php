<?php	
	...
	function asociarRolesRendererControl($idRegistro,$cadRoles)
	{
		global $con;
		$cadRoles=bD($cadRoles);
		$oRoles=json_decode($cadRoles);
		...
		$query[$x]="begin";
		$x++;
		$query[$x]="DELETE FROM 9033_rolesFuncionesScripts WHERE idFuncion=".$idRegistro;
		$x++;
		
		foreach($oRoles as $rol)
		{
			$query[$x]="INSERT INTO 9033_rolesFuncionesScripts(idFuncion,rol)VALUES(".$idRegistro.",'".$rol->idRol."')";
			$x++;
	...
	function asociarRegsitrosBitacoraAuditorio($cadRegistros)
	{
		global $con;
		$cadRegistros=bD($cadRegistros);
		$oRegistros=json_decode($cadRegistros);
		
		
		$x=0;
		$query[$x]="begin";
		$x++;
		$query[$x]="DELETE FROM 00021_tiposRegistroBitacoraAcceso";
		$x++;
		
		foreach($oRegistros->registros as $r)
		{
			$query[$x]="INSERT INTO 00021_tiposRegistroBitacoraAcceso(idRegistroBitacora,valor) VALUES(".$r->idRegistroBitacora.",'".$r->valor."')";
			$x++;
	...
	function asociarOpcionesMetaDato($idRegistro,$cadObj)
	{
		global $con;
		$cadObj=bD($cadObj);
		
		$oObj=json_decode($cadObj);
		
		
		$x=0;
		$query[$x]="begin";
		$x++;
		$query[$x]="DELETE FROM 20004_opcionesMetaDatos WHERE idMetaDatos=".$idRegistro;
		$x++;

		foreach($oObj->registros as $o)
		{
			$query[$x]="INSERT INTO 20004_opcionesMetaDatos(idMetaDatos,valor,etiqueta) VALUES(".$idRegistro.",'".cv($o->valorOpcion)."','".cv($o->etiqueta)."')";
			$x++;
	...
	function asociarMetaDatoPerfil($idRegistro,$cadObj)
	{
		global $con;
		...
		$query[$x]="begin";
		$x++;
		$query[$x]="DELETE FROM 20006_metaDatoPerfil WHERE idPerfilMetaDato=".$idRegistro;
		$x++;

		foreach($oObj->registros as $o)
		{
			$query[$x]="INSERT INTO 20006_metaDatoPerfil(idPerfilMetaDato,idMetaDato,obligatorio) VALUES(".$idRegistro.",".cv($o->idMetaDato).",".$o->obligatorio.")";
			$x++;
	...
	function asociarAmbitoAplicacionPlantilla($idRegistro,$cadObj)
	{
		global $con;
		$cadObj=bD($cadObj);
		...
		$query[$x]="begin";
		$x++;
		$query[$x]="DELETE FROM _10_ambitoAplicacionPlantilla WHERE idFormulario=10 AND idReferencia=".$idRegistro;
		$x++;
		...
		{
			$query[$x]="INSERT INTO _10_ambitoAplicacionPlantilla(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(10,".$idRegistro.",1,'".$e->cveElemento."')";
			$x++;
		}
		...
		{
			$query[$x]="INSERT INTO _10_ambitoAplicacionPlantilla(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(10,".$idRegistro.",2,'".$e->cveElemento."')";
			$x++;
		}
		...
		{
			$query[$x]="INSERT INTO _10_ambitoAplicacionPlantilla(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(10,".$idRegistro.",3,'".$e->cveElemento."')";
			$x++;
		}
		...
		{
			$query[$x]="INSERT INTO _10_ambitoAplicacionPlantilla(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(10,".$idRegistro.",4,'".$e->cveElemento."')";
			$x++;
		}
	...
	function asociarAmbitoAplicacionSuspensionTerminos($idRegistro,$cadObj)
	{
		global $con;
		$cadObj=bD($cadObj);
		...
		$query[$x]="begin";
		$x++;
		$query[$x]="DELETE FROM _1235_ambitoAplicacionSuspensionTerminos WHERE idFormulario=1235 AND idReferencia=".$idRegistro;
		$x++;
		...
		foreach($obj->arrDistritos as $e)
		{
			$query[$x]="INSERT INTO _1235_ambitoAplicacionSuspensionTerminos(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(1235,".$idRegistro.",1,'".$e->cveElemento."')";
			$x++;
		}
		...
		foreach($obj->arrCircuitos as $e)
		{
			$query[$x]="INSERT INTO _1235_ambitoAplicacionSuspensionTerminos(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(1235,".$idRegistro.",2,'".$e->cveElemento."')";
			$x++;
		}
		...
		foreach($obj->arrMunicipios as $e)
		{
			$query[$x]="INSERT INTO _1235_ambitoAplicacionSuspensionTerminos(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(1235,".$idRegistro.",3,'".$e->cveElemento."')";
			$x++;
		}
		...
		foreach($obj->arrDespachos as $e)
		{
			$query[$x]="INSERT INTO _1235_ambitoAplicacionSuspensionTerminos(idFormulario,idReferencia,tipoAmbito,cveElemento) VALUES(1235,".$idRegistro.",4,'".$e->cveElemento."')";
			$x++;
		}
