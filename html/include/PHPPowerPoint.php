...
require_once ('latis/PHPPowerPoint/DocumentProperties.php');

/** PHPPowerPoint_Shared_ZipStreamWrapper */
require_once ('latis/PHPPowerPoint/Shared/ZipStreamWrapper.php');

/** PHPPowerPoint_SlideIterator */
require_once ('latis/PHPPowerPoint/SlideIterator.php');
