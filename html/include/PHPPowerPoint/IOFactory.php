...
require_once ('latis/PHPPowerPoint/Reader/IReader.php');
...
{	
	...
	private static $_searchLocations = array(
		array( 'type' => 'IWriter', 'path' => 'latis/PHPPowerPoint/Writer/{0}.php', 'class' => 'PHPPowerPoint_Writer_{0}' ),
		array( 'type' => 'IReader', 'path' => 'latis/PHPPowerPoint/Reader/{0}.php', 'class' => 'PHPPowerPoint_Reader_{0}' )
	);
