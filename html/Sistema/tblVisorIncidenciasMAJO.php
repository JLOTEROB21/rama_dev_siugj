				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="left">
							...
							$consulta="SELECT idRegistro,fechaRegistro,claveLicencia,from_base64(reporte) AS reporte FROM 20900_reporteErroresInstancias";
							$configuracion='{
												"inicializar":1,
												"pantallaCompleta":"Reporte de Insidentes",
												"confBotones":	[
