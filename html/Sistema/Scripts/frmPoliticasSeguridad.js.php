...
function inicializar()
{
    ...
    asignarEvento(gE('_reportarErroresAdministradorint'),'change',function(cmb)
        							{
                                    	var valor=cmb.options[cmb.selectedIndex].value;
                                        
                                        if(valor=='1')
                                        {
                                        	gE('_correoErroresAdministradorvch').setAttribute('val','obl|mail');
                                        }
                                        else
                                        {
                                        	gE('_correoErroresAdministradorvch').value='';
                                            gE('_correoErroresAdministradorvch').setAttribute('val','');
