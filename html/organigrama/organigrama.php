...
if($tipoOrganigrama==1)
	header("location:../organigrama/organigramaInst.php");
?>
...
<script type="text/javascript" src="Scripts/organigrama.js.php"></script>
<?php
                            ...
                            <table>
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        $codigoRaiz=$con->obtenerValor($consulta);
                                        echo "<input type='hidden' id='idCodRaiz' value='".$codigoRaiz."'>";
                                    ?>
                                </tr>
                            </table>
                        </td>
