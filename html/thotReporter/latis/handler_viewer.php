...
//require_once '../latis/handlerlatis.php';
...
$handler->onPrepareVariables = function ($args) {
	...
	*/
	...
	//Esto devuelve la lista de variables del reporte.
	//$args->variables['VarClaveDenominacionDelito']->value = 1;
	
	$resp = StiResponse::json($args);
	//return StiResult::success('onpreparevariable  is not implemented on the server side.'.json_encode($args));
