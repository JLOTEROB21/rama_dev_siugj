...
<script language="javascript" src="Scripts/mensajesAccion.js.php"></script>
                          ...
                          <tr>
                            <td align="center">
                                ...
                                <TD align="left">
                                        ...
                                        <?php $idCircular="-1";
                                            if(isset($objParametros->idCircular))
                                                $idCircular=$objParametros->idCircular;
                                            $idProceso="-1";
											if(isset($objParametros->idProceso))
												$idProceso=$objParametros->idProceso;
											$numEtapa="-1";	
                                            if(isset($objParametros->nEtapa))
												$numEtapa=$objParametros->nEtapa;
                                        ...
                                        ?>
                                        <input type="hidden" value="" id="numIdiomas" name="numIdiomas">
                                        <input type="hidden" value="<?php echo $idCircular?>" id="idCircular" name="idCircular" />
                                        <input type="hidden" value="<?php echo $idProceso?>" id="idProceso" />
                                        <input type="hidden" value="<?php echo $numEtapa?>" id="numEtapa" />
                                        </td>
                                        <td align="left" style="vertical-align:top" width="175">
                                        <span id="divPermisos">	</span>
                                        </td>
                                  </tr>
                                </table>
							</td>
