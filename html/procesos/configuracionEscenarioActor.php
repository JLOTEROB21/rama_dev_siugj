                   ...
                   <tr>
                        <td>
                        	<?php
								...
								$tipoActor=-1;
								if(isset($objParametros->tipoActor))
									$tipoActor=$objParametros->tipoActor;
								$idActor=-1;
								if(isset($objParametros->idActor))
									$idActor=$objParametros->idActor;
							...
							?>	
                            	<script type="text/javascript" src="../Scripts/base64.js"></script>
  								<script type="text/javascript" src="../procesos/Scripts/configuracionEscenarioActor.js.php?proc=<?php echo  base64_encode($idProceso)?>"></script>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <?php
											...
											$consulta="select actor,idActorProcesoInicio from 950_actorVSProcesoInicio where idProceso=".$idProceso." and idPerfil=".$idPerfil;
                                                                        ...
                                                                        <table width="100%">
                                                                   			<?php
																				$consulta="select ap.idActorVSAccionesProceso,aa.accion,aa.idGrupoAccion,ap.complementario 
																						...
																						aa.idGrupoAccion=ap.idAccion  and ap.actor='".$fila[0]."' and idProceso=".$idProceso." and ap.idPerfil=".$idPerfil;
										...
										?>		
											<tr>
                                                ...
                                                <td align="right" class="etiquetaFicha">
                                                	<a href="javascript:configurarNotificaciones('<?php echo bE($idProceso) ?>','<?php echo bE($filaP[0])?>')"><img src="../images/campana.png" title="Configurar notificaciones" alt="Configurar notificaciones" /></a>&nbsp;&nbsp;&nbsp;<a href='javascript:configurarDisparador("<?php echo bE($idProceso)?>","<?php echo bE($filaP[0])?>")'><img src="../images/lightning_add.png" title='Configurar disparadores' alt='Configurar disparadores'/>
                                                </td>
                                            </tr>	
                                            <?php
                                            	$consulta="select actor,tipoActor,idActorProcesoEtapa,asocAutomatico from 944_actoresProcesoEtapa where numEtapa=".$filaP[0]." and idProceso=".$idProceso." and idPerfil=".$idPerfil;
                                                            	...
                                                            	<table width="100%">
                                                                	<tr>
                                                                    	<td>
                                                                        	<table width="100%">
                                                                   			<?php
																				$consulta="select ap.idAccionesProcesoEtapaVSAcciones,aa.accion,aa.idGrupoAccion,ap.complementario,ap.complementario2,ap.complementario3 from 
                                                                                                ...
                                                                                                <?php
                                                                                                    ...
                                                                                                    switch($filaPA[2])
                                                                                                    {
                                                                                                        ...
                                                                                                        case "4":
																											...
																											echo '<span class="copyrigth" ><b>'.$lblEtiqueta.'</span>&nbsp;&nbsp;';
																											?>
                                                                                                            <a href="javascript:removerAccion(<?php echo $filaPA[0]?>)"><img src="../images/delete.png" alt="Remover acción" title="Remover acción" /></a>&nbsp;&nbsp;
                                                                                                            <?php
                                                                                                            if($filaPA[3]=="")
                                                                                                                $btnComp="<a href='javascript:configurarDictamenParcial(\"".bE($filaAc[2])."\",\"".bE($filaPA[0])."\",\"".bE($filaP[0])."\")'><img src='../images/warning.png' title='Este elemento requiere que se le indique la etapa al cual pasar&aacute; el proceso de acuerdo al dictamen tomado, para configurarlo de click sobre este ícono' alt='Este elemento requiere que se le indique la etapa al cual pasar&aacute; el proceso de acuerdo al dictamen tomado, para configurarlo de click sobre este ícono'></a>";
                                                                                                            else
                                                                                                            {
                                                                                                                $consulta="select idElementoDictamen,idFormulario from 948_actoresVSFormulariosDictamen where idActorVSFormularioDictamen=".$filaPA[3];
                                                                                                                ...
                                                                                                                $btnComp="	<br><br><table>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td>
																																	&nbsp;&nbsp;
                                                                                                                                    <a href='javascript:configurarDictamenParcial(\"".bE($filaAc[2])."\",\"".bE($filaPA[0])."\",\"".bE($filaP[0])."\",\"".bE($idElemento)."\")'><img src='../images/pencil.png' alt='Modificar opciones de dictamen' title='Modificar opciones de dictamen'></a>
                                                                                                                                    </td>
                                                                                                                                </tr>";
                                                                                                                $resOpt=$con->obtenerFilas($consulta);
                                                                                                                while($filasOpt=mysql_fetch_row($resOpt))
                                                                                                        ...
                                                                                                        case "5":
                                                                                                            ...
                                                                                                            <?php
                                                                                                            if($filaPA[3]=="")
                                                                                                                $btnComp="<a href='javascript:configurarDictamenFinal(\"".bE($filaAc[2])."\",\"".bE($filaPA[0])."\",\"".bE($filaP[0])."\")'><img src='../images/warning.png' title='Este elemento requiere que se le indique la etapa al cual pasar&aacute; el proceso de acuerdo al dictamen tomado, para configurarlo de click sobre este ícono' alt='Este elemento requiere que se le indique la etapa al cual pasar&aacute; el proceso de acuerdo al dictamen tomado, para configurarlo de click sobre este ícono'></a>";
                                                                                                            else
                                                                                                            {
                                                                                                                $consulta="select idElementoDictamen,idFormulario from 948_actoresVSFormulariosDictamen where idActorVSFormularioDictamen=".$filaPA[3];
                                                                                                                ...
                                                                                                                $btnComp="	<br><br><table>
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td>&nbsp;&nbsp;
                                                                                                                                    <a href='javascript:configurarDictamenFinal(\"".bE($filaAc[2])."\",\"".bE($filaPA[0])."\",\"".bE($filaP[0])."\",\"".bE($idElemento)."\")'><img src='../images/pencil.png' alt='Modificar opciones de dictamen' title='Modificar opciones de dictamen'></a>
                                                                                                                                    </td>
                                                                                                                                </tr>";
                                                                                                                $resOpt=$con->obtenerFilas($consulta);
                                                                                                                while($filasOpt=mysql_fetch_row($resOpt))
																										...
																										break;
																										case 21:
																											$btnComp="<br><br><span class='corpo8_bold'>Institucion/departamentos que el actor puede ver:</a> <a href='javascript:agregarUnidad(\"".bE($filaPA[0])."\")'><img src='../images/add.png' title='Agregar Institución/departamento' alt='Agregar Institución/departamento'></a>
																																	<br><br><table id='tblUnidades_".$filaPA[0]."'>
																																	<tr>
																																		<td width='380' class='fondoVerde7' align='center'>
																																			Instituci&oacute;n / Departamento
																																		</td>
																																		<td width='200' class='fondoVerde7' align='center'>
																																			Ámbito
																																		</td>
																																	</tr>";
																											$arrAmbito[0]="Sólo Institucion/departamento";
																											$arrAmbito[1]="Instituci&oacute;n/departamento y subdepartamentos";
																																	
																											$consulta="SELECT idAmpliaUniversoRegistro,a.codigoUnidad,ambito,a.codigoUnidad FROM 947_ampliacionesAmbitoRegistros a 
																														WHERE idAccionesProcesoEtapaVSAcciones=".$filaPA[0];						
																											$resAmp=$con->obtenerFilas($consulta);
																											while($filaAmplia=mysql_fetch_row($resAmp))
																											{
																												$codInstitucion=obtenerInstitucionDepto($filaAmplia[3]);
																												$comp="";
																												if(($codInstitucion!=$filaAmplia[3])&&($filaAmplia[1]>0))
																												{
																													$consulta="select unidad from 817_organigrama where codigoUnidad ='".$codInstitucion."'";
																												...
																												if($filaAmplia[1]>0)
																												{
																													$consulta="select unidad from 817_organigrama where codigoUnidad ='".$filaAmplia[3]."'";
																													
																													$unidadInstitucion=$con->obtenerValor($consulta);
																												}
																												else
																												{
																													switch($filaAmplia[1])
																													{
																														case -1:
																															$unidadInstitucion="Institución a la que pertenece";
																														break;
																														case -2:
																															$unidadInstitucion="Departamento al que pertenece";
																														break;
																													}
																												}
																												$btnComp.="	<tr id='filaAmbito_".$filaAmplia[0]."'>
																																<td class='fondoGrid7'><a href='javascript:removerUnidad(\"".bE($filaAmplia[0])."\")'><img alt='Remover Institución/departamento' title='Remover Institución/departamento' src='../images/delete.png'></a> ".$unidadInstitucion.$comp."
																																</td>
																																<td class='fondoGrid7'>".$arrAmbito[$filaAmplia[2]]."
																																</td>
																															</tr>";
																											}
																											$btnComp.="				</table>";
																										...
																										case 30:
																											 ...
																											 if($filaPA[4]=="")
                                                                                                                $btnComp="<a href='javascript:configurarModuloFirmaCertificacion(".$filaPA[0].",".$filaP[0].")'><img src='../images/warning.png' title='Este elemento requiere ser configurado, para llevar acabo dicha acci&oacute;n de click sobre este ícono'  alt='Este elemento requiere ser configurado, para llevar acabo dicha acci&oacute;n de click sobre este ícono'></a>";
                                                                                                            else
                                                                                                            	$btnComp="<a href='javascript:configurarModuloFirmaCertificacion(".$filaPA[0].",".$filaP[0].",\"".bE($filaPA[4])."\")'><img src='../images/pencil.png' title='Modificar configuraci&oacute;n' alt='Modificar configuraci&oacute;n'></a>";
                                                                                                            
																										break;
																										case 31:

																											$btnComp="<span id=\"btn_".$filaPA[0]."\"><a href='javascript:configurarSubidaDocumento(".$filaPA[0].",".$filaP[0].",\"".bE($filaPA[4])."\")'><img src='../images/pencil.png' title='Configurar documentos de subida'  alt='Configurar documentos de subida'></a></span>";
                                    ...
                                    <input type="hidden" id="tipoActor" value="<?php echo $tipoActor?>" />
                                    <input type="hidden" id="idActor" value="<?php echo $idActor?>" />
