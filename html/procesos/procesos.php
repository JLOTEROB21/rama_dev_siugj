					...
					<form id="frmEnvio" method="post" action="../procesos/generarProceso.php">
                       ...
                       <table  border="0" cellspacing="0" cellpadding="0">
                            ...
                            <table  width="900" border="0">
                                ...
                                <tr height="50">
                                  <td align="left">
                                      <input class="<?php echo $estiloLetraControles?>" type="text" name="_cveProcesovch" id="_cveProcesovch"  style="width:400px" val="obl" campo="Cve. de Proceso" value="<?php echo $fila[11]?>" />	
                                  </td>
                                  <td  align="left">
                                      <input class="<?php echo $estiloLetraControles?>" type="text" name="_nombrevch" id="_nombrevch"  style="width:400px" val="obl" campo="titulo" value="<?php echo $fila[1]?>" />	
                                  </td>
                                </tr>
                                <tr height="50">
                                  <td width="450" align="left">
                                ...
                                <tr height="50">
                                  <td align="left" valign="top">
                                      <select class="<?php echo $estiloLetraControles?> comboProcesoClass" name="_idTipoProcesoint" id="_idTipoProcesoint" style="width:400px">
										<?php
                                  ...
                                  <td  align="left" valign="top">
                                      <textarea class="<?php echo $estiloLetraControles?>"  style="width:400px; height:60px !important" id="_descripcionvch" name="_descripcionvch" val="" campo="Descripcion" ><?php echo $fila[2]?></textarea>							
                                  </td>
                                </tr>
                                
                                <tr height="50">
                                  <td width="450" align="left" colspan="2">
                                      <span class="<?php echo $estiloLetraFormulario?>">
                                ...
                                <tr height="50">
                                  <td  align="left" valign="top" colspan="2">
                                      <textarea class="<?php echo $estiloLetraControles?>"  style="width:900px; height:100px !important" id="_descripcionvch" name="_descripcionvch" val="" campo="Descripcion" ><?php echo $fila[2]?></textarea>							
                                  </td>
                                </tr>
                                <tr height="23">
                                <td colspan="2" align="center">
                                 <br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<input type="button" value="Guardar" onclick="validar('frmEnvio')" class="btnSIUGJ" style="width:140px" /> 
                                        </td>
                                    </tr>
                                    </table>
                                </td>
                              ...
                              <?php
							 		...
							 		if(($idProceso!=-1)&&($fila[3]!=1))
									{
                              			echo	'	<tr height="23">
															...
															<span class="leyendaFormulario">
															<span style="color:#9B2027;">*</span>	
															Para modificar la configuración del escenario del proceso de click <a href="javascript:configurarProcesoProyecto()"><span style="color:#9B2027;">AQUÍ</span></a><br><br>
															<span>
															</td>
													</tr>';
									}
