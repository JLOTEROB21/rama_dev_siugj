...
<script type="text/javascript" src="Scripts/listadoProcesos.js.php"></script>
<!-- InstanceEndEditable -->
<?php
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td>
                            ...
                            <tr>
                            	<td width="200"></td>
                            	<td class="letraFicha" width="160">Por favor elija un proceso:</td>
                                <td> 	<select name="idProceso" id="idProceso" onchange="enviarProceso(this)">
                        	...
                        	<form method="post" action="tblEtapas.php" id="frmEnvio">
                            	<input type="hidden" name="hIdProceso" id="hIdProceso" value="" />
                            </form>
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
