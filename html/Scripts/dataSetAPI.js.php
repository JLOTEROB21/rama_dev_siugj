	...
	var form = new Ext.form.FormPanel(	
										{
											...
											items: 	[
                                                        ...
                                                        },
                                                        {
                                                        	x:150,
                                                            y:15,
                                                            html:'<div id="divComboConexion"></div>'
                                                        },
														gridTablasInv
													]
										}
                                                            ...
                                                            click:
                                                                    {
                                                                        fn:function()
                                                                        {
                                                                            ...
                                                                            {
                                                                                msgBox('Debe almenos selecionar una tabla en la cual se basar&aacute; su almac&eacute;n');
                                                                                return;
                                                                            }
                                                                            var x;
                                                                            var nomTabla='';
	...
	var ventanaAM = new Ext.Window(
									{
										...
										listeners : {
													show : {
																...
																fn : function() 
																{
                                                                	var cmbConexion=crearComboExt('cmbConexion',arrConexiones,0,0,250,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboConexion'});
                                                                            ...
                                                                            handler:function()
                                                                            		{
                                                                                        ...
                                                                                        if(filaSel==null)
                                                                                        {
                                                                                            msgBox('Debe selecionar la tabla en la cual se basar&aacute; su consulta');
                                                                                            return;
                                                                                        }
...
function mostrarVentanaFiltro(objTabla,ocultarProy)
{
	...
	var form = new Ext.form.FormPanel(	
										{
											...
											items: 	[
                                                        ...
                                                        },
                                                        {
                                                        	x:300,
                                                            y:15,
                                                            html:'<div id="divComboOperacion"></div>'
                                                        },
                                            			{
                                                        	x:10,
                                                            y:70-(ocultarProy?50:0),
                                                            cls:'SIUGJ_Etiqueta',
	...
	var ventanaAM = new Ext.Window(
									{
										title: 'Configuraci&oacute;n de filtro de consulta [Tabla: '+objTabla.nTablaUsr+']',
										width: 900,
										height:460,
										layout: 'fit',
										plain:true,
										...
										listeners : {
													show : {
																...
																fn : function() 
																{
                                                                	var cmbOperacion=crearComboExt('cmbOperacion',arrOperaciones,0,0,300,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboOperacion'});
                                                                    ...
                                                                    if(ocultarProy)
                                                                    {
                                                                        ...
                                                                        oE('divComboOperacion');
                                                                        gEx('lblOperacion').hide();
                                                                        ocultarEt=true;
                                                                        gridCampos.enable();
                                                                    }
                                                                    else
...
function crearGridCampos(ocultarProy)
{
    ...
    alDatos.loadData(dsDatos);
	var chkRow=new Ext.grid.CheckboxSelectionModel({singleSelect:!ocultarProy,width:40});
	...
	var tblGrid=	new Ext.grid.EditorGridPanel	(
                                                        {
                                                            ...
                                                            frame:false,
                                                            x:10,
                                                            y:100-(ocultarProy?50:0),
                                                            cls:'gridSiugjPrincipal',
                                                            stripeRows :false,
                                                            columnLines : false,
                                                            cm: cModelo,
                                                            height:230+(ocultarProy?50:0),
                                                            width:850,
                                                            sm:chkRow,
                                                            disabled:true
                                                        }
    ...
    var form = new Ext.form.FormPanel(	
                                        {
                                            ...
                                            items: 	[
                                                        ...
                                                        valorTxt,
                                                        {
                                                            ...
                                                            y:50,
                                                            xtype:'label',
                                                            html:'<div id="divCampoFecha" style="width:140px;display:none"></div>'
                                                       ...
                                                       
                                                        {
                                                            ...
                                                            y:425,
                                                            cls:'SIUGJ_Etiqueta',
                                                            html : 'Considerar s&oacute;lo los primeros:'
                                                        },
                                                        {
                                                        	xtype:'numberfield',
                                                            allowDecimals:false,
                                                        ...
                                                        },
                                                        {
                                                        ...
                                                        },
                                                         {
                                                            ...
                                                            boxLabel : 'Considerar s&oacute;lo valores distintos (Distinct)'
                                                        }
                                                    ]
                                        }
                                    );
                                                ...
                                                listeners : {
                                                                show : {
                                                                            ...
                                                                            fn : function() 
                                                                            {
                                                                                ...
                                                                                var cmbCondicion=crearComboExt('cmbCondicion',[],0,0,200,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboCondicion'});
                                                                                ...
                                                                                cmbCondicion.on('select',setFocoValor);
                                                                            	var valor=crearComboExt('cmbValor',[],0,0,220,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboValor'});
                                                                                var valorDte=new Ext.form.DateField	(
                                                                                                                    {
                                                                                                                        id:'dteValor',
                                                                                                                        renderTo:'divCampoFecha',
                                                                                                                        width:130,                                                                                                                       
...
function crearGridOrden(aCampos)
{
	...
	var cmbOrden=crearComboExt('cmbOrden',arrOrden,0,0,null,{ctCls:'comboWrapSIUGJGrid',cls:'comboSIUGJGrid',listClass:'listComboSIUGJGrid'});
    var cmbCampos=crearComboExt('cmbCamposOrdenQuery',arrCampos,0,0,null,{otrasConfiguraciones:{listWidth:650},ctCls:'comboWrapSIUGJGrid',cls:'comboSIUGJGrid',listClass:'listComboSIUGJGrid'});
    var dsDatos=[];
    var alDatos=	new Ext.data.SimpleStore	(
                                                {
                                                    fields:	[
	...
	var cModelo= new Ext.grid.ColumnModel   	(
												 	[
														...
														chkRow,
														{
                                                            ...
                                                            renderer:function(val)
                                                            			{
                                                                        	return mostrarValorDescripcion(formatearValorRendererCombo(cmbCampos.getStore(),val,'id','nombre'));
                                                                        }
														},
														{
															header:'Orden',
...
function ingresarParametroAlmacen()
{
    ...
    if(tDataSet==2)
	    objParametro=['16','Valor de par\xE1metro de proceso'];
    ...
    switch(tDataSet)
    {
        ...
        case 2:
        	if(permitirRegistroParametro)
                arrTipoEntrada=[['0','Campo de tabla'],['7','Consulta auxiliar'],['6','Par\xE1metro registrado'],['5','Registrar par\xE1metro'],['11','Valor de almac\xE9n'],['16','Par\xE1metro de proceso'],['3','Valor de sesi\xF3n'],['4','Valor de sistema']];
            else
	...
	var form = new Ext.form.FormPanel(	
										{
											...
											items: 	[
                                                        ...
                                                        },
                                                        {
                                                        	x:240,
                                                            y:65,
                                                            id:'lblDivComboValorParametro',
                                                            html:'<div id="divComboValorParametro"></div>'
                                                        },
                                                        {
                                                        	id:'lblAlmacen',
                                                        	x:10,
                                                        ...
                                                        },
                                                        {
                                                        	x:240,
                                                            y:65,
                                                            id:'lblDivComboAlmacenParametro',
                                                            html:'<div id="divComboAlmacenParametro"></div>'
                                                        },
                                                        {
                                                        	id:'lblCampo',
                                                        	x:10,
                                                        ...
                                                        },
                                                        {
                                                        	x:270,
                                                            y:115,
                                                            id:'lblDivComboCampoParametroCampo',
                                                            html:'<div id="divComboCampoParametroCampo"></div>'
                                                        }
													]
										}
									);
	...
	var ventanaAM = new Ext.Window(
									{
										...
										listeners : {
													show : {
																...
																fn : function() 
																{
                                                                	var cmbTipoValor=crearComboExt('cmbTipoValor',arrTipoEntrada,0,0,400,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboTipoValor'});
																    cmbTipoValor.on('select',funcTipoEntradaChangeParam);
                                                                    
                                                                    var cmbValor=crearComboExt('cmbValorAlmacen',[],0,0,300,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboValorParametro'});
                                                                 	gEx('lblDivComboValorParametro').hide();
                                                                    
                                                                    var cmbAlmacen=crearComboExt('cmbAlmacen',[],0,0,300,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboAlmacenParametro'});
                                                                    ...
                                                                    gEx('lblDivComboAlmacenParametro').hide();                        
                                                                    
                                                                    var cmbCampoParametro=crearComboExt('cmbCampoParametro',[],0,0,300,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divComboCampoParametroCampo'});
                                                                    gEx('lblDivComboCampoParametroCampo').hide();
...
function funcTipoEntradaChangeParam(combo,registro)
{
	...
	switch(registro.get('id'))
    {
    	case '0':
            ...
            gEx('lblDivComboValorParametro').show();
            lblValorAsigna.show();
        break;
    	case '5':
        ...
        break;
         case '11':
        	...
        	gEx('lblDivComboAlmacenParametro').show();
            lblAlmacen.show();
            lblCampo.show();
            gEx('lblDivComboCampoParametroCampo').show();
            cmbCampo.reset();
        break;
        case '16':
...
function mostrarVentanaAsignarParam()
{
    ...
    switch(tDataSet)
    {
        ...
        break;
        case 2:
        	arrTipoEntrada=[['7','Consulta auxiliar'],['11','Valor de almac\xE9n'],['1','Valor constante'],['16','Valor de proceso'],['3','Valor de sesi\xF3n'],['4','Valor de sistema']];
        break
        default:
        	 arrTipoEntrada=[['7','Consulta auxiliar'],['11','Valor de almac\xE9n'],['3','Valor de sesi\xF3n'],['4','Valor de sistema']];
        break;
	...
	var form = new Ext.form.FormPanel(	
										{
											...
											items: 	[
                                                        ...
                                                        },
                                                        {
                                                        	x:230,
                                                            y:10,
                                                            html:'<div id="divCmbValorAsignar"></div>'
                                                        },
                                                        {
                                                        	id:'lblValorAsigna',
                                                        	x:10,
                                                        ...
                                                        },
                                                        {
                                                        	x:230,
                                                            y:60,
                                                            id:'lblDivControlFormulario',
                                                            html:'<div id="divCmbValorControlFormulario" style="width:350px"></div>'
                                                        },
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            y:60,
                                                            id:'lblDivComboValor',
                                                            html:'<div id="divCmbValor" style="width:350px"></div>'
                                                        },
                                                        ...
                                                        },
                                                        {
                                                        	x:230,
                                                            y:60,
                                                            id:'lblDivComboAlmacen',
                                                            html:'<div id="divCmbAlmacen" style="width:350px"></div>'
                                                        },
                                                        {
                                                        	id:'lblCampo',
                                                        	x:10,
                                                            y:115,
                                                            cls:'SIUGJ_Etiqueta',
                                                            html:'Campo a utilizar:',
                                                            hidden:true
                                                        },
                                                        {
                                                        	x:230,
                                                            y:110,
                                                            id:'lblDivComboCampoAlmacen',
                                                            html:'<div id="divCmbCampoAlmacen" style="width:350px"></div>'
                                                        }
													]
										}
									);
	...
	var ventanaAM = new Ext.Window(
									{
										...
										listeners : {
													show : {
																...
																fn : function() 
																{
                                                                	var cmbTipoValor=crearComboExt('cmbTipoValor',arrTipoEntrada,0,0,350,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCmbValorAsignar'});
																    cmbTipoValor.on('select',funcTipoEntradaChange);
                                                                    
                                                                    var cmbControlFormulario=crearComboExt('cmbControlFormulario',[],0,0,350,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCmbValorControlFormulario'});
																    gEx('lblDivControlFormulario').hide();
                                                                    
                                                                    var cmbValor=crearComboExt('cmbValor',[],0,0,350,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCmbValor'});
                                                                    gEx('lblDivComboValor').hide();
                                                                    
                                                                    
                                                                    var cmbAlmacen=crearComboExt('cmbAlmacen',[],0,0,350,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCmbAlmacen'});
                                                                    cmbAlmacen.on('select',function(cmb,registro)
                                                                                            {
                                                                                                var arrCampos=obtenerCamposDisponibles(registro.get('id'));
                                                                                                gEx('cmbCampoParametro').setValue('');
                                                                                                gEx('cmbCampoParametro').getStore().loadData(arrCampos);
                                                                                            }
                                                                                 )
                                                                    
                                                                    gEx('lblDivComboAlmacen').hide();                        
                                                                    
                                                                    var cmbCampoParametro=crearComboExt('cmbCampoParametro',[],0,0,350,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCmbCampoAlmacen'});

                                                                    gEx('lblDivComboCampoAlmacen').hide();  
																}
															}
												},
										buttons:	[
                                                                        ...
                                                                        switch(cmbTipoValor.getValue())
                                                                        {
                                                                            ...
                                                                            case '11':
                                                                                ...
                                                                                if(nodoCampo.nCampo!=undefined)
                                                                                	...
                                                                                	nCampo=nodoCampo.attributes.nCampo;
                                                                                valor=gEx('cmbAlmacen').getValue()+'|'+nCampo;
                                                                            break;
                                                                            case '24':
...
{
	gEx('vAsignaParametro').setHeight(230);
	
	gEx('lblDivControlFormulario').hide();
	var txtValorConstante=gEx('txtValorConstante');
    txtValorConstante.hide();
    var cmbValor=gEx('lblDivComboValor');
    cmbValor.hide();
    var lblValorAsigna=gEx('lblValorAsigna');
    lblValorAsigna.hide();
    var lblAlmacen=gEx('lblAlmacen');
    lblAlmacen.hide();
    var cmbAlmacen=gEx('lblDivComboAlmacen');
    gEx('cmbAlmacen').setValue('');
    cmbAlmacen.hide();
    var cmbCampo=gEx('lblDivComboCampoAlmacen');
    gEx('cmbCampoParametro').setValue('');
    cmbCampo.hide();
    var lblCampo=gEx('lblCampo');
    lblCampo.hide();
	...
	switch(registro.get('id'))
    {
        ...
        break;
        case '2':
        	gEx('cmbValor').getStore().loadData(arrParametrosRep);
        	cmbValor.show();
            lblValorAsigna.show();
        break;
        case '3':
        ...
        case '7':
        	...
        	gEx('cmbValor').getStore().loadData(arrConsultaAux);
        	cmbValor.show();
            lblValorAsigna.show();
        break;
        case '11':
            ...
            lblCampo.show();
            cmbCampo.show();
            gEx('cmbAlmacen').reset();
            gEx('vAsignaParametro').setHeight(290);

        break;
        case '16':
        	arrParametrosObjeto=arrProceso;
        	gEx('cmbValor').getStore().loadData(arrParametrosObjeto);
        	cmbValor.show();
            lblValorAsigna.show();
        break;
        case '17':
        ...
        case '24':
            ...
            gEx('lblDivControlFormulario').show();
            function funcAjax()
            {
                var resp=peticion_http.responseText;
                arrResp=resp.split('|');
