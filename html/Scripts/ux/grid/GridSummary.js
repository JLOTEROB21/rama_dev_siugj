...
Ext.extend(Ext.ux.grid.GridSummary, Ext.util.Observable, {
    ...
    calculate : function(rs, cm) {
		...
		var arrDatosGrid=this.grid.id.split('_');
		var idCtrl=arrDatosGrid[1];
		if(typeof(arrFuncionesGridDeposito)!='undefined')
		{
			if(eval('typeof(arrFuncionesGridDeposito.funcionDepositoPie_'+idCtrl+')')!='undefined')
			{
				eval('arrFuncionesGridDeposito.funcionDepositoPie_'+idCtrl+'(data);');
			}
		}
        return data;
    },
