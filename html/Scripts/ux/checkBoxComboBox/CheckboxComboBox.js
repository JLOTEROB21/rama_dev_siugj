...
Ext.ux.form.CheckboxCombo = Ext.extend(Ext.form.TriggerField, {
    ...
    initComponent: function() 
	{
		...
		if(this.initialConfig.funcionCheckBoxCheck)
		{
			this.funcionCheckBoxCheck=this.initialConfig.funcionCheckBoxCheck;
		}
		
		if(this.initialConfig.caracterLimitante)
		{
			this.caracterLimitante=this.initialConfig.caracterLimitante;
		}
	...
	addCheckboxes: function() {
		...
		this.cbgroup.mon(this.cbgroup, 'change', function(cbg, arr) 
		{
			...
			if(this.funcionCheckBoxCheck)
			{
				this.funcionCheckBoxCheck(this,arr);
			}
			else
