	...
	var form = new Ext.form.FormPanel(	
										{
											...
											items: 	[
                                                        ...
                                                        },
                                                        {
                                                        	x:250,
                                                            y:15,
                                                            html:'<div id="divCategoriaExpresion"></div>'
                                                        },
	...
	var ventanaAM = new Ext.Window(
									{
										...
										listeners : {
													show : {
																...
																fn : function() 
																{
                                                                	var cmbCategoriaExpresion=crearComboExt('cmbCategoriaExpresion',arrCategoriasExpresion,0,0,350,{ctCls:'comboWrapSIUGJControl',cls:'comboSIUGJControl',listClass:'listComboSIUGJControl',renderTo:'divCategoriaExpresion'});
