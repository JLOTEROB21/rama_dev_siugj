...
CKEDITOR.plugins.add('pPrintDocument',	{
											init:	function(editor)
													{
														var pluginName='pPrintDocument';
														editor.ui.addButton	('pPrintDocument',
																				{
																					label:'Imprimir documento',
																					command:'printDocument',
																					icon:CKEDITOR.plugins.getPath('pPrintDocument')+'printer.png'
																				}
																			)
																			
														var cmd=editor.addCommand('printDocument',{exec: imprimirDocumentoExec});
													}	
										}
				);

function imprimirDocumentoExec(e)
{
