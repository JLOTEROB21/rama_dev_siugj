//<input id='timepicker1' type='text' value='12:00 pm' size=8 maxlength=8 onClick="selectTime(this,timepicker1)" onMouseOver="selectTime(this,timepicker1)" ONBLUR="validateDatePicker(this)">

    var imagePath='../Scripts/timePickerImages/';
	var ie=document.all;
	...
	function refreshTimePicker(mode) {
		...
		sHTML = "<table><tr><td><table cellpadding=3 cellspacing=0 style='background-color:#D1E7EF'>";
		for (i=0;i<=11;i++) {
		...
		sHTML += "</table></td></tr></table><B style='color:#4576DF'>Latis&#174;</B>";
		document.getElementById("timePickerContent").innerHTML = sHTML;
	}

	if (DOM)
	{
		document.write ("<div id='timepicker' style='z-index:+999;position:absolute;visibility:hidden;left:0px;top:0px'><table style='border-width:3px;border-style:solid;border-color:#6494FF;background-color:#FFF' cellpadding=0><tr style='background-color:#6393FF'><td><table style='background-color:#6393FF' cellpadding=0 cellspacing=0 width='100%' background='" + imagePath + "titleback.gif'><tr valign=bottom height=21><td style='font-family:verdana;font-size:11px;color:#FFF;padding:3px' valign=center><B>&nbsp;&nbsp;Seleccione Hora&nbsp;&nbsp;</B></td><td><img id='iconAM' src='" + imagePath + "am1.gif' onclick='document.getElementById(\"iconAM\").src=\"" + imagePath + "am1.gif\";document.getElementById(\"iconPM\").src=\"" + imagePath + "pm2.gif\";refreshTimePicker(0)' style='cursor:hand'></td><td><img id='iconPM' src='" + imagePath + "pm2.gif' onclick='document.getElementById(\"iconAM\").src=\"" + imagePath + "am2.gif\";document.getElementById(\"iconPM\").src=\"" + imagePath + "pm1.gif\";refreshTimePicker(1)' style='cursor:hand'></td><td align=right valign=center>&nbsp;<img onclick='closeTimePicker()' src='" + imagePath + "close.gif'  STYLE='cursor:hand'>&nbsp;</td></tr></table></td></tr><tr><td colspan=2><span id='timePickerContent'></span></td></tr></table></div>");
		refreshTimePicker(0);
	}
	...
	function selectTime(ctl,ctl2) 
	{
		...
		var divCalendario=gE('timepicker');
		divCalendario.style.left=ctl.offsetLeft	+ leftpos+'px' ;
		divCalendario.style.top=ctl.offsetTop +	toppos + ctl.offsetHeight +	2+'px'; 
		divCalendario.style.visibility=(DOM||ie)? "visible" : "show";
