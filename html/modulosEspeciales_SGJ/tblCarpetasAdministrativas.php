...
<script type="text/javascript" src="../modulosEspeciales_SGJ/Scripts/tblCarpetasAdministrativas.js.php"></script>
<style>
	body
	{
		min-height:650px;
			    ...
			    <tr>    
				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        <td align="left">
                        <?php
							$uGestion=$_SESSION["codigoInstitucion"];
							if(isset($_POST["uGestion"]))
	                        	$uGestion=$_POST["uGestion"];
								
							$nombreUnidad="Cualquiera"	;
							if($uGestion!=0)	
							{
								$consulta="SELECT nombreUnidad FROM _17_tablaDinamica WHERE claveUnidad='".$uGestion."'";	
								$nombreUnidad=$con->obtenerValor($consulta);
							}
                        ?>
                        	<input type="hidden" id="uGestion" value="<?php echo $uGestion ?>" />
                            <input type="hidden" id="nombreUnidad" value="<?php echo $nombreUnidad ?>" />
                        </td>
                   </tr>
				  <!-- InstanceEndEditable -->
				  <tr>
