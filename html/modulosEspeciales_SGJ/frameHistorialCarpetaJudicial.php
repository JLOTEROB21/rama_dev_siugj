				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							{
								$idCarpeta=$objParametros->iC;
							}
                        ?>
                        	<script type="text/javascript" src="../modulosEspeciales_SGJ/Scripts/frameHistorialCarpetaJudicial.js.php?cA=<?php echo $cA?>&iC=<?php echo $idCarpeta?>"></script>
                        	<input type="hidden" id="cA" value="<?php echo $cA?>" />
