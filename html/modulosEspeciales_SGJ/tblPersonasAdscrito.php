				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
							...
							$consulta="SELECT claveUnidad FROM _17_tablaDinamica WHERE id__17_tablaDinamica=".$idRegistro;
							$adscripcion=$con->obtenerValor($consulta);	
						
							$consulta="SELECT u.idUsuario,Nombre,
										(SELECT GROUP_CONCAT(r.nombreGrupo) FROM 807_usuariosVSRoles uR,8001_roles r WHERE 
										uR.idUsuario=u.idUsuario AND r.idRol=uR.idRol) AS roles
										 FROM  800_usuarios u,801_adscripcion a,817_organigrama o
										WHERE a.idUsuario=u.idUsuario AND o.codigoUnidad=a.Institucion and a.Institucion='".$adscripcion."' ORDER BY u.Nombre";
							$configuracion='{
												"inicializar":1,
												"pantallaCompleta":"Personal Adscrito",
												"confBotones":	[
																],
												"confCampos":	[
																	{
