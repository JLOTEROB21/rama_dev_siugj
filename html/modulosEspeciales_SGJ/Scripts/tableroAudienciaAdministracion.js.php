<?php
	...
	while($fSituacionImp=$con->fetchRow($rSituacionImp))
	{
	...
	while($fila=$con->fetchRow($resEtapas))
	{
	...
	alDatos.on('beforeload',function(proxy)
    								{
                                        ...
                                        proxy.baseParams.idCarpetaAdministrativa=<?php echo  $registrarIDCarpeta?"arrCarpeta[1]":"-1"?>;
										if(nodoCarpetaSel.attributes.tipoCarpeta=='11')
                                        {
                                        	proxy.baseParams.idCarpetaAdministrativa=arrCarpeta[1];
                                        }
																				...
																				handler:function()
																						{
                                                                                            ...
                                                                                            obtenerDatosWeb('../paginasFunciones/funcionesModulosEspeciales_SGP.php',funcAjax, 'POST','funcion=408&cA='+gE('carpetaAdministrativa').value+'&iP=-1&iR='+fila.data.idDocumento,true);
															...
															handler: function()
																	{
                                                                        ...
                                                                        obtenerDatosWeb('../paginasFunciones/funcionesModulosEspeciales_SGP.php',funcAjax, 'POST','funcion=408&iFormulario=-1&iRegistro=-1&cA='+gE('carpetaAdministrativa').value+'&iP='+nodoPlantillaSel.id,true);
                                                                            ...
                                                                            handler:function()
                                                                            		{
                                                                                        ...
                                                                                        gEx('gTelefonosCParticipante_C').startEditing(gEx('gTelefonosCParticipante_C').getStore().getCount()-1,1);
                                                                                    }
