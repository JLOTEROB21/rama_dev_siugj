<?php
	...
	$consulta="SELECT COUNT(*) FROM _1060_gRolesAgendanAudiencia WHERE concat(rol,'_0') in(".$_SESSION["idRol"].")";
...
var permiteAgendar=<?php echo $numReg>0?'true':'false' ?>;
var selEvento=-1;
                                                                                            ...
                                                                                            else
                                                                                            {
                                                                                                function funcAjax()
                                                                                                {
                                                                                                    ...
                                                                                                    if(arrResp[0]=='1')
                                                                                                    {
                                                                                                        ...
                                                                                                        obj.params=[['idFormulario',185],['idRegistro',arrResp[1]]];
                                                                                                ...
                                                                                                obtenerDatosWeb('../modulosEspeciales_SGJ/paginasFunciones/funcionesModulosEspeciales_SGJ.php',funcAjax, 'POST','funcion=31&iA='+arrID[1],true);
                                                                                          	}            	
                                        ...
                                        eventSources: 	[
                                                    		{
                                                                ...
                                                                data:	{
                                                                			tipoVista:2,
                                                                            idReferencia:'<?php echo $_SESSION["codigoInstitucion"]?>',
                                                                            funcion:21
