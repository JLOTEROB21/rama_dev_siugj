...
function inicializar()
{
    ...
    else
    {
        ...
        parametros={urlDoc:bE(oDocumento.urlContenido+'?id='+bE('documento_'+gE('iDocumento').value)+'&palabraBusqueda='+gE('palabraBusqueda').value+'&nombreArchivo='+oDocumento.nombreArchivo)}
     	if(gE('ipServidor').value!='')
        {
        	parametros={urlDoc:bE(oDocumento.urlContenido+'?ipServidor='+gE('ipServidor').value+'&id='+bE('documento_'+gE('iDocumento').value)+'&nombreArchivo='+oDocumento.nombreArchivo)}
