...
function revisarInicioReunion()
{
    ...
    obtenerDatosWebV2('../paginasFunciones/funcionesModulosEspeciales_VideoConferencias.php',funcAjax, 'POST','funcion=8&idReunion='+gE('idReunion').value,false);
...
function ingresarReunion()
{
    ...
    obtenerDatosWebV2('../paginasFunciones/funcionesModulosEspeciales_VideoConferencias.php',funcAjax, 'POST','funcion=11&noReunion='+gE('numeroReunion').value+
...
function revisarStatusReunion()
{
    ...
    obtenerDatosWebV2('../paginasFunciones/funcionesModulosEspeciales_VideoConferencias.php',funcAjax, 'POST','funcion=10&idReunion='+gE('idReunion').value,false);
