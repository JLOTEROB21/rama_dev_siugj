				  ...
				  <!-- InstanceBeginEditable name="content2" --> 
                   <tr>
                        ...
                        <?php
										...
										<table>
											<tr height="21">
												<td width="15" align="right" valign="top">
													<span class="<?php echo $arrEstilos[$fila[7]]?>"><?php echo $prefijo?></span>
												</td>
												<td style='text-align:justify' valign="top" >
													<span class="<?php echo $arrEstilos[$fila[7]]?>"><?php echo $btnGuardar.$fila[1]?></span>
												</td>
                                                <td>
											...
											<?php
												...
												switch($fila[2])
												{
													...
													<?php		
															...
															echo "<span class='".$arrEstilos[$claseRespuesta]."'>".$cadResp."</span>";
													?>	
														</td>
											...
											<?php
													...
													case 4:
														...
														<tr>
															...
															<td align="left" colspan="2">
                                                            	<div  style="width:650px; text-align:justify" id="txtArea_p_<?php echo $fila[10] ?>" class="<?php echo $arrEstilos[$fila[8]]?>"><?php echo $valIdOpcion?></div>
																<?php
							...
							$consulta="SELECT idElemento,if(valorRespuestaTexto is null,valorRespuesta,valorRespuestaTexto),idRespuesta FROM 9054_respuestasCuestionario WHERE idReferencia=".$idRegistro;
						...
						?>
                            ...
                            <tr>
                            	<td align="left">
                                	<fieldset class="frameHijo"><legend><b><?php echo $fCuestionario[3]?></b></legend><br />
                                    <table width="800">
                                            	...
                                            	<form id="frmEnvio">
                                            	 <table>
                                                    ...
                                                    <tr height="21" style="display:none">
                                                 	...
                                                 	<tr  height="21">
                                                    	<td valign="top" width="130">
                                                        	<span class="corpo8_bold" style="font-size:12px">Comentarios finales:</span>
                                                        </td>
                                                        <td align="left">
                                                        	<label style="text-align:justify"><?php echo $fResultado[2]?></label>
                                                        </td>
                                                    </tr>
